...
- If you use the Agora RTC Web SDK 3.x or earlier versions, see [error codes](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/web/v3.3.1/index.html#error-codes) and [warning codes](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/web/v3.3.1/index.html#warning-codes).
- If you use the Agora RTC Web SDK 4.x, see [error codes](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/web_ng/index.html#error-code).