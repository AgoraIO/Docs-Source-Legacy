...
For details, see <Link to="../basic-features/screensharing?platform=android">Share the Screen (Android)</Link> and <Link to="../basic-features/screensharing?platform=ios">Share the Screen (iOS)</Link>.
