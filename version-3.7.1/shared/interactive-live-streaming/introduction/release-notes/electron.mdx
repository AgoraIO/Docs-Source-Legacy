...
- [`startRtmpStreamWithoutTranscoding`](./API%20Reference/electron/classes/agorartcengine.html#startrtmpstreamwithouttranscoding)
- [`startRtmpStreamWithTranscoding`](./API%20Reference/electron/classes/agorartcengine.html#startrtmpstreamwithtranscoding)
- [`updateRtmpTranscoding`](./API%20Reference/electron/classes/agorartcengine.html#updatertmptranscoding)
- [`stopRtmpStream`](./API%20Reference/electron/classes/agorartcengine.html#stoprtmpstream)
- [`startEchoTestWithConfig`](./API%20Reference/electron/classes/agorartcengine.html#startechotestwithconfig) 
- [`getScreenCaptureSources`](./API%20Reference/electron/classes/agorartcengine.html#getscreencapturesources)
- [`startScreenCaptureByDisplayId`](./API%20Reference/electron/classes/agorartcengine.html#startscreencapturebydisplayid)
- [`takeSnapshot`](./API%20Reference/electron/classes/agorartcengine.html#takesnapshot)
- `snapshotTaken`
- [`setAudioMixingPlaybackSpeed`](./API%20Reference/electron/classes/agorartcengine.html#setaudiomixingplaybackspeed)
- [`getAudioTrackCount`](./API%20Reference/electron/classes/agorartcengine.html#getaudiotrackcount)
- [`selectAudioTrack`](./API%20Reference/electron/classes/agorartcengine.html#selectaudiotrack)
- [`setAudioMixingDualMonoMode`](./API%20Reference/electron/classes/agorartcengine.html#setaudiomixingdualmonomode)
- [`pauseAllChannelMediaRelay`](./API%20Reference/electron/classes/agorartcengine.html#pauseallchannelmediarelay)
- [`resumeAllChannelMediaRelay`](./API%20Reference/electron/classes/agorartcengine.html#resumeallchannelmediarelay)
- [`getAudioFileInfo`](./API%20Reference/electron/classes/agorartcengine.html#getaudiofileinfo)
...
- The following enumerators in [`RTMP_STREAMING_EVENT` ](./API%20Reference/electron/interfaces/rtmp_streaming_event.html):
  - `RTMP_STREAMING_EVENT_ADVANCED_FEATURE_NOT_SUPPORT(3)`
  - `RTMP_STREAMING_EVENT_REQUEST_TOO_OFTEN(4)`
- `zOrder` and `alpha` in the [`RtcImage`](./API%20Reference/electron/interfaces/rtcimage.html) structure
- `AUDIO_CODEC_PROFILE_HE_AAC_V2(2)` in [`AUDIO_CODEC_PROFILE_TYPE`](./API%20Reference/electron/enums/audio_codec_profile_type.html)
- `sharpnessLevel` in the [`BeautyOptions`](./API%20Reference/electron/interfaces/beautyoptions.html) structure
- The following enumerators in [`LOCAL_VIDEO_STREAM_ERROR`](./API%20Reference/electron/enums/local_video_stream_error.html):
  - `LOCAL_VIDEO_STREAM_ERROR_DEVICE_INVALID_ID(10)`
  - `LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_OCCLUDED(13)`
  - `LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_NOT_SUPPORTED(20)`
- `blur_degree` and `BACKGROUND_BLUR_DEGREE` in the [`VirtualBackgroundSource`](./API%20Reference/electron/interfaces/virtualbackgroundsource.html) structure
- `BACKGROUND_BLUR` in [`BACKGROUND_SOURCE_TYPE`](./API%20Reference/electron/enums/background_source_type.html)
- The following enumerators in [`CHANNEL_MEDIA_RELAY_EVENT`](./API%20Reference/electron/enums/channelmediarelayevent.html):
...
- `LOCAL_AUDIO_STREAM_ERROR_RECORD_INVALID_ID(9)` and `LOCAL_AUDIO_STREAM_ERROR_PLAYOUT_INVALID_ID(10)` in [`LOCAL_AUDIO_STREAM_ERROR`](./API%20Reference/electron/enums/local_audio_stream_error.html)
- `NETWORK_TYPE_MOBILE_5G(6)` in [`NETWORK_TYPE`](./API%20Reference/electron/enums/network_type.html)
...
See [Set the Publishing State](./set_publishing_state?platform=Windows).
...
**Added**
- [`enableVirtualBackground`](./API%20Reference/electron/classes/agorartcengine.html#enablevirtualbackground)
- `RTMP_STREAMING_EVENT_URL_ALREADY_IN_USE (2)` in [`RTMP_STREAMING_EVENT`](./API%20Reference/electron/enums/rtmp_streaming_event.html)
- `encryptionKdfSalt` in [`EncryptionConfig`](./API%20Reference/electron/interfaces/encryptionconfig.html)
- `AES_128_GCM2 (7)` and `AES_256_GCM2 (8)` in  [`ENCRYPTION_MODE`](./API%20Reference/electron/enums/encryption_mode.html)
- [`muteLocalAudioStream`](./API%20Reference/electron/classes/agorartcchannel.html#mutelocalaudiostream) and [`muteLocalVideoStream`](./API%20Reference/electron/classes/agorartcchannel.html#mutelocalvideostream) in `AgoraRtcChannel`
- `publishLocalAudio` and `publishLocalVideo` in [`ChannelMediaOptions`](./API%20Reference/electron/interfaces/channelmediaoptions.html)
-  `virtualBackgroundSourceEnabled`
-  Error code `100` to `rtmpStreamingStateChanged`

**Modified**

- The default value of [`ENCRYPTION_MODE`](./API%20Reference/electron/enums/encryption_mode.html)
...
- [`adjustLoopbackRecordingSignalVolume`](./API%20Reference/electron/classes/agorartcengine.html#adjustloopbackrecordingsignalvolume)
- [`getAudioMixingFileDuration`](./API%20Reference/electron/classes/agorartcengine.html#getaudiomixingfileduration)
- [`getEffectDuration`](./API%20Reference/electron/classes/agorartcengine.html#geteffectduration)
- [`setEffectPosition`](./API%20Reference/electron/classes/agorartcengine.html#seteffectposition)
- [`getEffectCurrentPosition`](./API%20Reference/electron/classes/agorartcengine.html#geteffectcurrentposition)
- [`startAudioRecordingWithConfig`](./API%20Reference/electron/classes/agorartcengine.html#startaudiorecordingwithconfig)
- `MAINTAIN_BALANCED(2)` in the [`degradationPreference`](./API%20Reference/electron/enums/degradationpreference.html) enum
- `LOCAL_VIDEO_STREAM_ERROR_DEVICE_NOT_FOUND(8)` in the [`LOCAL_VIDEO_STREAM_ERROR`](./API%20Reference/electron/enums/local_video_stream_error.html) enum
- `LOCAL_AUDIO_STREAM_ERROR_NO_RECORDING_DEVICE(6)` and `LOCAL_AUDIO_STREAM_ERROR_NO_PLAYOUT_DEVICE(7)` in the [`LOCAL_AUDIO_STREAM_ERROR`](./API%20Reference/electron/enums/local_audio_stream_error.html) enum (Windows)
- [Error code](./API%20Reference/electron/index.html#error): `-160`
...
See details in [Set the Subscribing State](./set_subscribing_state?platform=Electron).
...
To improve the usability of the Agora Cloud Proxy, this release adds the `setCloudProxy` method to set the cloud proxy and allows you to select a cloud proxy that uses the UDP protocol. For details, see [Cloud Proxy](./cloudproxy_native?platform=Electron).
...
- [`setVoiceConversionPreset`](./API%20Reference/electron/classes/agorartcengine.html#setvoiceconversionpreset)
- `AES_128_GCM` and `AES_256_GCM` in the [`ENCRYPTION_MODE`](./API%20Reference/electron/enums/encryption_mode.html) enum
- `qoeQuality`, `qualityChangedReason` and `mosValue` in the [`RemoteAudioStats`](./API%20Reference/electron/interfaces/remoteaudiostats.html) interface
- [`setVoiceBeautifierParameters`](./API%20Reference/electron/classes/agorartcengine.html#setvoicebeautifierparameters)
- `SINGING_BEAUTIFIER` in the [`VOICE_BEAUTIFIER_PRESET`](./API%20Reference/electron/enums/voice_beautifier_preset.html) enum
- [`enableDeepLearningDenoise`](./API%20Reference/electron/classes/agorartcengine.html#enabledeeplearningdenoise)
- [`createDataStreamWithConfig`](./API%20Reference/electron/classes/agorartcengine.html#createdatastreamwithconfig)
- [`setCloudProxy`](./API%20Reference/electron/classes/agorartcengine.html#setcloudproxy)
- `captureBrightnessLevel` in the [`LocalVideoStats`](./API%20Reference/electron/interfaces/localvideostats.html) interface
- `captureWidth` and `captureHeight` in the [`CameraCapturerConfiguration`](./API%20Reference/electron/interfaces/cameracapturerconfiguration.html) interface
- `CAPTURER_OUTPUT_PREFERENCE_MANUAL(3)` in the [`CaptureOutPreference`](./API%20Reference/electron/enums/captureoutpreference.html) enum
- [Error code](./API%20Reference/electron/index.html#error): `-157`
...
Agora has passed ISO 27001, ISO 27017, and ISO 27018 international certifications, providing safe and reliable real-time interactive cloud services for users worldwide. See [ISO Certificates](https://docs.agora.io/en/Agora%20Platform/iso_cert?platform=Electron).
...
For details, see the [product overview](https://docs.agora.io/en/live-streaming/product_live_standard?platform=Electron) of Interactive Live Streaming Standard.
...
- [`setAudioEffectPreset`](./API%20Reference/electron/classes/agorartcengine.html#setaudioeffectpreset)
- [`setVoiceBeautifierPreset`](./API%20Reference/electron/classes/agorartcengine.html#setvoicebeautifierpreset)
- [`setAudioEffectParameters`](./API%20Reference/electron/classes/agorartcengine.html#setaudioeffectparameters)
- [`setBeautyEffectOptions`](./API%20Reference/electron/classes/agorartcengine.html#setbeautyeffectoptions)
- [`setClientRoleWithOptions`](./API%20Reference/electron/classes/agorartcengine.html#setclientrolewithoptions)
- [`enableEncryption`](./API%20Reference/electron/classes/agorartcengine.html#enableencryption)
- [`sendCustomReportMessage`](./API%20Reference/electron/classes/agorartcengine.html#sendcustomreportmessage)
- [`setAudioMixingPitch`](./API%20Reference/electron/classes/agorartcengine.html#setaudiomixingpitch)
- [`registerMediaMetadataObserver`](./API%20Reference/electron/classes/agorartcengine.html#registermediametadataobserver)
- [`unRegisterMediaMetadataObserver`](./API%20Reference/electron/classes/agorartcengine.html#unregistermediametadataobserver)
- [`setMaxMetadataSize`](./API%20Reference/electron/classes/agorartcengine.html#setmaxmetadatasize)
- [`sendMetadata`](./API%20Reference/electron/classes/agorartcengine.html#sendmetadata)
...
To enable a user to join an unlimited number of channels at a time, this release adds the [`AgoraRtcChannel`](./API%20Reference/electron/classes/agorartcchannel.html) class. By creating multiple `AgoraRtcChannel` objects, a user can join the corresponding channels at the same time.
...
To meet the need for higher audio quality, this release adjusts the corresponding audio profile (`profile(0)`) of [`setAudioProfile`](./API%20Reference/electron/classes/agorartcengine.html#setaudioprofile) in the `LIVE_BROADCASTING` profile.
...
Setting a mirror mode for the stream to be encoded: This release adds the `mirrorMode` property to the [`VideoEncoderConfiguration`](./API%20Reference/electron/interfaces/videoencoderconfiguration.html) interface for setting a mirror effect for the stream to be encoded and transmitted.

**3. Quality statistics**

Adds the following properties in the [`RtcStats`](./API%20Reference/electron/interfaces/rtcstats.html) interface for providing more in-call statistics, making it easier to monitor the call quality and memory usage in real time:
...
This release enables the watermark function for users to add a PNG file to the local live streaming as a watermark. The [`addVideoWatermark`](./API%20Reference/electron/classes/agorartcengine.html#addvideowatermark) and [`clearVideoWatermark`](./API%20Reference/electron/classes/agorartcengine.html#clearvideowatermarks) methods can add and delete watermarks in interactive live streaming.

**6. Supporting more audio sample rates for recording**

To enable more audio sample rate options for recording, this release adds a new [`startAudioRecording`](./API%20Reference/electron/classes/agorartcengine.html#startaudiorecording) method with a `sampleRate` parameter. In the new method, you can set the sample rate as 16, 32, 44.1 or 48 kHz.
...
- The [`setRemoteSubscribeFallbackOption`](./API%20Reference/electron/classes/agorartcengine.html#setremotesubscribefallbackoption) method, which should work in the `LIVE_BROADCASTING` profile only, also works in the `COMMUNICATION` profile.
...
- The `mirrorMode` property in the [`VideoEncoderConfiguration`](./API%20Reference/electron/interfaces/videoencoderconfiguration.html) interface
- [`createChannel`](./API%20Reference/electron/classes/agorartcengine.html#createchannel)
- [`AgoraRtcChannel`](./API%20Reference/electron/classes/agorartcchannel.html) class
- The `gatewayRtt`, `memoryAppUsageRatio`, `memoryTotalUsageRatio` and `memoryAppUsageInKbytes` properties in the [`RtcStats`](./API%20Reference/electron/interfaces/rtcstats.html) interface
- [`startAudioRecording`](./API%20Reference/electron/classes/agorartcengine.html#startaudiorecording)
- [`setBeautyEffectOptions`](./API%20Reference/electron/classes/agorartcengine.html#setbeautyeffectoptions)
- [`addVideoWatermark`](./API%20Reference/electron/classes/agorartcengine.html#addvideowatermark)
- [`clearVideoWatermark`](./API%20Reference/electron/classes/agorartcengine.html#clearvideowatermarks)
- The `report_vad` parameter in the [`enableAudioVolumeIndication`](./API%20Reference/electron/classes/agorartcengine.html#enableaudiovolumeindication) method
...
- [`startChannelMediaRelay`](./API%20Reference/electron/classes/agorartcengine.html#startchannelmediarelay)
- [`updateChannelMediaRelay`](./API%20Reference/electron/classes/agorartcengine.html#updatechannelmediarelay)
- [`stopChannelMediaRelay`](./API%20Reference/electron/classes/agorartcengine.html#stopchannelmediarelay)
...
This release adds the following statistics in the [`RtcStats`](./API%20Reference/electron/interfaces/rtcstats.html), [`LocalVideoStats`](./API%20Reference/electron/interfaces/localvideostats.html), and [`RemoteVideoStats`](./API%20Reference/electron/interfaces/remotevideostats.html) classes:
...
- Invalid call of the [`muteRemoteAudioStream`](./API%20Reference/electron/classes/agorartcengine.html#muteremoteaudiostream) method.
...
- [`switchChannel`](./API%20Reference/electron/classes/agorartcengine.html#switchchannel)
- [`startChannelMediaRelay`](./API%20Reference/electron/classes/agorartcengine.html#startchannelmediarelay)
- [`updateChannelMediaRelay`](./API%20Reference/electron/classes/agorartcengine.html#updatechannelmediarelay)
- [`stopChannelMediaRelay`](./API%20Reference/electron/classes/agorartcengine.html#stopchannelmediarelay)
...
- [`RtcStats`](./API%20Reference/electron/interfaces/rtcstats.html): `txAudioBytes`, `txVideoBytes`, `rxAudioBytes` and `rxVideoBytes`
- [`localVideoStats`](./API%20Reference/electron/interfaces/localvideostats.html): `encodedBitrate`,`encodedFrameWidth`,`encodedFrameHeight`, `encodedFrameCount` and `codecType`
- [`remoteVideoStats`](./API%20Reference/electron/interfaces/remotevideostats.html): `packetLossRate`
...
- [Start a Voice Call](https://docs.agora.io/en/Voice/start_call_audio_electron?platform=Electron)
- [Start a Video Call](https://docs.agora.io/en/Video/start_call_electron?platform=Electron)
- [Start Live Interactive Audio Streaming](https://docs.agora.io/en/Interactive%20Broadcast/start_live_audio_electron?platform=Electron)
- [Start Live Interactive Video Streaming](https://docs.agora.io/en/Interactive%20Broadcast/start_live_electron?platform=Electron)
- [API Reference](./API%20Reference/electron/index.html)

Agora also provides the open-source [Electron-Quickstart](https://github.com/AgoraIO-Community/Agora-Electron-Quickstart) sample project.
