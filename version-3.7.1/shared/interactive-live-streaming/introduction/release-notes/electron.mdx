...
- [`startRtmpStreamWithoutTranscoding`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#startrtmpstreamwithouttranscoding)
- [`startRtmpStreamWithTranscoding`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#startrtmpstreamwithtranscoding)
- [`updateRtmpTranscoding`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#updatertmptranscoding)
- [`stopRtmpStream`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#stoprtmpstream)
- [`startEchoTestWithConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#startechotestwithconfig) 
- [`getScreenCaptureSources`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#getscreencapturesources)
- [`startScreenCaptureByDisplayId`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#startscreencapturebydisplayid)
- [`takeSnapshot`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#takesnapshot)
- `snapshotTaken`
- [`setAudioMixingPlaybackSpeed`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#setaudiomixingplaybackspeed)
- [`getAudioTrackCount`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#getaudiotrackcount)
- [`selectAudioTrack`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#selectaudiotrack)
- [`setAudioMixingDualMonoMode`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#setaudiomixingdualmonomode)
- [`pauseAllChannelMediaRelay`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#pauseallchannelmediarelay)
- [`resumeAllChannelMediaRelay`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#resumeallchannelmediarelay)
- [`getAudioFileInfo`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#getaudiofileinfo)
...
- The following enumerators in [`RTMP_STREAMING_EVENT` ](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/interfaces/rtmp_streaming_event.html):
  - `RTMP_STREAMING_EVENT_ADVANCED_FEATURE_NOT_SUPPORT(3)`
  - `RTMP_STREAMING_EVENT_REQUEST_TOO_OFTEN(4)`
- `zOrder` and `alpha` in the [`RtcImage`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/interfaces/rtcimage.html) structure
- `AUDIO_CODEC_PROFILE_HE_AAC_V2(2)` in [`AUDIO_CODEC_PROFILE_TYPE`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/audio_codec_profile_type.html)
- `sharpnessLevel` in the [`BeautyOptions`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/interfaces/beautyoptions.html) structure
- The following enumerators in [`LOCAL_VIDEO_STREAM_ERROR`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/local_video_stream_error.html):
  - `LOCAL_VIDEO_STREAM_ERROR_DEVICE_INVALID_ID(10)`
  - `LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_OCCLUDED(13)`
  - `LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_NOT_SUPPORTED(20)`
- `blur_degree` and `BACKGROUND_BLUR_DEGREE` in the [`VirtualBackgroundSource`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/interfaces/virtualbackgroundsource.html) structure
- `BACKGROUND_BLUR` in [`BACKGROUND_SOURCE_TYPE`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/background_source_type.html)
- The following enumerators in [`CHANNEL_MEDIA_RELAY_EVENT`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/channelmediarelayevent.html):
...
- `LOCAL_AUDIO_STREAM_ERROR_RECORD_INVALID_ID(9)` and `LOCAL_AUDIO_STREAM_ERROR_PLAYOUT_INVALID_ID(10)` in [`LOCAL_AUDIO_STREAM_ERROR`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/local_audio_stream_error.html)
- `NETWORK_TYPE_MOBILE_5G(6)` in [`NETWORK_TYPE`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/network_type.html)
...
**Added**
- [`enableVirtualBackground`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#enablevirtualbackground)
- `RTMP_STREAMING_EVENT_URL_ALREADY_IN_USE (2)` in [`RTMP_STREAMING_EVENT`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/rtmp_streaming_event.html)
- `encryptionKdfSalt` in [`EncryptionConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/interfaces/encryptionconfig.html)
- `AES_128_GCM2 (7)` and `AES_256_GCM2 (8)` in  [`ENCRYPTION_MODE`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/encryption_mode.html)
- [`muteLocalAudioStream`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcchannel.html#mutelocalaudiostream) and [`muteLocalVideoStream`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcchannel.html#mutelocalvideostream) in `AgoraRtcChannel`
- `publishLocalAudio` and `publishLocalVideo` in [`ChannelMediaOptions`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/interfaces/channelmediaoptions.html)
-  `virtualBackgroundSourceEnabled`
-  Error code `100` to `rtmpStreamingStateChanged`

**Modified**

- The default value of [`ENCRYPTION_MODE`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/encryption_mode.html)
...
- [`adjustLoopbackRecordingSignalVolume`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#adjustloopbackrecordingsignalvolume)
- [`getAudioMixingFileDuration`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#getaudiomixingfileduration)
- [`getEffectDuration`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#geteffectduration)
- [`setEffectPosition`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#seteffectposition)
- [`getEffectCurrentPosition`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#geteffectcurrentposition)
- [`startAudioRecordingWithConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#startaudiorecordingwithconfig)
- `MAINTAIN_BALANCED(2)` in the [`degradationPreference`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/degradationpreference.html) enum
- `LOCAL_VIDEO_STREAM_ERROR_DEVICE_NOT_FOUND(8)` in the [`LOCAL_VIDEO_STREAM_ERROR`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/local_video_stream_error.html) enum
- `LOCAL_AUDIO_STREAM_ERROR_NO_RECORDING_DEVICE(6)` and `LOCAL_AUDIO_STREAM_ERROR_NO_PLAYOUT_DEVICE(7)` in the [`LOCAL_AUDIO_STREAM_ERROR`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/local_audio_stream_error.html) enum (Windows)
- [Error code](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/index.html#error): `-160`
...
- [`setVoiceConversionPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#setvoiceconversionpreset)
- `AES_128_GCM` and `AES_256_GCM` in the [`ENCRYPTION_MODE`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/encryption_mode.html) enum
- `qoeQuality`, `qualityChangedReason` and `mosValue` in the [`RemoteAudioStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/interfaces/remoteaudiostats.html) interface
- [`setVoiceBeautifierParameters`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#setvoicebeautifierparameters)
- `SINGING_BEAUTIFIER` in the [`VOICE_BEAUTIFIER_PRESET`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/voice_beautifier_preset.html) enum
- [`enableDeepLearningDenoise`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#enabledeeplearningdenoise)
- [`createDataStreamWithConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#createdatastreamwithconfig)
- [`setCloudProxy`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#setcloudproxy)
- `captureBrightnessLevel` in the [`LocalVideoStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/interfaces/localvideostats.html) interface
- `captureWidth` and `captureHeight` in the [`CameraCapturerConfiguration`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/interfaces/cameracapturerconfiguration.html) interface
- `CAPTURER_OUTPUT_PREFERENCE_MANUAL(3)` in the [`CaptureOutPreference`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/enums/captureoutpreference.html) enum
- [Error code](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/index.html#error): `-157`
...
- [`setAudioEffectPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#setaudioeffectpreset)
- [`setVoiceBeautifierPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#setvoicebeautifierpreset)
- [`setAudioEffectParameters`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#setaudioeffectparameters)
...
- [`setClientRoleWithOptions`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#setclientrolewithoptions)
- [`enableEncryption`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#enableencryption)
- [`sendCustomReportMessage`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#sendcustomreportmessage)
- [`setAudioMixingPitch`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#setaudiomixingpitch)
- [`registerMediaMetadataObserver`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#registermediametadataobserver)
- [`unRegisterMediaMetadataObserver`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#unregistermediametadataobserver)
- [`setMaxMetadataSize`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#setmaxmetadatasize)
- [`sendMetadata`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/electron/classes/agorartcengine.html#sendmetadata)
