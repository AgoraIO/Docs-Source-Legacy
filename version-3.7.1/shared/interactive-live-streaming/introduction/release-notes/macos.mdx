...
See [Media Stream Encryption](./channel_encryption_apple?platform=macOS).
...
See [Set the Publishing State](./set_publishing_state?platform=macOS) and [Join Multiple Channels](./multiple_channel_apple?platform=macOS).
