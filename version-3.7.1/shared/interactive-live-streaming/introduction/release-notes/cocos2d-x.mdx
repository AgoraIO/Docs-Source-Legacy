...
This release adapts to the Agora Video SDK v3.5.1 for Android and iOS. For the compatibility changes, new features, improvements, and fixed issues from v3.2.0 to v3.5.1, see [Release Notes (Android)](https://docs.agora.io/en/Video/release_android_video?platform=Android) and [Release Notes (iOS)](https://docs.agora.io/en/Video/release_ios_video?platform=iOS).
