...
- `SR_MODE_AUTO(1)`:  Enables super resolution for the remote user corresponding to the largest rendering window in the channel.
  <div class="alert note">Before using super resolution, ensure that you have integrated the <code>libagora_super_resolution_extension.so</code> dynamical library. For other requirements, see the <a href="./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a69275723501075062c6215a1d58f0e94">enableRemoteSuperResolution documentation</a>.</div>
...
This release supports screen sharing on this platform and provides the `startScreenCapture`, `stopScreenCapture`, and `updateScreenCaptureParameters` methods for this purpose. For the implementation method, see [Share the Screen](./screensharing_android?platform=Android).
...
- Reporting streaming states, errors, and events:
    ...
    - Adding the following to the `RTMP_STREAM_PUBLISH_ERROR` error code:
        ...
        - `RTMP_STREAM_PUBLISH_ERROR_INVALID_APPID(15)`: Your App ID does not have permission to use the Media Push function. Refer to [Prerequisites](https://docs.agora.io/en/Interactive%20Broadcast/cdn_streaming_android?platform=Android#prerequisites) to enable the Media Push permission.
...
- `RTMP_STREAM_PUBLISH_STATE_DISCONNECTING(5)` in the `state` parameter of [`onRtmpStreamingStateChanged`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a7b9f1a5d87480cfd6187c3da0ade3f94) 

- The followin code  in the `errCode` parameter of  [`onRtmpStreamingStateChanged`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a7b9f1a5d87480cfd6187c3da0ade3f94):
...
- The following code in the `error`parameter of [`onRtmpStreamingEvent`](./API%20Reference/java/v3.6.0/classio_1_1agora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a2c26ecc40133c2bb18b30f4752edc61c):
...
- The following methods in the `LiveTranscoding` class:
  ...
  - [`addWatermark`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1live_1_1_live_transcoding.html#acfb48803a25e2874662a6062e42eb23a)
  - [`removeWatermark`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1live_1_1_live_transcoding.html#ac9f7a22a7f81ed3f1e76aabd85de24a1)
  - [`getWatermarkList`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1live_1_1_live_transcoding.html#a2eb18535e9325de3c2f13ab198632086)
  - [`addBackgroundImage`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1live_1_1_live_transcoding.html#a545520b022875f0defa88ca1e60644eb)
  - [`removeBackgroundImage`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1live_1_1_live_transcoding.html#abb5e69ef80b366ada2194b8fea7ad2a5)
  - [`getBackgroundImageList`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1live_1_1_live_transcoding.html#a6b8407b0266bb7bdd5f54a5b95109ef3)

- `zOrder` and `alpha` in the [`AgoraImage`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1video_1_1_agora_image.html) class

- `HE_AAC_V2` in `AudioCodecProfileType`

- [`setAVSyncSource`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a2a1680d169ee47b60a1612efbdb0a0de)

- `sharpnessLevel` in the [`BeautyOptions`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1video_1_1_beauty_options.html#abe098987049261ed3fafa5c9eb566f3e) class

**Modified**

- Changed the default value of  [`lighteningLevel`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1video_1_1_beauty_options.html#a8f95db150c53642322d1724260c6412c) from 0.7 to 0.6
...
- [`startEchoTest`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#ae4b2638c90a721749abdd9513260e51c) [3/3]

- [`getMediaRecorder`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_agora_media_recorder.html#a664d014b211e9bdb02a2ab6e6bed602f)

- [`onRecorderStateChanged`](./API%20Reference/java/interfaceio_1_1agora_1_1rtc_1_1_agora_media_recorder_1_1_i_media_recorder_callback.html#a3355c1e8de0c5da28a741c2b1b537395)

- [`onRecorderInfoUpdated`](./API%20Reference/java/interfaceio_1_1agora_1_1rtc_1_1_agora_media_recorder_1_1_i_media_recorder_callback.html#a212e958cb29dc6760fbe4e4c3068b6d7)

- [`startRecording`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_agora_media_recorder.html#a587a2d8e4e86157d59ec058ef1e22463)

- [`stopRecording`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_agora_media_recorder.html#a210c51a4f89b88d9d04f37a87ec1d478)

- [`release`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_agora_media_recorder.html#a4f2bef81683e17b663255ace71207ec9)

- [`takeSnapshot`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#ab5331537300d488d6095c01337bda202)

- [`onSnapshotTaken`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a611602228a711d8ca9a125fbc22f2d85)
...
- [`enableRemoteSuperResolution`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#ab4901dc483497a5721b3059751e1117c)
- [`onUserSuperResolutionEnabled`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a4437c6d4d04135837ddf79ce050132a0)
- [`isCameraTorchSupported`](./API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#a4125f12424c84b0a5e36f08a3665cc9e) (C++)
- [`setCameraTorchOn`](./API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#a1411918f978f4aea0562d1274432a943) (C++)
- `blur_degree` and `BLUR_DEGREE` in [`VirtualBackgroundSource`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1video_1_1_virtual_background_source.html)
- `BACKGROUND_BLUR` in [`backgroundSourceType`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1video_1_1_virtual_background_source.html#aef6a35a8b004af0cd60d0504c946755e) 
- [`pushExternalAudioFrame`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#acc77cfbe4ddfcf36d722a89af6729ce5) [2/2]
- [`setExternalAudioSourceVolume`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a237825abbde72f6818d8450cfe4be06b)
- [`setAudioMixingPlaybackSpeed`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#aa89c09746ed13adb978e7ed552319c51)
- [`getAudioTrackCount`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#ac45aa45b0965639df502c462b54cf1b7)
- [`selectAudioTrack`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a011d98dd3828690165f4f5915f494ddd)
- [`setAudioMixingDualMonoMode`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a81b6a0f46612a6c4337d078b3af1681a)
- [`pauseAllChannelMediaRelay`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#acbf0c434b6867c6b3010aee1f2375269)
- [`resumeAllChannelMediaRelay`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#ab33a8fc2a42d95916e483705c9b43293)
- The following `RELAY_EVENT` enumerators:
  - [`RELAY_EVENT_PAUSE_SEND_PACKET_TO_DEST_CHANNEL_SUCCESS`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_constants.html#a7bdf2c335ecb4699ade19ffd9f128389)
  - [`RELAY_EVENT_PAUSE_SEND_PACKET_TO_DEST_CHANNEL_FAILED`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_constants.html#a5a1d733bf274f138b511e76081526b65)
  - [`RELAY_EVENT_RESUME_SEND_PACKET_TO_DEST_CHANNEL_SUCCESS`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_constants.html#a45b2a457a6dd33a5b3be3cb17dda2ec1)
  - [`RELAY_EVENT_RESUME_SEND_PACKET_TO_DEST_CHANNEL_FAILED`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_constants.html#a4125ae6a9bd19116f6239ef0766cb852)
- [`getAudioFileInfo`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#ab280ab29440d333c8c00be9c45a3dd48)
- [`onRequestAudioFileInfo`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a3e1191735cd197815f4001b89825220a)
- [`NETWORK_TYPE_MOBILE_5G(6)`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_constants.html#a2e380ca154d7bcb587f30e87a77b3cb4)
...
As of this release, Agora publishes the SDK package to mavenCentral. To integrate the SDK with mavenCentral, see [Other approches to integrating the SDK](./start_call_android?platform=Android#other-approches-to-integrating-the-sdk).
...
See [Set the Audio Route](./set_audio_route_android?platform=Android).
...
- [`enableVirtualBackground`](./API%20Reference/java/v3.5.0/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a1d7da2e04f82d5f3988e08f042b87fd2)
- [`onVirtualBackgroundSourceEnabled`](./API%20Reference/java/v3.5.0/classio_1_1agora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a075c08f221367598a22389b5bf357cb4)

**Modified**

- [`setEnableSpeakerphone`](./API%20Reference/java/v3.5.0/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a67cf60c4a3f4dade3f49205cd2f044f3)
- [`setDefaultAudioRouteToSpeakerphone`](./API%20Reference/java/v3.5.0/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a8f89328fab2054d74f9dfa7819458866)
...
See [Media Stream Encryption](./channel_encryption_android?platform=Android).
...
See [Set the Publishing State](./set_publishing_state?platform=Android) and [Join Multiple Channels](./multiple_channel_android?platform=Android).
...
- [`RTMP_STREAM_UNPUBLISH_ERROR_OK (100)`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_constants.html#acaddf5d8d65ca6f6ee7f4fd77dec2947) in `RTMP_STREAM_PUBLISH_ERROR`
- [`RTMP_STREAMING_EVENT_URL_ALREADY_IN_USE (2)`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_constants.html#a25b71972dca11ac4b5cd9055590bcc47) in `RTMP_STREAMING_EVENT`
- `AES_128_GCM2 (7)` and `AES_256_GCM2 (8)` in [`EncryptionMode`](./API%20Reference/java/enumio_1_1agora_1_1rtc_1_1internal_1_1_encryption_config_1_1_encryption_mode.html)
- [`encryptionKdfSalt`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1internal_1_1_encryption_config.html#afc9c110a821b8fe078aa187a894d7e39) in [`EncryptionConfig`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1internal_1_1_encryption_config.html)
- [`muteLocalAudioStream`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_channel.html#ae756f3e94c56acc0873799c63a97a22d) and [`muteLocalVideoStream`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_channel.html#a9ab5e48b13317d7e2017c4093a665031) in `RtcChannel`
- [`publishLocalAudio`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1models_1_1_channel_media_options.html#a647b5b6056e0b364c4df6a72ec1f9420) and [`publishLocalVideo`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1models_1_1_channel_media_options.html#a68ff1bd1dc3f99d202d6c141dabcdccc) in `ChannelMediaOptions`
- [`LOCAL_AUDIO_STREAM_ERROR_INTERRUPTED (8)`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_constants.html#a26b3c01733c2f7ffced2540c3f52b6ef) in `LOCAL_AUDIO_STREAM_ERROR`
...
- `AES_128_GCM` and `AES_256_GCM` in [`encryptionMode`](./API%20Reference/java/enumio_1_1agora_1_1rtc_1_1internal_1_1_encryption_config_1_1_encryption_mode.html)
