...
- Reporting streaming states, errors, and events:
    ...
    - Adding the following to the `AgoraRtmpStreamingErrorCode` error code:
        ...
        - `AgoraRtmpStreamPublishErrorInvalidAppId(15)`: Your App ID does not have permission to use the Media Push function. Refer to [Prerequisites](https://docs.agora.io/en/Interactive%20Broadcast/cdn_streaming_apple?platform=iOS#prerequisites) to enable the Media Push permission.
...
- `AgoraRtmpStreamingStateDisconnecting(5)` in [`AgoraRtmpStreamingState`](./API%20Reference/oc/Constants/AgoraRtmpStreamingState.html) 

- The following enumerators in [`AgoraRtmpStreamingErrorCode`](./API%20Reference/oc/Constants/AgoraRtmpStreamingErrorCode.html):
...
- The following enumerators in [`AgoraRtmpStreamingEvent`](./API%20Reference/oc/Constants/AgoraRtmpStreamingEvent.html):

  - `RTMP_STREAMING_EVENT_ADVANCED_FEATURE_NOT_SUPPORT(3)`
  - `RTMP_STREAMING_EVENT_REQUEST_TOO_OFTEN(4)`

- `AgoraAudioCodecProfileHEAACv2` in the [`AgoraAudioCodecProfileType`](./API%20Reference/oc/Constants/AgoraAudioCodecProfileType.html) class
...
This release adds the [`startEchoTestWithConfig`](./API%20Reference/oc//Classes/AgoraRtcEngineKit.html#//api/name/startEchoTestWithConfig:) method.
...
- [`isMultipleChannelFrameWanted`](./API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/isMultipleChannelFrameWanted)
- [`onPlaybackAudioFrameBeforeMixingEx`](./API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/onPlaybackAudioFrameBeforeMixingEx:channelId:uid:)

## v3.4.6

<div class="alert note">In this release, a memory leak occurs when `AgoraRtcEngineKit` strongly references <code>AgoraRtcEngineDelegate</code>. If you set the strong reference to <code>AgoraRtcEngineDelegate</code> by <code>AgoraRtcEngineKit</code>, Agora recommends that you upgrade the SDK to v3.5.0.1. For details, see <a href="#v3.5.0.1">v3.5.0.1</a >.</div>
...
<div class="alert note">In this release, a memory leak occurs when `AgoraRtcEngineKit` strongly references `AgoraRtcEngineDelegate`. If you set the strong reference to `AgoraRtcEngineDelegate` by `AgoraRtcEngineKit`, Agora recommends that you upgrade the SDK to v3.5.0.1. For details, see <a href="#v3.5.0.1">v3.5.0.1</a >.</div>
...
<div class="alert note">`publishLocalAudio = NO` serves the same function as `muteLocalAudioStream(YES)`. If you call them together, the one called later takes effect.</div>
...
- `AgoraRtmpStreamingErrorCodeUnpublishOK (100)` in [`AgoraRtmpStreamingErrorCode`](./API%20Reference/oc/Constants/AgoraRtmpStreamingErrorCode.html)
- `AgoraRtmpStreamingEventUrlAlreadyInUse (2)` in [`AgoraRtmpStreamingEvent`](./API%20Reference/oc/Constants/AgoraRtmpStreamingEvent.html)
- `AgoraEncryptionModeAES128GCM2 (7)` and `AgoraEncryptionModeAES256GCM2 (8)` in [`AgoraEncryptionMode`](./API%20Reference/oc/Constants/AgoraEncryptionMode.html)
- [`encryptionKdfSalt`](./API%20Reference/oc/Classes/AgoraEncryptionConfig.html#//api/name/encryptionKdfSalt) in `AgoraEncryptionConfig`
- [`muteLocalAudioStream`](./API%20Reference/oc/Classes/AgoraRtcChannel.html#//api/name/muteLocalAudioStream:) in `AgoraRtcChannel`
- `publishLocalAudio` in [`AgoraRtcChannelMediaOptions`](./API%20Reference/oc/Classes/AgoraRtcChannelMediaOptions.html)
- The following callbacks in [`AgoraAudioDataFrameProtocol`](./API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html):
  - [`getObservedAudioFramePosition`](./API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/getObservedAudioFramePosition)
  - [`getRecordAudioParams`](./API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/getRecordAudioParams)
  - [`getMixedAudioParams`](./API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/getMixedAudioParams)
  - [`getPlaybackAudioParams`](./API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/getPlaybackAudioParams)

**Modified**

- `setAudioFrameDelegate` to [`setAudioDataFrame`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioDataFrame:)
- `AgoraAudioFrameDelegate` to [`AgoraAudioDataFrameProtocol`](./API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html)
- [`startAudioMixing`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startAudioMixing:loopback:replace:cycle:startPos:)
...
- [`startRhythmPlayer`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startRhythmPlayer:sound2:config:)
- [`stopRhythmPlayer`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/stopRhythmPlayer)
- [`configRhythmPlayer`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/configRhythmPlayer:)
- [`playEffect`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/playEffect:filePath:loopCount:pitch:pan:gain:publish:startPos:)3
- [`getEffectDuration`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/getEffectDuration:)
- [`setEffectPosition`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setEffectPosition:pos:)
- [`getEffectCurrentPosition`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/getEffectCurrentPosition:)
- [`startAudioMixing`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startAudioMixing:loopback:replace:cycle:startPos:)2
- [`startAudioRecordingWithConfig`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startAudioRecordingWithConfig:)3
- [Error Code](./error_rtc?platform=iOS): `AgoraErrorCodeAlreadyInRecording(160)`

**Modified**

- [`localAudioMixingStateDidChanged`](./API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:localAudioMixingStateDidChanged:reason:)
...
This release adds the `setVoiceConversionPreset` method to set a voice conversion effect (to disguise a user's voice). You can use this method to make a male-sounding voice sound steady or deep, and a female-sounding voice sound gender-neutral or sweet. See [Set the Voice Effect](./voice_changer_apple?platform=iOS).
...
- [`setVoiceConversionPreset`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setVoiceConversionPreset:)
- `AgoraEncryptionModeAES128GCM` and `AgoraEncryptionModeAES256GCM` in [`AgoraEncryptionMode`](./API%20Reference/oc/Constants/AgoraEncryptionMode.html) 
- `mosValue` in [`AgoraRtcRemoteAudioStats`](./API%20Reference/oc/Classes/AgoraRtcRemoteAudioStats.html)
...
To integrate the SDK into your project, see [Integrate the SDK](./start_live_ios?platform=iOS#integrate_sdk).
...
See details in [Set the Subscribing State](./set_subscribing_state?platform=iOS).
...
To improve the usability of the Agora Cloud Proxy, this release adds the `setCloudProxy` method to set the cloud proxy and allows you to select a cloud proxy that uses the UDP protocol. For details, see [Cloud Proxy](./cloudproxy_native?platform=iOS).
...
**2. Cloud proxy**
This release optimizes the Agora cloud proxy architecture. If you are already using cloud proxy, to avoid compatibility issues between the new SDK and the old cloud proxy, please contact support@agora.io before upgrading the SDK. See [Cloud Proxy](./cloudproxy_native?platform=iOS).
...
After joining multiple channels, users can receive the audio streams of all the channels, but publish one stream to only one channel at a time. This feature applies to scenarios where users need to receive streams from multiple channels, or frequently switch between channels to publish streams. See [Join multiple channels](../advanced-features/multiple-channel) for details.
...
- `firstRemoteAudioFrameDecodedOfUid` and `firstRemoteAudioFrameOfUid`. Use the [`remoteAudioStateChangedOfUid`](./API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:remoteAudioStateChangedOfUid:state:reason:elapsed:) callback instead.
...
-  Interactive live streaming: See [Online Statistics Query API](/en/API%20Reference/dashboard_restful_live).
