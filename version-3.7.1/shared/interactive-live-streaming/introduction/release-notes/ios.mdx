...
See [Media Stream Encryption](./channel_encryption_apple?platform=iOS).
...
See [Set the Publishing State](./set_publishing_state?platform=iOS) and [Join Multiple Channels](./multiple_channel_apple?platform=iOS).
