...
This release supports screen sharing on the Android and iOS platforms and provides the `startScreenCapture`, `stopScreenCapture`, and `updateScreenCaptureParameters` methods for this purpose. For the implementation guide, see [Share the Screen](./screensharing_react_native?platform=React%20Native).
...
- [`startScreenCapture` ](./API%20Reference/react_native/v3.7.0/classes/rtcengine.html#startscreencapture)
- [`stopScreenCapture`](./API%20Reference/react_native/v3.7.0/classes/rtcengine.html#stopscreencapture)
- [`updateScreenCaptureParameters`](./API%20Reference/react_native/v3.7.0/classes/rtcengine.html#updatescreencaptureparameters)
- [`enableLocalVoicePitchCallback`](./API%20Reference/react_native/v3.7.0/classes/rtcengine.html#enablelocalvoicepitchcallback)
- [`LocalVoicePitchInHz`](./API%20Reference/react_native/v3.7.0/interfaces/rtcengineevents.html#localvoicepitchinhz)
- [`FirstRemoteVideoFrame`](./API%20Reference/react_native/v3.7.0/interfaces/rtcchannelevents.html#firstremotevideoframe) in `RtcChannelEvents` 
- [`ClientRoleChangeFailed`](./API%20Reference/react_native/v3.7.0/interfaces/rtcengineevents.html#clientrolechangefailed)
- `SameUidLogin(19)` and `TooManyBroadcasters(20)` in [`ConnectionChangedReason`](./API%20Reference/react_native/v3.7.0/enums/connectionchangedreason.html)
- The following constants in [`LocalVideoStreamError`](./API%20Reference/react_native/v3.7.0/enums/localvideostreamerror.html):
...
- Reporting streaming states, errors, and events:
  ...
  - Adding the following to the `RtmpStreamingErrorCode` error code:
    ...
    - `InvalidAppid(15)`: Your App ID does not have permission to use the Media Push function. Refer to [Prerequisites](https://docs.agora.io/en/Interactive%20Broadcast/cdn_streaming_android?platform=Android#prerequisites) to enable the Media Push permission.
...
- [`takeSnapshot`](./API%20Reference/react_native/classes/rtcengine.html#takesnapshot)
- [`SnapshotTaken`](./API%20Reference/react_native/interfaces/rtcchannelevents.html#snapshottaken)
- [`enableRemoteSuperResolution`](./API%20Reference/react_native/classes/rtcengine.html#enableremotesuperresolution)
- [`UserSuperResolutionEnabled`](./API%20Reference/react_native/interfaces/rtcchannelevents.html##a4437c6d4d04135837ddf79ce050132a0)
- `blur_degree` and `VirtualBackgroundBlurDegree` in [`VirtualBackgroundSource`](./API%20Reference/react_native/classes/virtualbackgroundsource.html)
- `Blur` in [`backgroundSourceType`](./API%20Reference/react_native/classes/virtualbackgroundsource.html#backgroundsourcetype)
- [`setAudioMixingPlaybackSpeed`](./API%20Reference/react_native/classes/rtcengine.html#setaudiomixingplaybackspeed)
- [`getAudioTrackCount`](./API%20Reference/react_native/classes/rtcengine.html#getaudiotrackcount)
- [`selectAudioTrack`](./API%20Reference/react_native/classes/rtcengine.html#selectaudiotrack)
- [`setAudioMixingDualMonoMode`](./API%20Reference/react_native/classes/rtcengine.html#a81b6a0f46612a6c4337d078b3af1681a)
- [`pauseAllChannelMediaRelay`](./API%20Reference/react_native/classes/rtcengine.html#pauseallchannelmediarelay)
- [`resumeAllChannelMediaRelay`](./API%20Reference/react_native/classes/rtcengine.html#resumeallchannelmediarelay)
- [`getAudioFileInfo`](./API%20Reference/react_native/classes/rtcengine.html#getaudiofileinfo)
- [`RequestAudioFileInfo`](./API%20Reference/react_native/interfaces/rtcchannelevents.html#requestaudiofileinfo)
- `Mobile5G(6)`in [`NetworkType`](./API%20Reference/react_native/enums/networktype.html)

**Modified**

- [`startEchoTest`](./API%20Reference/react_native/classes/rtcengine.html#startechotest)
...
See [Set the Audio Route](./set_audio_route_android?platform=Android) for Android platform.
...
<div class="alert note">Before you use virtual backgrounds, ensure that the device performance and user scenarios meet the requirements. See <a href="./API%20Reference/react_native/classes/rtcengine.html#enablevirtualbackground">enableVirtualBackground</a > documentation.</div>
...
- [`enableVirtualBackground`](./API%20Reference/react_native/classes/rtcengine.html#enablevirtualbackground)
- [`VirtualBackgroundSourceEnabled`](./API%20Reference/react_native/interfaces/rtcchannelevents.html#virtualbackgroundsourceenabled)

**Modified**

- [`setEnableSpeakerphone`](./API%20Reference/react_native/classes/rtcengine.html#setenablespeakerphone)
- [`setDefaultAudioRouteToSpeakerphone`](./API%20Reference/react_native/classes/rtcengine.html#setdefaultaudioroutetospeakerphone)
...
- [`RtcEngineContext`](./API%20Reference/react_native/classes/rtcenginecontext.html) class
- [`createWithContext`](./API%20Reference/react_native/classes/rtcengine.html#createwithcontext)
- [`UnPublishOK (100)`](/API%20Reference/react_native/enums/rtmpstreamingerrorcode.html#unuublishok) in `RtmpStreamingErrorCode` 
- [`UrlAlreadyInUse (2)`](./API%20Reference/react_native/enums/rtmpstreamingevent.html#urlalreadyinuse) in `RtmpStreamingEvent`
- `AES128GCM2 (7)` and `AES256GCM2 (8)`in [`EncryptionMode`](./API%20Reference/react_native/enums/encryptionmode.html) 
- `encryptionKdfSalt` in [`EncryptionConfig`](./API%20Reference/react_native/enums/encryptionmode.html)
- [`muteLocalAudioStream`](./API%20Reference/react_native/classes/rtcchannel.html#mutelocalaudiostream) and [`muteLocalVideoStream`](./API%20Reference/react_native/classes/rtcchannel.html#mutelocalvideostream) in `RtcChannel`
- [`publishLocalAudio`](./API%20Reference/react_native/classes/channelmediaoptions.html#publishlocalaudio) and [`publishLocalVideo`](./API%20Reference/react_native/classes/channelmediaoptions.html#publishlocalvideo) in `ChannelMediaOptions`
- [`Interrupted (8)`](./API%20Reference/react_native/enums/audiolocalerror.html#interrupted) in `AudioLocalError`
...
- [`startRhythmPlayer`](./API%20Reference/react_native/classes/rtcengine.html#startrhythmplayer)
- [`stopRhythmPlayer`](./API%20Reference/react_native/classes/rtcengine.html#stoprhythmplayer)
- [`configRhythmPlayer`](./API%20Reference/react_native/classes/rtcengine.html#configrhythmplayer)
- [`startAudioRecordingWithConfig`](./API%20Reference/react_native/classes/rtcengine.html#startaudiorecordingwithconfig)
- [`getEffectDuration`](./API%20Reference/react_native/classes/rtcengine.html#geteffectduration)
- [`setEffectPosition`](./API%20Reference/react_native/classes/rtcengine.html#seteffectposition)
- [`getEffectCurrentPosition`](./API%20Reference/react_native/classes/rtcengine.html#geteffectcurrentposition)
- `filePath` in [`getAudioMixingDuration`](./API%20Reference/react_native/classes/rtcengine.html#getaudiomixingduration)
- `startPos` in [`playEffect`](./API%20Reference/react_native/classes/rtcengine.html#playeffect)
- `startPos` in [`startAudioMixing`](./API%20Reference/react_native/classes/rtcengine.html#startaudiomixing)
- `DeviceNotFound(8)` in [`LocalVideoStreamError`](./API%20Reference/react_native/enums/localvideostreamerror.html)
- [`Error code`](./error_rtc?platform=React%20Native): `AlreadyInRecording(160)`

**Modified**

- [`AudioMixingStateChanged`]((./API%20Reference/react_native/interfaces/rtcengineevents.html#audiomixingstatechanged))
...
To improve the usability of the Agora Cloud Proxy, this release adds the `setCloudProxy` method to set the cloud proxy and allows you to select a cloud proxy that uses the UDP protocol. For details, see [Cloud Proxy](./cloudproxy_native?platform=React Native).
...
- `AES128GCM` and `AES256GCM` in [`EncryptionMode`](./API%20Reference/react_native/enums/encryptionmode.html)
- `mosValue` in [`RemoteAudioStats`](./API%20Reference/react_native/interfaces/rtcengineevents.html#remoteaudiostats)
- [`setVoiceBeautifierParameters`](./API%20Reference/react_native/classes/rtcengine.html#setvoicebeautifierparameters)
- `SingingBeautifier` in [`VoiceBeautifierPreset`](./API%20Reference/react_native/enums/voicebeautifierpreset.html)
- [`enableDeepLearningDenoise`](./API%20Reference/react_native/classes/rtcengine.html#enabledeeplearningdenoise)
- `options` in [`joinChannel`](./API%20Reference/react_native/classes/rtcengine.html#joinchannel)
- `options` in [`switchChannel`](./API%20Reference/react_native/classes/rtcengine.html#switchchannel)
- [`createDataStreamWithConfig`](./API%20Reference/react_native/classes/rtcengine.html#createdatastreamwithconfig)
- `qoeQuality` and `qualityChangedReason` in [`RemoteAudioStats`](./API%20Reference/react_native/interfaces/rtcengineevents.html#remoteaudiostats)
- [`setCloudProxy`](./API%20Reference/react_native/classes/rtcengine.html#setcloudproxy)
- The `captureBrightnessLevel` property in the [`LocalVideoStats`](./API%20Reference/react_native/interfaces/localvideostats.html)
- The `captureWidth` and `captureHeight` properties in the [`CameraCapturerConfiguration`](./API%20Reference/react_native/classes/cameracapturerconfiguration.html) class
- `Manual(3)` in  [`CameraCaptureOutputPreference`](./API%20Reference/react_native/enums/cameracaptureoutputpreference.html)
- `CaptureInBackGround(6)` and `CaptureMultipleForegroundApps(7)` in [`LocalVideoStreamError`](./API%20Reference/react_native/enums/localvideostreamerror.html)
- Error code: [`ModuleNotFound(157)`](./API%20Reference/react_native/enums/errorcode.html)
