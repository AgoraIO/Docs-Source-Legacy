...
v3.5.0 adds the `proxy` property in `client.on("stream-published")` for indicating whether the media stream is forwarded by the [cloud proxy service](./cloud_proxy_web?platform=Web).
...
You can contact [support@agora.io](mailto:support@agora.io) to apply for using the optimized Agora cloud proxy service and set the `type` parameter as `3` when calling `startProxyServer`. For details, see [Use Cloud Proxy](./cloud_proxy_web).
...
v3.2.0 adds the [`optimizationMode`](./API%20Reference/web/interfaces/agorartc.streamspec.html#optimizationmode) property in `StreamSpec`.
...
Adds the [`areaCode`](./API%20Reference/web/interfaces/agorartc.clientconfig.html#areacode) property in `ClientConfig`.
...
Added the event `"stream-unpublished"` in [`Client.on`](./API%20Reference/web/interfaces/agorartc.client.html#on).
...
- Occasionally, the SDK does not automatically reconnect after being disconnected from the servers for pushing and pulling streams.
  For answers to questions arising from common disconnection issues, click the following FAQ links: [When pushing streams to the CDN, what should I do when a disconnection happens?](https://docs.agora.io/en/faq/live_streaming_disconnection_web)
...
- [`Client.startChannelMediaRelay`](./API%20Reference/web/interfaces/agorartc.client.html#startchannelmediarelay)

- [`Client.updateChannelMediaRelay`](./API%20Reference/web/interfaces/agorartc.client.html#updatechannelmediarelay)

- [`Client.stopChannelMediaRelay`](./API%20Reference/web/interfaces/agorartc.client.html#stopchannelmediarelay)

- [`Stream.setBeautyEffectOptions`](./API%20Reference/web/interfaces/agorartc.stream.html#setbeautyeffectoptions)

- Adds the following events in [`Client.on`](./API%20Reference/web/interfaces/agorartc.client.html#on)
  - `"enable-local-video"`
  - `"disable-local-video"`
...
Adds the [`screenAudio`](./API%20Reference/web/interfaces/agorartc.streamspec.html#screenaudio) property in[`AgoraRTC.createStream`](./API%20Reference/web/v3.3.1/globals.html#createstream).
...
Adds the `Stream.setVideoEncoderConfiguration` method to customize the video encoder configuration. Compared with the`Stream.setVideoProfile` method, this method is more flexible and supports customizing the video resolution, frame rate, and bitrate. See [Set the Video Profile](./video_profile_web) for details.
...
Supports audio calls, video calls, and interactive live streaming on the Microsoft Edge browser. For details, see [Agora Web SDK FAQ](https://docs.agora.io/en/faq/browser_support#edge).
...
- [`Stream.setVideoEncoderConfiguration`](./API%20Reference/web/interfaces/agorartc.stream.html#setvideoencoderconfiguration)
- [`Stream.resume`](./API%20Reference/web/interfaces/agorartc.stream.html#resume)
- New callbacks added in the [`Client.on`](./API%20Reference/web/interfaces/agorartc.client.html#on)  method:
  - `"first-audio-frame-decode"`
  - `"first-video-frame-decode"`
- New callbacks added in the [`Stream.on`](./API%20Reference/web/interfaces/agorartc.stream.html#on) method:
  - `"audioTrackEnded"`
  - `"videoTrackEnded"`
...
[`Stream.play`](./API%20Reference/web/interfaces/agorartc.stream.html#play): Adds the `callback` parameter.
...
Supports playing multiple audio effect files at the same time, and managing the files. You can set the volume, pause/stop the playback, and preload the audio effect file. See [Play Audio Effects/Audio Mixing](./audio_effect_mixing_web?platform=Web).

#### 2. Screen sharing on Chrome without extension

Supports screen sharing on Chrome 72 and later without using the Chrome extension. See [Share the Screen](./screensharing_web?platform=Web#a-name-chrome-a-screen-sharing-on-google-chrome).
...
- [`AgoraRTC.getSupportedCodec`](./API%20Reference/web/v3.3.1/globals.html#getsupportedcodec)
- [`Stream.playEffect`](./API%20Reference/web/interfaces/agorartc.stream.html#playeffect)
- [`Stream.stopEffect`](./API%20Reference/web/interfaces/agorartc.stream.html#stopeffect)
- [`Stream.pauseEffect`](./API%20Reference/web/interfaces/agorartc.stream.html#pauseeffect)
- [`Stream.resumeEffect`](./API%20Reference/web/interfaces/agorartc.stream.html#resumeeffect)
- [`Stream.setVolumeOfEffect`](./API%20Reference/web/interfaces/agorartc.stream.html#setvolumeofeffect)
- [`Stream.preloadEffect`](./API%20Reference/web/interfaces/agorartc.stream.html#preloadeffect)
- [`Stream.unloadEffect`](./API%20Reference/web/interfaces/agorartc.stream.html#unloadeffect)
- [`Stream.getEffectsVolume`](./API%20Reference/web/interfaces/agorartc.stream.html#geteffectsvolume)
- [`Stream.setEffectsVolume`](./API%20Reference/web/interfaces/agorartc.stream.html#seteffectsvolume)
- [`Stream.stopAllEffects`](./API%20Reference/web/interfaces/agorartc.stream.html#stopalleffects)
- [`Stream.pauseAllEffects`](./API%20Reference/web/interfaces/agorartc.stream.html#pausealleffects)
- [`Stream.resumeAllEffects`](./API%20Reference/web/interfaces/agorartc.stream.html#resumealleffects)
- New callbacks added in the [`Client.on`](./API%20Reference/web/interfaces/agorartc.client.html#on) method: 
  - `stream-fallback`
  - `stream-updated`
...
- Adds the `cacheResource` parameter in the [`Stream.startAudioMixing`](./API%20Reference/web/interfaces/agorartc.stream.html#startaudiomixing) method.
...
Supports the cloud proxy service. See [Use Cloud Proxy](./cloud_proxy_web) for details.
...
- [`AgoraRTC.getScreenSources`](./API%20Reference/web/v3.3.1/globals.html#getscreensources)
...
- [`Client.startProxyServer`](./API%20Reference/web/interfaces/agorartc.client.html#startproxyserver)
- [`Client.stopProxyServer`](./API%20Reference/web/interfaces/agorartc.client.html#stopproxyserver)
...
- [`Client.subscribe`](./API%20Reference/web/interfaces/agorartc.client.html#subscribe): Adds the `options` parameter.

- [`Stream.setAudioMixingPosition`](./API%20Reference/web/interfaces/agorartc.stream.html#setaudiomixingposition): Adds the `callback` parameter.

- [`Stream.play`](./API%20Reference/web/interfaces/agorartc.stream.html#play): Adds the `muted` parameter.

- Renames the following callbacks in the [`Client.on`](./API%20Reference/web/interfaces/agorartc.client.html#on) method:
...
To enable better interoperability between the Agora Web SDK and other Agora SDKs, this version adds the following features. For detailed descriptions of the APIs, see [Agora Web SDK API Reference](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/web/v3.3.1/index.html).
...
Adds the support for the Firefox browser to share the screen by adding the <code>mediaSource</code> property in the <code>createStream</code> method. See [Screen Sharing on Firefox](./screensharing_web?platform=Web#a-name-ff-a-screen-sharing-on-firefox) for details.
