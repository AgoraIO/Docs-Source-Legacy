...
This page explains how Agora calculates your monthly bill for using [Voice Call](/3.7.1/voice-calling/introduction/product-overview), [Video Call](/3.7.1/video-calling/introduction/product-overview), and [Interactive Live Streaming Premium](/3.7.1/interactive-live-streaming/introduction/product-overview).
...
If your scenario involves video calling or interactive live streaming alongside other Agora products or services, such as [Real-time Messaging](/signaling/reference/billing-policies), [Cloud Recording](/cloud-recording/reference/billing-policies), or [Interactive Whiteboard](/interactive-whiteboard/reference/billing-policies), expect additional charges. For details, see the pricing documents for each Agora product or service.
