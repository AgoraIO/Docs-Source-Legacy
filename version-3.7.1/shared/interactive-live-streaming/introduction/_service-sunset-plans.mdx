...
- [SDK download links](https://docs.agora.io/en/Interactive%20Broadcast/downloads?platform=All%20Platforms)
- [Release notes](https://docs.agora.io/en/Interactive%20Broadcast/release_android_video?platform=Android)

<div class="alert info">Click the <img src="https://web-cdn.agora.io/docs-files/1636965819958" width="150"/> button in the upper left corner of the website to switch to release notes for another platform.</div>
...
If you use Agora RTC SDK for Media Push, read [Media Push](https://docs.agora.io/en/Interactive%20Broadcast/cdn_streaming_android?platform=Android) before upgrading; if you use the server-side service for Media Push, read [Push Stream RESTful API](https://docs-preprod.agora.io/en/Interactive%20Broadcast/streaming_restful?platform=All%20Platforms) before upgrading. Perform relevant tests to verify after upgrading.
