...
- [`unloadEffect`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/unloadEffect:)
- [`playEffect`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/playEffect:filePath:loopCount:pitch:pan:gain:publish:startPos:)
- [`stopEffect`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/stopEffect:)
- [`stopAllEffects`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/stopAllEffects)
- [`pauseEffect`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/pauseEffect:)
- [`pauseAllEffects`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/pauseAllEffects)
- [`resumeEffect`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/resumeEffect:)
...
- [`rtcEngineDidAudioEffectFinish`](./API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngineDidAudioEffectFinish:soundId:)
...
- [`stopAudioMixng`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/stopAudioMixing)
- [`pauseAudioMixing`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/pauseAudioMixing)
- [`resumeAudioMixing`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/resumeAudioMixing)
- [`getAudioMixingDuration`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/getAudioMixingDuration)
- [`setAudioMixingPosition`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioMixingPosition:)
- [`getAudioMixingCurrentPosition`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/getAudioMixingCurrentPosition)
...
- [`setAudioMixingPlaybackSpeed`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioMixingPlaybackSpeed:)
- [`getAudioTrackCount`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/getAudioTrackCount)
- [`selectAudioTrack`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/selectAudioTrack:)
- [`setAudioMixingDualMonoMode`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioMixingDualMonoMode:)
