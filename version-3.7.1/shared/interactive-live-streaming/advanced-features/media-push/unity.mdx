...
<div class="alert note">The Media Push service is not free. Agora charges for the use of this service based on the transcoding configuration and streaming duration. See [Pricing for Media Push](link). If you additionally enable the LBHQ feature, discuss the charges with sales-us@agora.io.</div>
