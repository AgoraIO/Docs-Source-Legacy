...
Ensure that you implement a video call or interactive video streaming in your project. For details, see [Start a Call](start_call_web) or [Start Live Interactive Streaming](../quickstart-guide/start-video-streaming).
