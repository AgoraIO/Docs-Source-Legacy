...
<div class="alert note">Ensure that you implement a video call or interactive video streaming in your project. For details, see <a href="/3.7.1/video-calling/quickstart-guide/get-started-sdk">Start a Video Call</a> or <a href="../quickstart-guide/start-video-streaming">Start Live Interactive Video Streaming</a>.</div>
