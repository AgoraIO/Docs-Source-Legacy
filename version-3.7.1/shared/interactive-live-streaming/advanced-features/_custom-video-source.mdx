...
<div class="alert info">This article only applies to the Agora Web SDK 3.x and earlier versions. If you use the Web SDK 4.x, see <a href="./custom_video_web_ng?platform=Web">Custom Video Source and Renderer</a>.</div>
