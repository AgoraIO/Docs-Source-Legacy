...
1. Go to [Downloads](https://docs.agora.io/en/Interactive%20Broadcast/downloads?platform=iOS), download the latest version of the MediaPlayer Kit, and unzip the download package.
...
Integration steps: See [Integrate the Native SDK](../quickstart-guide/start-video-streaming).
