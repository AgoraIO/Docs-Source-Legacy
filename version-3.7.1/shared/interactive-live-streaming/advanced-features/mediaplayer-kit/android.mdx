...
1. Go to [Downloads](./downloads?platform=Android), download the latest version of the MediaPlayer Kit, and unzip the download package.
...
1. Go to [Download](./downloads?platform=Android), download the latest version of the Agora Native SDK, and unzip the download package.
