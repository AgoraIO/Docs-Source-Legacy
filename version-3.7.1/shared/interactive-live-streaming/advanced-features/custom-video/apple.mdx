...
- iOS:
  - Customize the video source (Push mode): [CustomVideoSourcePush](https://github.com/AgoraIO/API-Examples/tree/master/iOS/APIExample/Examples/Advanced/CustomVideoSourcePush)
  - Customize the video source (mediaIO mode): [CustomVideoSourceMediaIO](https://github.com/AgoraIO/API-Examples/tree/master/iOS/APIExample/Examples/Advanced/CustomVideoSourceMediaIO)
  - Customize the video renderer (mediaIO mode): [CustomVideoRender](https://github.com/AgoraIO/API-Examples/tree/master/iOS/APIExample/Examples/Advanced/CustomVideoRender)
- macOS
  - Customize the video source (Push mode): [CustomVideoSourcePush](https://github.com/AgoraIO/API-Examples/tree/master/macOS/APIExample/Examples/Advanced/CustomVideoSourcePush)
  - Customize the video source (mediaIO mode): [CustomVideoSourceMediaIO](https://github.com/AgoraIO/API-Examples/tree/master/macOS/APIExample/Examples/Advanced/CustomVideoSourceMediaIO)
  - Customize the video renderer (mediaIO mode): [CustomVideoRender](https://github.com/AgoraIO/API-Examples/tree/master/macOS/APIExample/Examples/Advanced/CustomVideoRender)
...
- [`AgoraVideoSourceProtocal`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSourceProtocol.html): Triggers callbacks that control video capturing.
- [`AgoraVideoSinkProtocal`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html): Triggers callbacks that control video rendering.
- [`AgoraVideoFrameConsumer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoFrameConsumer.html): Stores the captured video frames. In scenarios involving a custom video source, the `AgoraVideoFrameConsumer` class sends the captured video frames to the SDK. In scenarios involving a custom video renderer, the `AgoraVideoFrameConsumer` class sends the captured video frames to the renderer.
...
- After receiving  [`bufferType`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSourceProtocol.html#//api/name/bufferType), specify the format of the captured video frames in the return value.
- After receiving [`shouldInitialize`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSourceProtocol.html#//api/name/shouldInitialize), initialize the custom video source, for example, by turning on the video capture device. The SDK maintains the AgoraVideoFrameConsumer instance contained in the callback.
- After receiving [`shouldStart`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSourceProtocol.html#//api/name/shouldStart), send video frames to the SDK using [`consumePixelBuffer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoFrameConsumer.html#//api/name/consumePixelBuffer:withTimestamp:rotation:) or [`consumeRawData`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoFrameConsumer.html#//api/name/consumeRawData:withTimestamp:format:size:rotation:). You can modify the video frame parameters in `AgoraVideoFrameConsumer` according to your app scenario.
- After receiving [`shouldStop`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSourceProtocol.html#//api/name/shouldStop), stop sending video frames to the SDK.
- After receiving [`shouldDispose`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSourceProtocol.html#//api/name/shouldDispose), release the custom video source, for example, by turning off the video capture device.
...
- After receiving [`bufferType`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/bufferType) and [`pixelFormat`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/pixelFormat), specify the format of rendered video frames in the return value.
- Control the video rendering process with the [`shouldInitialize`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/shouldInitialize), [`shouldStart`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/shouldStart), [`shouldStop`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/shouldStop), and [`shouldDispose`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/shouldDispose) callbacks.
- The SDK triggers [`renderPixelBuffer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/renderPixelBuffer:rotation:) or [`renderRawData`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/renderRawData:size:rotation:) according to the video-frames format that you set in `bufferType` or `pixelFormat`.
...
Call [`setLocalVideoRenderer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setLocalVideoRenderer:) of the SDK to display the video in the local view.
