...
Before customizing the video source or renderer, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Video Call](./start_call_windows) or [Start Interactive Video Streaming](./start_live_windows).
