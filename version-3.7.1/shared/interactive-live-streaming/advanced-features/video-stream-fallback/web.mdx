...
<div class="alert info">This article only applies to the Agora Web SDK 3.x and earlier versions. If you use the Web SDK 4.x, see <a href="./fallback_web_ng?platform=Web">Video Stream Fallback</a>.</div>
...
Before proceeding, ensure that you have implemented interactive live video streaming or a video call in your project. See [Start Live Interactive Video Streaming](start_live_web) or [Start a Call](start_call_web) for details.
