...
Before proceeding, ensure that you implement interactive live video streaming in your project. See [Start Live Interactive Video Streaming](../quickstart-guide/start-video-streaming) or [Start a Call](/3.7.1/video-calling/quickstart-guide/get-started-sdk) for details.
