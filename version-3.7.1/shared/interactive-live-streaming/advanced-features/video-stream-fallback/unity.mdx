...
Before proceeding, ensure that you implement interactive live video streaming or call in your project. See [Start a Video Call](start_call_unity) or [Start Live Interactive Video Streaming](start_live_unity) for details.
