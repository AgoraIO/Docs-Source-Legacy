...
Before proceeding, ensure that you implement interactive live video streaming or a video call in your project. See [Start Live Interactive Video Streaming](start_live_android) or [Start a Call](start_call_android) for details.
