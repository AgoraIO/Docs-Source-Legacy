...
Your business scenarios might require you to set the [publishing](https://docs.agora.io/en/Agora%20Platform/publish) state of audio and video streams during real-time engagement.
