...
Before customizing the audio source or sink, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Call](/3.7.1/video-calling/quickstart-guide/get-started-sdk) or [Start Live Interactive Streaming](./start_live_android).
