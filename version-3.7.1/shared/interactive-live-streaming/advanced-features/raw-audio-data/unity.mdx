...
Before using the raw audio data function, ensure that you have implemented the basic real-time communication functions in your project. See [Start a Call](/3.7.1/voice-calling/quickstart-guide/get-started-sdk) and [Start Live Interactive Streaming](../quickstart-guide/start-audio-streaming) for details.
