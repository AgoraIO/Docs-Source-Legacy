...
1. Go to [SDK Downloads](https://docs.agora.io/en/Interactive%20Broadcast/downloads?platform=Cocos2d-x), download the latest version of the Agora Video SDK, and extract the files from the downloaded SDK package.
