...
- Stream objects, which represent the local and remote [streams](https://docs.agora.io/en/Agora%20Platform/terms?platform=Web#media-stream). The Stream methods define the behaviors of a stream object, such as the playback control and audio profiles. When you call a Stream method, you need to distinguish between the local and the remote streams.
