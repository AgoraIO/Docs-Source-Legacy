...
Generating a token by hand is not helpful in a production context. [Authenticate Your Users with Tokens](../basic-features/token-server) shows you how to start voice live streaming with a token that you retrieve from your server.
