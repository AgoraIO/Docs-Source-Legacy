...
This article describes how to create a simple Cocos2d-x project and integrate the Agora Voice SDK to build an Android app with the basic live audio streaming function.
...
1. Go to [SDK Downloads](./downloads?platform=Cocos2d-x), download the latest version of the Agora Voice SDK for Android, and extract the files from the downloaded SDK package.
...
4. Copy the following files or subfolders from the `audio/libs/android` folder of the downloaded SDK package to the path of your project:
