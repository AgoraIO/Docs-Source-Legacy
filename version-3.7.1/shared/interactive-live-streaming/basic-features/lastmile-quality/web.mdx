...
<div class="alert info">This article only applies to the Agora Web SDK 3.x and earlier versions. If you use the Web SDK 4.x, see <a href="./lastmile_quality_web_ng?platform=Web">Pre-call Network Test</a>.</div>
