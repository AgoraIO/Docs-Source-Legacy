...
Before proceeding, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Call](start_call_windows) or [Start Live Interactive Streaming](start_live_windows).
