...
Before you begin, ensure that you understand how to start a video call or start interactive video streaming. For details, see [Start a Video Call](./start_call_flutter?platform=Flutter) or [Get Started with Interactive Live Streaming Premium](./start_live_flutter?platform=Flutter).
