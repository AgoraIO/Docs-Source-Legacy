...
4. Call [`startScreenCaptureMobile` ](./API%20Reference/flutter/v5.3.0/API/class_irtcengine.html#api_startscreencapturemobile), and prompt the user's manual action to make the app start screen sharing. You can choose either of the following two methods:
...
You can get the display ID by using  [`enumerateDisplays`](./API%20Reference/flutter/v5.3.0/API/api_enumeratedisplays.html)  in  agora_rtc_engine.
...
You can get the window ID by using  [`enumerateWindows`](./API%20Reference/flutter/v5.3.0/API/api_enumeratewindows.html)  in  agora_rtc_engine.
