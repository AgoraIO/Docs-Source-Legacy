...
Before you begin, ensure that you understand how to start a video call or start interactive video streaming. For details, see [Start a Video Call](./Video/start_call_react_native?platform=React%20Native) or [Start Interactive Video Streaming](./Interactive%20Broadcast/start_live_react_native?platform=React%20Native).
