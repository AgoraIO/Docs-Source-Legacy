...
- [`startScreenCapture`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#/api/name/startScreenCapture:)
- [`updateScreenCapture`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#/api/name/updateScreenCapture:)
