...
* [`getScreenCaptureSourcesWithThumbSize`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/getScreenCaptureSourcesWithThumbSize:iconSize:includeScreen:)
