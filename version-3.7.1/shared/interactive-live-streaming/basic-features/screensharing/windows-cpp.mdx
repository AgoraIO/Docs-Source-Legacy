...
Refer to the [sample project](https://github.com/AgoraIO/API-Examples/tree/master/windows/APIExample/APIExample/Advanced/ScreenShare) on GitHub to learn how to share a screen or window with the Agora SDK.

## Implementation

Ensure that you implement a video call or interactive streaming in your project. For details, see [Start a Video Call](/3.7.1/video-calling/quickstart-guide/get-started-sdk) or [Start Interactive Video Streaming](../quickstart-guide/start-video-streaming).
