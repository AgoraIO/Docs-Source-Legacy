...
<div class="alert info">This article only applies to the Agora Web SDK 3.x and earlier versions. If you use the Web SDK 4.x, see <a href="./screensharing_web_ng?platform=Web">Share the Screen</a>.</div>
...
Before you begin, ensure that you understand how to [start a video call](start_call_web) or [start interactive video streaming](start_live_web).
...
1. Add the [Google Chrome Extension for Screen Sharing](./chrome_screensharing_plugin) provided by Agora and get an extension ID.
