...
Before you begin, ensure that you understand how to [start a video call](start_call_web) or [start interactive video streaming](../quickstart-guide/start-video-streaming).
