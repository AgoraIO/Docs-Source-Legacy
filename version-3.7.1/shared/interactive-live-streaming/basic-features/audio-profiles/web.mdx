...
Before adjusting the audio volume, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Call](start_call_web) or [Start Live Interactive Streaming](../quickstart-guide/start-video-streaming).
