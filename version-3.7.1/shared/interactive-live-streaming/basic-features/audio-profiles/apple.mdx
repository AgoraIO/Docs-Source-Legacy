...
- iOS: [Start a Call](/3.7.1/video-calling/quickstart-guide/get-started-sdk)/[Start Live Interactive Streaming](../quickstart-guide/start-video-streaming)
- macOS: [Start a call](/3.7.1/video-calling/quickstart-guide/get-started-sdk)/[Start Live Interactive Streaming](../quickstart-guide/start-video-streaming)
