...
- iOS: [Start a Call](start_call_ios?platform=iOS)/[Start Live Interactive Streaming](../quickstart-guide/start-video-streaming?platform=iOS)
- macOS: [Start a call](start_call_mac?platform=macOS)/[Start Live Interactive Streaming](../quickstart-guide/start-video-streaming)
