...
Before setting the audio profile and scenario, ensure that you have implemented the basic real-time communication functions in your project. See [Start a Video Call](start_call_android?platform=Android) or [Start Interactive Live Streaming](../quickstart-guide/start-video-streaming?platform=Android).
...
- [`setAudioProfile`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a34175b5e04c88d9dc6608b1f38c0275d)
