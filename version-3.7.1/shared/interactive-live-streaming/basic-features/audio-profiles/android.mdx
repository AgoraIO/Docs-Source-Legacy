...
Before setting the audio profile and scenario, ensure that you have implemented the basic real-time communication functions in your project. See [Start a Video Call](start_call_android?platform=Android) or [Start Interactive Live Streaming](start_live_android?platform=Android).
