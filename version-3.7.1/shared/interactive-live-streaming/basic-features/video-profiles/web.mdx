...
Before setting the video profile, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Video Call](/3.7.1/video-calling/quickstart-guide/get-started-sdk) or [Start a Live Interactive Video Streaming](../quickstart-guide/start-video-streaming).
