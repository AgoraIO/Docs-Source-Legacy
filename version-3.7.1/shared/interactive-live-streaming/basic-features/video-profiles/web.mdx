...
Before setting the video profile, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Video Call](start_call_web) or [Start a Live Interactive Video Streaming](../quickstart-guide/start-video-streaming).
