...
Before using super resolution, ensure that you have integrated the <code>AgoraSuperResolutionExtension.xcframework</code> dynamical library. For other requirements, see the <a href="https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/enableRemoteSuperResolution:mode:uid:">enableRemoteSuperResolution  documentation</a>.
</div>
...
- [`startRtmpStreamWithoutTranscoding`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startRtmpStreamWithoutTranscoding:)

- [`startRtmpStreamWithTranscoding`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startRtmpStreamWithTranscoding:transcoding:)

- [`updateRtmpTranscoding`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/updateRtmpTranscoding:)

- [`stopRtmpStream`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/stopRtmpStream:)

- `AgoraRtmpStreamingStateDisconnecting(5)` in [`AgoraRtmpStreamingState`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraRtmpStreamingState.html) 

- The following enumerators in [`AgoraRtmpStreamingErrorCode`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraRtmpStreamingErrorCode.html):
...
- The following enumerators in [`AgoraRtmpStreamingEvent`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraRtmpStreamingEvent.html):

  - `RTMP_STREAMING_EVENT_ADVANCED_FEATURE_NOT_SUPPORT(3)`
  - `RTMP_STREAMING_EVENT_REQUEST_TOO_OFTEN(4)`

- `watermarkArray` and `backgroundImageArray` in the [`AgoraLiveTranscoding`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraLiveTranscoding.html) class

- `zOrder` and `alpha` in `AgoraImage`

- `AgoraAudioCodecProfileHEAACv2` in the [`AgoraAudioCodecProfileType`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraAudioCodecProfileType.html) class

- `sharpnessLevel` in the [`AgoraBeautyOptions`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraBeautyOptions.html) class

**Modified**

Changed the default value of [`lighteningLevel`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraBeautyOptions.html#//api/name/lighteningLevel)  from 0.7 to 0.6
...
- [`startEchoTestWithConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc//Classes/AgoraRtcEngineKit.html#//api/name/startEchoTestWithConfig:)
- [`sharedMediaRecorderWithRtcEngine`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc//Classes/AgoraMediaRecorder.html#/api/name/sharedMediaRecorderWithRtcEngine:delegate:)
- [`stateDidChanged`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc//Protocols/AgoraMediaRecorderDelegate.html#//api/name/mediaRecorder:stateDidChanged:error:)
- [`informationDidUpdated`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc//Protocols/AgoraMediaRecorderDelegate.html#//api/name/mediaRecorder:informationDidUpdated:)
- [`startRecording`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc//Classes/AgoraMediaRecorder.html#//api/name/startRecording:)
- [`stopRecording`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc//Classes/AgoraMediaRecorder.html#//api/name/stopRecording)
- [`destroy`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc//Classes/AgoraMediaRecorder.html#//api/name/destroy)
- [`takeSnapshot`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc//Classes/AgoraRtcEngineKit.html#/api/name/takeSnapshot:uid:filePath:)
- [`snapshotTaken`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc//Protocols/AgoraRtcEngineDelegate.html#/api/name/rtcEngine:snapshotTaken:uid:filePath:width:height:errCode:)
...
- [`enableVirtualBackground`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/enableVirtualBackground:backData:)
- [`virtualBackgroundSourceEnabled`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:virtualBackgroundSourceEnabled:reason:)
- [`isMultipleChannelFrameWanted`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/isMultipleChannelFrameWanted)
- [`onPlaybackAudioFrameBeforeMixingEx`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/onPlaybackAudioFrameBeforeMixingEx:channelId:uid:)
...
- `AgoraRtmpStreamingErrorCodeUnpublishOK (100)` in [`AgoraRtmpStreamingErrorCode`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraRtmpStreamingErrorCode.html)
- `AgoraRtmpStreamingEventUrlAlreadyInUse (2)` in [`AgoraRtmpStreamingEvent`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraRtmpStreamingEvent.html)
- `AgoraEncryptionModeAES128GCM2 (7)` and `AgoraEncryptionModeAES256GCM2 (8)` in [`AgoraEncryptionMode`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraEncryptionMode.html)
- [`encryptionKdfSalt`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraEncryptionConfig.html#//api/name/encryptionKdfSalt) in `AgoraEncryptionConfig`
- [`muteLocalAudioStream`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcChannel.html#//api/name/muteLocalAudioStream:) and [`muteLocalVideoStream`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcChannel.html#//api/name/muteLocalVideoStream:) in `AgoraRtcChannel`
- `publishLocalAudio` and `publishLocalVideo` in [`AgoraRtcChannelMediaOptions`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcChannelMediaOptions.html)
- [`setVideoDataFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setVideoDataFrame:)
- [`onCaptureVideoFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoDataFrameProtocol.html#//api/name/onCaptureVideoFrame:)
- [`onPreEncodeVideoFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoDataFrameProtocol.html#//api/name/onPreEncodeVideoFrame:)
- [`onRenderVideoFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoDataFrameProtocol.html#//api/name/onRenderVideoFrame:forUid:)
- [`getVideoFormatPreference`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoDataFrameProtocol.html#//api/name/getVideoFormatPreference)
- [`getRotationApplied`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoDataFrameProtocol.html#//api/name/getRotationApplied)
- [`getMirrorApplied`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoDataFrameProtocol.html#//api/name/getMirrorApplied)
- [`getObservedFramePosition`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoDataFrameProtocol.html#//api/name/getObservedFramePosition)
- [`isMultipleChannelFrameWanted`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoDataFrameProtocol.html#//api/name/isMultipleChannelFrameWanted)
- [`onRenderVideoFrameEx`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoDataFrameProtocol.html#//api/name/onRenderVideoFrameEx:forUid:inChannel:)
- [`setVideoEncodedFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setVideoEncodedFrame:)
- [`onVideoEncodedFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoEncodedFrameProtocol.html#//api/name/onVideoEncodedFrame:)
- The following callbacks in [`AgoraAudioDataFrameProtocol`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html):
  - [`getObservedAudioFramePosition`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/getObservedAudioFramePosition)
  - [`getRecordAudioParams`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/getRecordAudioParams)
  - [`getMixedAudioParams`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/getMixedAudioParams)
  - [`getPlaybackAudioParams`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/getPlaybackAudioParams)

**Modified**

- `setAudioFrameDelegate` to [`setAudioDataFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioDataFrame:)
- `AgoraAudioFrameDelegate` to [`AgoraAudioDataFrameProtocol`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html)
- [`startAudioMixing`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startAudioMixing:loopback:replace:cycle:startPos:)
...
- [`startRhythmPlayer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startRhythmPlayer:sound2:config:)
- [`stopRhythmPlayer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/stopRhythmPlayer)
- [`configRhythmPlayer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/configRhythmPlayer:)
- [`playEffect`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/playEffect:filePath:loopCount:pitch:pan:gain:publish:startPos:)3
- [`getEffectDuration`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/getEffectDuration:)
- [`setEffectPosition`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setEffectPosition:pos:)
- [`getEffectCurrentPosition`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/getEffectCurrentPosition:)
- [`startAudioMixing`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startAudioMixing:loopback:replace:cycle:startPos:)2
- [`startAudioRecordingWithConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startAudioRecordingWithConfig:)3
- `AgoraLocalVideoStreamErrorCaptureNoDeviceFound(8)` in [`AgoraLocalVideoStreamError`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraLocalVideoStreamError.html)
- [Error Code](../reference/error-codes): `AgoraErrorCodeAlreadyInRecording(160)`

**Modified**

- [`localAudioMixingStateDidChanged`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:localAudioMixingStateDidChanged:reason:)
...
This release adds the following APIs:
- [`setVoiceConversionPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setVoiceConversionPreset:)
- `AgoraEncryptionModeAES128GCM` and `AgoraEncryptionModeAES256GCM` in [`AgoraEncryptionMode`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraEncryptionMode.html) 
- `mosValue` in [`AgoraRtcRemoteAudioStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcRemoteAudioStats.html)
...
- [`setVoiceBeautifierParameters`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setVoiceBeautifierParameters:param1:param2:)
- `AgoraSingingBeautifier` in the [`AgoraVoiceBeautifierPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraVoiceBeautifierPreset.html) constant
- [`enableDeepLearningDenoise`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/enableDeepLearningDenoise:)
- [`joinChannelByToken`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/joinChannelByToken:channelId:info:uid:options:)2
- [`switchChannelByToken`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/switchChannelByToken:channelId:options:)2
- [`createDataStream`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/createDataStream:config:)
- The `logConfig` property in the [`AgoraRtcEngineConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineConfig.html) class
- [`setAudioFrameDelegate`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioFrameDelegate:)
- [`onRecordAudioFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioFrameDelegate.html#//api/name/onRecordAudioFrame:)
- [`onPlaybackAudioFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioFrameDelegate.html#//api/name/onPlaybackAudioFrame:)
- [`onMixedAudioFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioFrameDelegate.html#//api/name/onMixedAudioFrame:)
- [`onPlaybackAudioFrameBeforeMixing`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioFrameDelegate.html#//api/name/onPlaybackAudioFrameBeforeMixing:uid:)
- The `qoeQuality` and `qualityChangedReason` properties in the [`AgoraRtcRemoteAudioStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcRemoteAudioStats.html) class
- [`setCloudProxy`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setCloudProxy:)
- The `captureBrightnessLevel` property in the [`AgoraRtcLocalVideoStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcLocalVideoStats.html) class
- The `captureWidth` and `captureHeight` properties in the [`AgoraCameraCapturerConfiguration`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraCameraCapturerConfiguration.html) class
- `AgoraCameraCaptureOutputPreferenceManual(3)` in the [`AgoraCameraCaptureOutputPreference`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraCameraCaptureOutputPreference.html) constant
- `AgoraLocalVideoStreamErrorCaptureInBackGround(6)` and `AgoraLocalVideoStreamErrorCaptureMultipleForegroundApps(7)` in the [`AgoraLocalVideoStreamError`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraLocalVideoStreamError.html) constant
- Error code: [`AgoraErrorCodeModuleNotFound(157)`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraErrorCode.html)
...
- [`setClientRole`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setClientRole:options:)
- [`setAudioEffectPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioEffectPreset:)
- [`setVoiceBeautifierPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setVoiceBeautifierPreset:)
- [`setAudioEffectParameters`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioEffectParameters:param1:param2:)
- `AgoraAudioScenarioMeeting(8)` in [`AgoraAudioScenario`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Constants/AgoraAudioScenario.html)
...
- [`didAudioPublishStateChange`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:didAudioPublishStateChange:oldState:newState:elapseSinceLastState:)
- [`didVideoPublishStateChange`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:didVideoPublishStateChange:oldState:newState:elapseSinceLastState:)
- [`didAudioSubscribeStateChange`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:didAudioSubscribeStateChange:withUid:oldState:newState:elapseSinceLastState:)
- [`didVideoSubscribeStateChange`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:didVideoSubscribeStateChange:withUid:oldState:newState:elapseSinceLastState:)
- [`firstLocalAudioFramePublished`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:firstLocalAudioFramePublished:)
- [`firstLocalVideoFramePublished`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:firstLocalVideoFramePublished:)
...
- `txPacketLossRate` in [`AgoraRtcLocalAudioStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcLocalAudioStats.html) class
- `txPacketLossRate` and `captureFrameRate` in [`AgoraRtcLocalVideoStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcLocalVideoStats.html) class
- `publishDuration` in [`AgoraRtcRemoteAudioStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcRemoteAudioStats.html) and [`AgoraRtcRemoteVideoStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcRemoteVideoStats.html) class
- `captureType` and `contentHint` in [`AgoraVideoSourceProtocol`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraVideoSourceProtocol.html) protocol
- [`rtmpStreamingEventWithUrl`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:rtmpStreamingEventWithUrl:eventCode:)
...
- [`setLocalRenderMode`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/v3.0.0/Classes/AgoraRtcEngineKit.html#//api/name/setLocalRenderMode:mirrorMode:)
...
- `firstRemoteAudioFrameDecodedOfUid` and `firstRemoteAudioFrameOfUid`. Use the [`remoteAudioStateChangedOfUid`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:remoteAudioStateChangedOfUid:state:reason:elapsed:) callback instead.
...
The new callback reports most of the remote video states, and therefore deprecates the [`firstRemoteVideoDecodedOfUid`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:firstRemoteVideoDecodedOfUid:size:elapsed:) callback. You can still use it, but we do not recommend doing so.
...
In scenarios such as the video chat, interactive streaming, and online education, basic beautification is a popular feature. v2.4.0 adds the [`setBeautyEffectOptions`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setBeautyEffectOptions:options:) method, allowing you to adjust the contrast, brightness, smoothness and red saturation of an image. For more information, see [Image Enhancement](image_enhancement_ios).
...
- [`setRemoteUserPriority`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setRemoteUserPriority:type:)
