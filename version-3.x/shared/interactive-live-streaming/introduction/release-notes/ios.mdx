import ThreeSevenTwo from './372.mdx' ;
...
To upgrade the <Vg k="VIDEO" /> Native SDK, you must re-integrate the dynamic library, `AgoraRtcKit.framework`.
