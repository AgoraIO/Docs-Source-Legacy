...
If you are integrating by using the [SDK download link](https://docs.agora.io/en/sdks?platform=macos), when you upgrade to v3.6.2, you must modify the project as follows:
