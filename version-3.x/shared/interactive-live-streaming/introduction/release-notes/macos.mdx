...
If you are integrating by using the [SDK download link](https://docs.agora.io/en/Interactive%20Broadcast/downloads?platform=macOS), when you upgrade to v3.6.2, you must modify the project as follows:
...
For integration details, see the [Quickstart Guide](../quickstart-guide/start-video-streaming).
...
To unify the library names across platforms, this release renames the library from `AgoraRtcEngineKit.framework` to `AgoraRtcKit.framework`. If you upgrade your SDK to v3.0.0, you must re-import the `AgoraRtcKit` class. For details, see [Import the class](../quickstart-guide/start-video-streaming#a-nameimportclassa2-import-the-class) in the Quickstart.
...
If you prefer the dynamic library, you need to re-integrate the SDK and re-import the `AgoraRtcKit` class. This process should take no more than five minutes. See [Integrate the SDK](../quickstart-guide/start-video-streaming#a-nameintegratesdkaintegrate-the-sdk) and [Import the class](../quickstart-guide/start-video-streaming#a-nameimportclassa2-import-the-class) in the Quickstart.
