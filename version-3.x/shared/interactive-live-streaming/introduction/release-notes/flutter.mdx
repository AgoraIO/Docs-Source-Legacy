...
v5.3.0 adapts to the Agora <Vg k="VSDK" /> Native SDK v3.7.0.2. For new features and improvements, see the release notes for each platform from v3.6.2 to v3.7.0.2:
...
v5.1.0 adapts to the Agora <Vg k="VSDK" /> Native SDK v3.6.2. For new features and improvements, see the release notes for each platform from 3.5.2 to 3.6.2:
...
As of v5.0.0, the Agora <Vg k="VSDK" /> Flutter SDK supports Flutter 2.x and can run on Android, iOS, macOS, and Windows platforms.
...
v5.0.0 adapts to the Agora <Vg k="VSDK" /> Native SDK v3.5.2. For new features and improvements, see the release notes for each platform from 3.5.0.4 to 3.5.2:
...
Since this version, Agora <Vg k="VSDK" /> Flutter SDK supports null safety. Because null safety is not backward compatible, **you must ensure that the dart version is 2.12 or higher**. See [Flutter documentation](https://dart.dev/null-safety) for more information.

2. Flutter 2.x support (Android and iOS only)

Since this version, Agora <Vg k="VSDK" /> Flutter SDK supports Flutter 2.x (Android and iOS only.)
