...
- [`enableVirtualBackground`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/RtcEngine/enableVirtualBackground.html)
- [`VirtualBackgroundSourceEnabled`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/RtcEngineEventHandler/virtualBackgroundSourceEnabled.html)

**Modified**

- [`setEnableSpeakerphone`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/RtcEngine/setEnableSpeakerphone.html)
- [`setDefaultAudioRouteToSpeakerphone`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/RtcEngine/setDefaultAudioRoutetoSpeakerphone.html)
...
- [`RtcEngineContext`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/RtcEngineContext/RtcEngineContext.html) class
- [`createWithContext`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/RtcEngine/createWithContext.html)
- [`UnPublishOK (100)`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/RtmpStreamingErrorCode-class.html) in `RtmpStreamingErrorCode`
- [`UrlAlreadyInUse (2)`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_channel/RtcChannelEventHandler/rtmpStreamingEvent.html) in `RtmpStreamingEvent`
- `AES128GCM2 (7)` and `AES256GCM2 (8)`in [`EncryptionMode`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/EncryptionMode-class.html)
- `encryptionKdfSalt` in [`EncryptionConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/EncryptionConfig-class.html)
- [`muteLocalAudioStream`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/RtcEngine/muteLocalAudioStream.html) and [`muteLocalVideoStream`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/RtcEngine/muteLocalAudioStream.html) in `RtcChannel`
- `publishLocalAudio` and `publishLocalVideo` in [`ChannelMediaOptions`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/ChannelMediaOptions-class.html)
- `Interrupted (8)` in [`AudioLocalError`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/agora_rtc_engine/AudioLocalError-class.html)
...
- [`startRhythmPlayer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/startRhythmPlayer.html)
- [`stopRhythmPlayer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/stopRhythmPlayer.html)
- [`configRhythmPlayer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/configRhythmPlayer.html)
- [`startAudioRecordingWithConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/startAudioRecordingWithConfig.html)
- [`getEffectDuration`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/getEffectDuration.html)
- [`setEffectPosition`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/setEffectPosition.html)
- [`getEffectCurrentPosition`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/getEffectCurrentPosition.html)
- `filePath` in [`getAudioMixingDuration`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/getAudioMixingDuration.html)
- `startPos` in [`playEffect`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/playEffect.html)
- `startPos` in [`startAudioMixing`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/startAudioMixing.html)
- `DeviceNotFound(8)` in [`LocalVideoStreamError`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/LocalVideoStreamError-class.html)
- [`Error code`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/ErrorCode-class.html): `AlreadyInRecording(160)`

**Modified**

- [`AudioMixingStateChanged`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngineEventHandler/audioMixingStateChanged.html)
...
- [`createWithConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/createWithConfig.html)
- [`setVoiceConversionPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/setVoiceConversionPreset.html)
- `AES128GCM` and `AES256GCM` in [`EncryptionMode`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/EncryptionConfig-class.html)
- `mosValue` in [`RemoteAudioStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RemoteAudioStats-class.html)
- [`setVoiceBeautifierParameters`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/setVoiceBeautifierParameters.html)
- `SingingBeautifier` in the [`VoiceBeautifierPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/VoiceBeautifierPreset-class.html) constant
- [`enableDeepLearningDenoise`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/enableDeepLearningDenoise.html)
- `options` in [`joinChannel`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_channel/RtcChannel/joinChannel.html)
- `options` in [`switchChannel`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/switchChannel.html)
- [`createDataStreamWithConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_channel/RtcChannel/createDataStreamWithConfig.html)
- `qoeQuality` and `qualityChangedReason` in [`RemoteAudioStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RemoteAudioStats-class.html)
- [`setCloudProxy`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/setCloudProxy.html)
- The `captureBrightnessLevel` property in the [`LocalVideoStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/LocalVideoStats-class.html)
- The `captureWidth` and `captureHeight` properties in the [`CameraCapturerConfiguration`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/CameraCapturerConfiguration-class.html) class
- `Manual(3)` in the [`CameraCaptureOutputPreference`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/CameraCaptureOutputPreference-class.html) constant
- `CaptureInBackGround(6)` and `CaptureMultipleForegroundApps(7)` in the [`LocalVideoStreamError`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/LocalVideoStreamError-class.html) constant
- Error code: [`ModuleNotFound(157)`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/ErrorCode-class.html)
...
- `options`in [`setClientRole`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_channel/RtcChannel/setClientRole.html)
- [`setAudioEffectPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/setAudioEffectPreset.html)
- [`setVoiceBeautifierPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/setVoiceBeautifierPreset.html)
- [`setAudioEffectParameters`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/RtcEngine/setAudioEffectParameters.html)
- `MEETING(8)` in [`AudioScenario`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/flutter/rtc_engine/AudioScenario-class.html)
