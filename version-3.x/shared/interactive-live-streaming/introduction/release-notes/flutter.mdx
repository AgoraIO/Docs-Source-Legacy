...
## v5.3.1 (Native v3.7.0.2)
v5.3.1 was released on September 27, 2022.

#### Fixed issues
This release fixed the following issues:

- The app was killed and reported the error message "Sending a message before the FlutterEngine has been run". (iOS)
- The video did not automatically switch back to camera after screen sharing stopped. (Android, iOS)
- The `facePositionChanged` callback error.
- The `VideoRemoteStateReason` enum parse error.

## v5.3.0 (Native v3.7.0.2)
v5.3.0 was released on July 20, 2022.

#### New features and improvements
v5.3.0 adapts to the Agora <Vg k="VIDEO" /> Native SDK v3.7.0.2. For new features and improvements, see the release notes for each platform from v3.6.2 to v3.7.0.2:
...
- <Link to="../introduction/release-notes?platform=windows-cpp">Windows Release Notes</Link>
...
v5.1.0 adapts to the Agora <Vg k="VIDEO" /> Native SDK v3.6.2. For new features and improvements, see the release notes for each platform from 3.5.2 to 3.6.2:
...
As of v5.0.0, the Agora <Vg k="VIDEO" /> Flutter SDK supports Flutter 2.x and can run on Android, iOS, macOS, and Windows platforms.
...
v5.0.0 adapts to the Agora <Vg k="VIDEO" /> Native SDK v3.5.2. For new features and improvements, see the release notes for each platform from 3.5.0.4 to 3.5.2:
...
<div class="alert note">Before you use virtual backgrounds, ensure that the device performance and user scenarios meet the requirements. See <a href="https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/RtcEngine/enableVirtualBackground.html">enableVirtualBackground</a > documentation.</div>
...
- [`enableVirtualBackground`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/RtcEngine/enableVirtualBackground.html)
- [`VirtualBackgroundSourceEnabled`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/RtcEngineEventHandler/virtualBackgroundSourceEnabled.html)

**Modified**

- [`setEnableSpeakerphone`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/RtcEngine/setEnableSpeakerphone.html)
- [`setDefaultAudioRouteToSpeakerphone`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/RtcEngine/setDefaultAudioRoutetoSpeakerphone.html)
...
- [`RtcEngineContext`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/RtcEngineContext/RtcEngineContext.html) class
- [`createWithContext`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/RtcEngine/createWithContext.html)
- [`UnPublishOK (100)`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/RtmpStreamingErrorCode-class.html) in `RtmpStreamingErrorCode`
- [`UrlAlreadyInUse (2)`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_channel/RtcChannelEventHandler/rtmpStreamingEvent.html) in `RtmpStreamingEvent`
- `AES128GCM2 (7)` and `AES256GCM2 (8)`in [`EncryptionMode`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/EncryptionMode-class.html)
- `encryptionKdfSalt` in [`EncryptionConfig`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/EncryptionConfig-class.html)
- [`muteLocalAudioStream`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/RtcEngine/muteLocalAudioStream.html) and [`muteLocalVideoStream`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/RtcEngine/muteLocalAudioStream.html) in `RtcChannel`
- `publishLocalAudio` and `publishLocalVideo` in [`ChannelMediaOptions`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/ChannelMediaOptions-class.html)
- `Interrupted (8)` in [`AudioLocalError`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/agora_rtc_engine/AudioLocalError-class.html)
...
Since this version, Agora <Vg k="VIDEO" /> Flutter SDK supports null safety. Because null safety is not backward compatible, **you must ensure that the dart version is 2.12 or higher**. See [Flutter documentation](https://dart.dev/null-safety) for more information.

2. Flutter 2.x support (Android and iOS only)

Since this version, Agora <Vg k="VIDEO" /> Flutter SDK supports Flutter 2.x (Android and iOS only.)
...
- [`startRhythmPlayer`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/startRhythmPlayer.html)
- [`stopRhythmPlayer`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/stopRhythmPlayer.html)
- [`configRhythmPlayer`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/configRhythmPlayer.html)
- [`startAudioRecordingWithConfig`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/startAudioRecordingWithConfig.html)
- [`getEffectDuration`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/getEffectDuration.html)
- [`setEffectPosition`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/setEffectPosition.html)
- [`getEffectCurrentPosition`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/getEffectCurrentPosition.html)
- `filePath` in [`getAudioMixingDuration`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/getAudioMixingDuration.html)
- `startPos` in [`playEffect`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/playEffect.html)
- `startPos` in [`startAudioMixing`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/startAudioMixing.html)
- `DeviceNotFound(8)` in [`LocalVideoStreamError`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/LocalVideoStreamError-class.html)
- [`Error code`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/ErrorCode-class.html): `AlreadyInRecording(160)`

**Modified**

- [`AudioMixingStateChanged`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngineEventHandler/audioMixingStateChanged.html)
...
- [`createWithConfig`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/createWithConfig.html)
- [`setVoiceConversionPreset`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/setVoiceConversionPreset.html)
- `AES128GCM` and `AES256GCM` in [`EncryptionMode`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/EncryptionConfig-class.html)
- `mosValue` in [`RemoteAudioStats`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RemoteAudioStats-class.html)
- [`setVoiceBeautifierParameters`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/setVoiceBeautifierParameters.html)
- `SingingBeautifier` in the [`VoiceBeautifierPreset`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/VoiceBeautifierPreset-class.html) constant
- [`enableDeepLearningDenoise`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/enableDeepLearningDenoise.html)
- `options` in [`joinChannel`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_channel/RtcChannel/joinChannel.html)
- `options` in [`switchChannel`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/switchChannel.html)
- [`createDataStreamWithConfig`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_channel/RtcChannel/createDataStreamWithConfig.html)
- `qoeQuality` and `qualityChangedReason` in [`RemoteAudioStats`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RemoteAudioStats-class.html)
- [`setCloudProxy`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/setCloudProxy.html)
- The `captureBrightnessLevel` property in the [`LocalVideoStats`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/LocalVideoStats-class.html)
- The `captureWidth` and `captureHeight` properties in the [`CameraCapturerConfiguration`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/CameraCapturerConfiguration-class.html) class
- `Manual(3)` in the [`CameraCaptureOutputPreference`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/CameraCaptureOutputPreference-class.html) constant
- `CaptureInBackGround(6)` and `CaptureMultipleForegroundApps(7)` in the [`LocalVideoStreamError`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/LocalVideoStreamError-class.html) constant
- Error code: [`ModuleNotFound(157)`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/ErrorCode-class.html)
...
- `options`in [`setClientRole`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_channel/RtcChannel/setClientRole.html)
- [`setAudioEffectPreset`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/setAudioEffectPreset.html)
- [`setVoiceBeautifierPreset`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/setVoiceBeautifierPreset.html)
- [`setAudioEffectParameters`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/RtcEngine/setAudioEffectParameters.html)
- `MEETING(8)` in [`AudioScenario`](https://api-ref.agora.io/en/video-sdk/flutter/5.x/rtc_engine/AudioScenario-class.html)
...
- Adapts to Agora <Vg k="VSDK" /> v3.1.2.
...
Agora provides an open-source [Agora Flutter Quickstart](https://github.com/AgoraIO-Community/Agora-Flutter-Quickstart) on GitHub.

<div class="alert note">To improve user experience, this version disables the local network connection quality report by default, to prevent the prompt to find local network devices from popping up when an end user launches the app on an iOS 14.0 device. The <code>[[gatewayRtt](https://api-ref.agora.io/en/video-sdk/ios/3.x/Classes/AgoraChannelStats.html#//api/name/gatewayRtt)</code> parameter in the <code>RtcStats</code> callback is disabled by default. Do not use <code>[[gatewayRtt](https://api-ref.agora.io/en/video-sdk/ios/3.x/Classes/AgoraChannelStats.html#//api/name/gatewayRtt)</code> to obtain the round-trip delay between the client and the local router. See the <a href="https://docs.agora.io/en/help/integration-issues/local_network_privacy">FAQ</a> for details.</div>
