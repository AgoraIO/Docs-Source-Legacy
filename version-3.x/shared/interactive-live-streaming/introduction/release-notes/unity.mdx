...
<div class="alert note">
  Before using super resolution, ensure that you have integrated the relevant
  dynamical libraries:
  <ul>
    <li>
      Android: <code>libagora_super_resolution_extension.so</code>
    </li>
    <li>
      iOS: <code>AgoraSuperResolutionExtension.xcframework</code>
    </li>
    <li>
      macOS: <code>AgoraSuperResolutionExtension.xcframework</code>
    </li>
    <li>
      Windows: <code>libagora_super_resolution_extension.dll</code>
    </li>
  </ul>
</div>
...
<div class="alert note">
  These video enhancement features have certain performance requirements on
  devices. If your device begins to overheat after you enable video enhancement,
  modify the video enhancement options to a less performance-consuming level or
...
<div class="alert note">
  Calling <code>StartAudioRecordingDeviceTest</code>,{' '}
  <code>StartAudioPlaybackDeviceTest</code>, or{' '}
  <code>StartAudioDeviceLoopbackTest</code> after joining a channel tests the
  audio devices that the SDK is using.
</div>
...
<div class="alert info">
  {' '}
  This release deprecates three old methods for CDN live streaming: <code>
    AddPublishStreamUrl
  </code>, <code>SetLiveTranscoding</code>, and <code>
    RemovePublishStreamUrl
  </code>. Agora recommends that you use the new methods for CDN live streaming and
  update your code logic by referring to <a href="../advanced-features/media-push">
    Media Push
  </a>.{' '}
</div>
...
<div class="alert note">
  To ensure the quality of the CDN live streaming, make sure to handle the
  business logic according to the state code, error code, and event code.
</div>
...
<div class="alert note">
  {' '}
  In the <code>COMMUNICATION</code> channel profile, this function is incompatible
  with versions of the SDK earlier than v3.0.1.
</div>
...
<div class="alert note">
  Before using super resolution, ensure that you have integrated the relevant
  dynamical library and that the device performance, number of remote users, and
  original resolution of remote user's video meet the requirements. For details,
  see the <a href="">EnableRemoteSuperResolution</a> documentation.{' '}
</div>
...
<div class="alert note">
  If the user device is connected to another display, to avoid screen sharing
  issues, use <code>StartScreenCaptureByDisplayId</code> to start sharing
  instead of using <code>StartScreenCaptureByScreenRect</code>.
</div>
...
<div class="alert note">
  As of this release, ensure that you have integrated the{' '}
  <code>libagora_video_process_extension.dll</code> dynamic library before
  calling <code>SetBeautyEffectOptions</code>; otherwise, you cannot experience
  the optimized image enhancement effects and sharpness adjustment brought out
  by the updated Agora image enhancement algorithm, but only the image
  enhancement effects brought out by the older Agora image enhancement
  algorithm.
</div>
...
- `blur_degree` and `BACKGROUND_BLUR_DEGREE` in [`VirtualBackgroundSource`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/structagora__gaming__rtc_1_1_virtual_background_source.html)
- `BACKGROUND_BLUR` in [`BACKGROUND_SOURCE_TYPE`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/structagora__gaming__rtc_1_1_virtual_background_source.html#acc50460b6a0de5f4d2878440f3d06513)
- [`PushAudioFrame`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#aa791dd3de749a2a2e144e5e28d0b4170)
- [`SetExternalAudioSourceVolume`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a07bb1b1736107af4b4cdb2523f093e17)
- [`SetAudioMixingPlaybackSpeed`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#ab09032a08860ae8a3fc2cc390c353320)
- [`GetAudioTrackCount`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a36fd324b786827c3dfcc7dd4c84026ca)
- [`SelectAudioTrack`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#ab7394e0ee051280637c89c432dc03679)
- [`SetAudioMixingDualMonoMode`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a79e893c724bc60d3a01d022a69983704)
- [`PauseAllChannelMediaRelay`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a652e58225c2d13e4f9b3c61e43963a9b)
- [`ResumeAllChannelMediaRelay`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#ae6dd13ac6cd8e77652ee6b6b74be5e8a)
- The following enumerators in [`CHANNEL_MEDIA_RELAY_EVENT`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/namespaceagora__gaming__rtc.html#a02d1e8579142814739af24c65f320d6e):
...
- [`GetAudioFileInfo`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a6f9438df3f15a0052cc282d42681a655)
- [`OnRequestAudioFileInfoHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/namespaceagora__gaming__rtc.html#a0090cc1f5259b022105d3bb3cea84337)
- `LOCAL_AUDIO_STREAM_ERROR_RECORD_INVALID_ID(9)` and `LOCAL_AUDIO_STREAM_ERROR_PLAYOUT_INVALID_ID(10)` in [`LOCAL_AUDIO_STREAM_ERROR`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/namespaceagora__gaming__rtc.html#a635752ff6077fa96e730f513668a0c04)
- `NETWORK_TYPE_MOBILE_5G(6)` in [`NETWORK_TYPE`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/namespaceagora__gaming__rtc.html#ad2817b616c08cb15a3505caa75e413b1)
- [`StartEchoTest`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a3eed33e686179e037e3cd43c9f597667) [3/3]
- [`StartScreenCaptureByDisplayId`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a9fa9dd48fc3ecf616d39f6fdf00000c2)
- [`GetScreenCaptureManager`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#aacfde52a4f48e9634083ebcc9560e416)
- [`GetMediaRecorder`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#ac3202f06fb134e2e1ed56017fcab2595)
- [`OnRecorderStateChangedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_media_recorder.html?platform=Unity#a35df18677b5416409408eb44bca91993)
- [`OnRecorderInfoUpdatedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_media_recorder.html#ac330fa8083acd46b38343c4da7cd413a)
- [`StartRecording`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_media_recorder.html#a7bb3a157427c33f111eb7d5c013cca20)
- [`StopRecording`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_media_recorder.html#ade0ca8f80b2ebbc738b683c0cae4b128)
- [`initMediaRecorderObserver`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_media_recorder.html#a99e85b49decec8b820298e6700093b84)
- [`TakeSnapshot`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a4bc1f1ab66339e36e43f8edc4fef7a78)
- [`OnSnapshotTakenHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/namespaceagora__gaming__rtc.html#a7b23f3773fbf3167fe051b846e490219)
- The following enumerators in [`LOCAL_VIDEO_STREAM_ERROR`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/namespaceagora__gaming__rtc.html#a66baa891d5de1a2d43341b5460b2f059)：
  - `LOCAL_VIDEO_STREAM_ERROR_DEVICE_INVALID_ID(10)`
  - `LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_OCCLUDED(13)`
  - `LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_NOT_SUPPORTED(20)`
- [`StartRtmpStreamWithoutTranscoding`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a2f0994dbc3b1bb8e23853ffdb67d0dd9)
- [`StartRtmpStreamWithTranscoding`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a34fbe006d84d0542e652a49492711900)
- [`UpdateRtmpTranscoding`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a2454acc0080f36a32c98a41d3c7f08ae)
- [`StopRtmpStream`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a4a48fd2558f15a25e0845e57f08dc7f3)
- `RTMP_STREAM_PUBLISH_STATE_DISCONNECTING(5)` in [`RTMP_STREAM_PUBLISH_STATE`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/namespaceagora__gaming__rtc.html#a2132250fb5d8c8e0f3e52bf15449f2ff)
- The following enumerators in [`RTMP_STREAM_PUBLISH_ERROR_TYPE`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/namespaceagora__gaming__rtc.html#acf64f163b1768d834ce6b8cbabcf235d):
...
- The following enumerators in[`RTMP_STREAMING_EVENT`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/namespaceagora__gaming__rtc.html#a1161b5f270933ebd660b9c29848161aa):
  - `RTMP_STREAMING_EVENT_ADVANCED_FEATURE_NOT_SUPPORT(3)`
  - `RTMP_STREAMING_EVENT_REQUEST_TOO_OFTEN(4)`
- `watermarkCount` and `backgroundImageCount` in [`LiveTranscoding`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/structagora__gaming__rtc_1_1_live_transcoding.html)
- `zOrder` and `alpha` in [`RtcImage`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/structagora__gaming__rtc_1_1_rtc_image.html)
- `AUDIO_CODEC_PROFILE_HE_AAC_V2(2)` in [`AUDIO_CODEC_PROFILE_TYPE`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/namespaceagora__gaming__rtc.html#ac158d8109203b32bfe60cbadf37dfe80)
- [`GetAudioRecordingDefaultDevice`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_audio_recording_device_manager.html#a817e38006202b733f8608765d7353a7d)
- [`GetAudioPlaybackDefaultDevice`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_audio_playback_device_manager.html#ad91f0d3230c10042498bfecdbbe9a7c5)
- [`FollowSystemPlaybackDevice`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_audio_playback_device_manager.html#a2884fba3f5506bfc6658c431b3a75111)
- [`FollowSystemRecordingDevice`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/classagora__gaming__rtc_1_1_audio_recording_device_manager.html#a52fe58871ce03f0893e19173fa77baaa)
- `sharpnessLevel` in [`BeautyOptions`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.6.1.1/structagora__gaming__rtc_1_1_beauty_options.html)
...
- When the SDK uses the media volume, the audio route is affected as follows:
  ...
  <div class="alert info">
    To learn about the scenarios where the SDK uses the media volume, see{' '}
    <a href="https://docs.agora.io/en/help/integration-issues/system_volume">
...
- On Android and iOS, this release adds the `EnableVirtualBackground` method, with which you can enable and set a virtual background for users as either a solid color or an image in PNG or JPG format. You can use the `OnVirtualBackgroundEnabledHandler` callback to learn whether the virtual background is successfully enabled or the reason for an error.
  ...
  <div class="alert info">
    Before you use virtual backgrounds, ensure that the relevant dynamic library
    is integrated and that the device performance and user scenarios meet the
    requirements. See{' '}
    <a href="https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a04418596cd2717aaf2a1da9f7f35b392">
      {' '}
      EnableVirtualBackground documentation{' '}
    </a>
    .
  </div>
...
- [`SetEnableSpeakerphone`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#aa8ef8504581b10975ceb2dc86c133481)
- [`SetDefaultAudioRouteToSpeakerphone`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a7ed850ab08664fb9b847ac9416e7fec5)
...
<div class="alert note">
  Once you enable the built-in encryption, all users in the same channel must
  use the same encryption mode and key, including the server-side users such as
  the Agora recording service.
</div>
...
- [`EnableVirtualBackground`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.4.5/classagora__gaming__rtc_1_1_i_rtc_engine.html#a04418596cd2717aaf2a1da9f7f35b392)
- [`OnVirtualBackgroundSourceEnabledHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.4.5/namespaceagora__gaming__rtc.html#a2b90fcf68a2901aa1ba7184e6cac1d53)
- `RTMP_STREAM_UNPUBLISH_ERROR_OK (100)` in [`RTMP_STREAM_PUBLISH_ERROR`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html?platform=Unity#adf0b94807c88344092613487b0dfa0c9)
- `RTMP_STREAMING_EVENT_URL_ALREADY_IN_USE (2)` in [`RTMP_STREAMING_EVENT`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html?platform=Unity#a1161b5f270933ebd660b9c29848161aa)
- `AES_128_GCM2 (7)` and `AES_256_GCM2 (8)` in [`EncryptionMode`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a94f249e19d1de6e0a6ac2348ace088fb)
- [`encryptionKdfSalt`](https://api-ref.agora.io/en/video-sdk/unity/3.x/v3.4.5/structagora__gaming__rtc_1_1_encryption_config.html#ae88de9e9ef42b206d9de307d2f4bc47a) in [`EncryptionConfig`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_encryption_config.html)
- [`MuteLocalAudioStream`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html?platform=Unity#a6260eac33b6624824872a7140a229ef3) and [`MuteLocalVideoStream`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html?platform=Unity#a80cd4eaa589f66059912eee08ed8b20a) in `IRtcEngine`
- [`publishLocalAudio`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_channel_media_options.html?platform=Unity#ae7cf13e792f38e45ed5a1a35f8c948c7) and [`publishLocalVideo`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_channel_media_options.html?platform=Unity#a4daaa2d2546779e80784f2bfc3728825) in [`ChannelMediaOptions`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_channel_media_options.html)
- `MEDIA_DEVICE_STATE_IDLE (0)` in [`MEDIA_DEVICE_STATE_TYPE`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html?platform=Unity#ad862a26da27e398f045eb4a95bcfa530)

**Modified**

- [`MEDIA_DEVICE_STATE_TYPE`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html?platform=Unity#ad862a26da27e398f045eb4a95bcfa530)
...
- [`AdjustLoopbackRecordingSignalVolume`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a2b44e09cccfed942c6df06551d3aca29)
- [`GetAudioMixingDuration`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a581955d6b97a81c7edf2b9aea88cfcb2) [2/2]
- [`StartAudioRecording`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a3fde78b23f4f36610c15d22f9392f2ca) [3/3]
- [`GetEffectDuration`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_audio_effect_manager_impl.html#a9dbc262a96b256b3fcc04c510cc8666a)
- [`SetEffectPosition`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_audio_effect_manager_impl.html#a89bf6f0ae950354545dc94f94609b753)
- [`GetEffectCurrentPosition`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_audio_effect_manager_impl.html#a415b3e9805bbf513039ed7ef48c74bd8)
- [`PlayEffect`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_audio_effect_manager_impl.html#a221f53a8c7c857c1b94133f481a9c3d4) [2/2]
- [`StartAudioMixing`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a37642f8384220a6494232d90e1fbd8c3) [2/2]
- `LOCAL_VIDEO_STREAM_ERROR_DEVICE_NOT_FOUND(8)` in [`LOCAL_VIDEO_STREAM_ERROR`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a66baa891d5de1a2d43341b5460b2f059)
- `LOCAL_AUDIO_STREAM_ERROR_NO_RECORDING_DEVICE(6)` and `LOCAL_AUDIO_STREAM_ERROR_NO_PLAYOUT_DEVICE(7)` in [`LOCAL_AUDIO_STREAM_ERROR`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a635752ff6077fa96e730f513668a0c04)
- Error code: `-160`

**Modified**

- [`OnAudioMixingStateChangedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a41f42633cf2053de2dc6b4dd0a085a1f)
...
<div class="alert note">
  Before enabling deep-learning noise reduction, integrate the deep-learning
  noise reduction library into your project files.
</div>
...
- [`SetVoiceConversionPreset`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#aee2fb5664266783a9ff855b4ef81e1b6)
- `AES_128_GCM` and `AES_256_GCM` in [`ENCRYPTION_MODE`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_encryption_config.html)
- [`SetVoiceBeautifierParameters`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#acb6c5d42ea4e14b0f2e7bc8f27bc2def)
- `SINGING_BEAUTIFIER` in [`VOICE_BEAUTIFIER_PRESET`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a95376eca24c67a6c2bee9d0ca2b2e7d6)
- [`EnableDeepLearningDenoise`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a401707e8917f9af84c3a77e77f0160e5)
- [`JoinChannel`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#ad64ca959b93b2678df44777ad20e2072)2
- [`SwitchChannel`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a44cde739692d5a4326b918d631170be9)2
- [`CreateDataStream`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a2779954830d051179e574e1c744fb411)
- `logConfig` in [`RtcEngineConfig`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_rtc_engine_config.html)
- `qoeQuality`, `qualityChangedReason` and `mosValue` in [`RemoteAudioStats`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_remote_audio_stats.html)
- [`SetCloudProxy`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#ad354f9ec01a0985f76f82cae1fafee5e)
- `captureBrightnessLevel` in [`LocalVideoStats`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_local_video_stats.html)
- `captureWidth` and `captureHeight` in [`CameraCapturerConfiguration`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_camera_capturer_configuration.html)
- `CAPTURER_OUTPUT_PREFERENCE_MANUAL(3)` in [`CAPTURER_OUTPUT_PREFERENCE`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a6642195eed7dc4bd5457f41992bf0e36)
...
<div class="alert note">
  Transport layer encryption affects the size of the SDK package. For details,
...
- [`SetClientRole`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a9a31f9b8e45c6528d6f56914619de314)
- [`SetAudioEffectPreset`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a4bbf600b51a400fe6ab261a95e47bad6)
- [`SetVoiceBeautifierPreset`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#ab4953c6ce75adc42a13297af41676d9a)
- [`SetAudioEffectParameters`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a9ccf7abdd5f7b4bc0e7f0a7807e34390)
...
- [`OnAudioPublishStateChangedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#aabfff11675d45572de8eb5f28d80ac33)
- [`OnVideoPublishStateChangedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#acbe99ccc22853645819110b5cf311142)
- [`OnAudioSubscribeStateChangedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#aa0283db27464a1cc827515853db924c5)
- [`OnVideoSubscribeStateChangedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#aae17c7a5b5eee64af5402f9f93a5616f)
- [`OnFirstLocalAudioFramePublishedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a2be635d5257a7673102e0e0e62c73793)
- [`OnFirstLocalVideoFramePublishedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#abc5c6cb1cfb6e7340fc10dc554d6ab3a)
- [`OnRtmpStreamingEventHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a78104eee847716bfd43f7efd5cdd8b58)
- `txPacketLossRate` in [`LocalAudioStats`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_local_audio_stats.html)
- `txPacketLossRate` and `captureFrameRate` in [`LocalVideoStats`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_local_video_stats.html)
- `publishDuration` in [`RemoteAudioStats`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_remote_audio_stats.html) and [`RemoteVideoStats`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_remote_video_stats.html)
- `AUDIO_SCENARIO_MEETING(8)` in [`AUDIO_SCENARIO_TYPE`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a7630f2ee913986430344d4aad26098a3) enum
- `AUDIO_ROUTE_USB`, `AUDIO_ROUTE_HDMI`, `AUDIO_ROUTE_DISPLAYPORT` and `AUDIO_ROUTE_AIRPLAY` in [`AUDIO_ROUTE`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#aca310af5a1412fa7a7475b245994b3ae) enum
...
On iOS, to prevent the prompt to find local network devices from popping up when an end user launches the app on an iOS 14.0 device, the `gatewayRtt` parameter is disabled by default. See the [FAQ](https://docs.agora.io/en/help/integration-issues/local_network_privacy) for details. If you do not mind the prompt, and want to enable the `gatewayRtt` parameter, please contact Agora technical support via [support@agora.io](mailto:support@agora.io).
...
- [`GetEngine2`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#ac1a02000088c915aa36065325f42d166)
...
- [`AgoraChannel`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_agora_channel.html) class
- [`SetMultiChannelWant`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a50ddfe8050fd11f1537bd0dddc2eb8a3)
- [`SetForMultiChannelUser`](https://api-ref.agora.io/en/video-sdk/unity/3.x/class_video_surface.html#a2c751c8013e9a20c9f7929ca427b04b9)
- [`SetAudioMixingPitch`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#ac1f7b492430f2c3f38826804a418c2a7)
- [`AdjustUserPlaybackSignalVolume`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a6ae88c74d0dc4e80837cd0a351f81c00)
- Nine enumerations in [`VOICE_CHANGER_PRESET`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a710b9754965ccb92ed968a562968df2c), such as `VOICE_BEAUTY_VIGOROUS`
- Twelve enumerations in [`AUDIO_REVERB_PRESET`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a1e681589411dd2f5df62dab5c1fca7b9), such as `AUDIO_REVERB_FX_KTV`
- [`EnableFaceDetection`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a45f7776f4fd3a6d73186c83e4e15e917)
- [`OnFacePositionChangedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a2425866f7157395b0f6cc04e7854d0f5)
- The [`gatewayRtt`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_rtc_stats.html#aef762b5910ca3a7a06a4e37869c34fed), [`memoryAppUsageRatio`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_rtc_stats.html#a5b7d328a6f8e6aca9e1b8b6c8ce16e02), [`memoryTotalUsageRatio`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_rtc_stats.html#a232d695be9b723df8dae4ca219c6745f) and [`memoryAppUsageInKbytes`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_rtc_stats.html#aeb37b39c64362e3954b279c6dfc5e774) members in the `RtcStats` class
- The [`totalActiveTime`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_remote_audio_stats.html#a7453a27b08439186f35b3b7bb9eafd3b) member in the `RemoteAudioStats` struct
- The [`totalActiveTime`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_remote_audio_stats.html#a7453a27b08439186f35b3b7bb9eafd3b) member in the `RemoteVideoStats` struct
- The [`channelId`](https://api-ref.agora.io/en/video-sdk/unity/3.x/structagora__gaming__rtc_1_1_audio_volume_info.html#a0b95567512ed7c6642671e805207a8e1) member in the `AudioVolumeInfo` struct

**`Renamed`**

Enum type `CLIENT_ROLE` changed to [`CLIENT_ROLE_TYPE`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a901253f94f78da34371bf7eb656a19ff). Enum name `BROADCASTER` and `AUDIENCE` changed to `CLIENT_ROLE_BROADCASTER` and `CLIENT_ROLE_AUDIENCE`.

**Deprecated**

- `EnableWebSdkInteroperability`
- `OnFirstRemoteVideoFrameHandler`, replaced by [`OnRemoteVideoStateChangedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a53d577f5c1c2d863f7946d86d76adb13)
- `OnUserMutedAudioHandler`, `OnFirstRemoteAudioDecodedHandler`, and `OnFirstRemoteAudioFrameHandler`, replaced by [`OnRemoteAudioStateChangedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a92f016ea980eba06cf38192191d17e01)
- `OnStreamPublishedHandler` and `OnStreamUnpublishedHandler`, replaced by [`OnRtmpStreamingStateChangedHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a589c11ed19b0638824aa1b2e23971271)

## v2.9.2

<div class="alert note">
  As of December 8, 2021, Agora begins implementing the retirement process for
  the Voice SDK and Video SDK for native platforms and third-party frameworks
  earlier than v3.0.0. See{' '}
  <a href="../introduction/service-sunset-plans">Service Sunset Plans</a>.
</div>
