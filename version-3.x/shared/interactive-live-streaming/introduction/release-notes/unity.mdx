...
- This release enables interoperability between the <Vg k="VSDK" /> Unity SDK and the <Vg k="VSDK" /> Web SDK by default, and deprecates the `EnableWebSdkInteroperability` method.
