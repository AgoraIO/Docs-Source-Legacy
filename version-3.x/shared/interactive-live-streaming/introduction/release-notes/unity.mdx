...
<div class="alert info">
  ...
  update your code logic by referring to <a href="/en/3.x/interactive-live-streaming/advanced-features/media-push">
    Media Push
  </a>.{' '}
</div>
...
- Reporting streaming states, errors, and events:
  ...
  - Renaming `RTMP_STREAM_PUBLISH_ERROR` to `RTMP_STREAM_PUBLISH_ERROR_TYPE` and adding the following to the `RTMP_STREAM_PUBLISH_ERROR_TYPE` error code:
    ...
    - `RTMP_STREAM_PUBLISH_ERROR_INVALID_APPID(15)`: Your App ID does not have permission to use the CDN live streaming function. Refer to [Prerequisites](/en/3.x/interactive-live-streaming/advanced-features/media-push#prerequisites) to enable the CDN live streaming permission.
...
If you upgrade the SDK to v3.2.1, ensure that you have added the above files in your project according to [Quickstart Guide](/en/3.x/interactive-live-streaming/quickstart-guide/start-video-streaming#integrate-the-sdk).
