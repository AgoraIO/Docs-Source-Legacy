...
-   Web: Adds and updates a series of APIs to enable interoperability between the web browsers and native clients for the `COMMUNICATION` and `LIVE_BROADCASTING` profiles. See <Link to="../introduction/release-notes">Release Notes</Link>.
