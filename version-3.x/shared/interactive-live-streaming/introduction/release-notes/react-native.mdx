...
- [`startScreenCapture` ](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/v3.7.0/classes/rtcengine.html#startscreencapture)
- [`stopScreenCapture`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/v3.7.0/classes/rtcengine.html#stopscreencapture)
- [`updateScreenCaptureParameters`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/v3.7.0/classes/rtcengine.html#updatescreencaptureparameters)
- [`enableLocalVoicePitchCallback`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/v3.7.0/classes/rtcengine.html#enablelocalvoicepitchcallback)
- [`LocalVoicePitchInHz`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/v3.7.0/interfaces/rtcengineevents.html#localvoicepitchinhz)
- [`FirstRemoteVideoFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/v3.7.0/interfaces/rtcchannelevents.html#firstremotevideoframe) in `RtcChannelEvents` 
- [`ClientRoleChangeFailed`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/v3.7.0/interfaces/rtcengineevents.html#clientrolechangefailed)
- `SameUidLogin(19)` and `TooManyBroadcasters(20)` in [`ConnectionChangedReason`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/v3.7.0/enums/connectionchangedreason.html)
- The following constants in [`LocalVideoStreamError`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/v3.7.0/enums/localvideostreamerror.html):
...
- Reporting streaming states, errors, and events:
  ...
  - Adding the following to the `RtmpStreamingErrorCode` error code:
    ...
    - `InvalidAppid(15)`: Your App ID does not have permission to use the Media Push function. Refer to [Prerequisites](../advanced-features/media-push#prerequisites) to enable the Media Push permission.
...
- Android: Modify `dependencies` in the `/android/app/build.gradle` file. For details about the sample code and the `implementation` field in `dependencies`, see [Remove extension libraries when using Maven Central](https://docs.agora.io/en/Video/reduce_rtc_app_size#remove-extension-libraries-when-using-maven-central) in Reduce App Size.
- iOS: Use the `subspecs` field in the `/ios/Podfile` file. For details about the sample code and the `subspecs` fields, see [Remove extension libraries when using CocoaPods](https://docs.agora.io/en/Video/reduce_rtc_app_size#remove-extension-libraries-when-using-cocoapods) in Reduce App Size.
...
- Changes the meaning of `None(0)` from "Do not use the cloud proxy" to "Automatic mode". In this mode, the SDK attempts a direct connection to SD-RTN™ and automatically switches to TLS 443 if the attempt fails. As of v3.6.2, the SDK has this mode enabled by default.
...
- Supports more audio file formats. See [Which audio file formats does the Agora RTC SDK support](https://docs.agora.io/en/Video/faq/audio_format).

If you want to experience these improvements, ensure that you have integrated the following dynamic library:

- Android：`libagora-full-audio-format-extension.so`
- iOS：`AgoraFullAudioFormatExtension.xcframework`

Given the large size of this library, if you have limitations on app size and do not need these improvements, you can remove this dynamic library when integrating the SDK. For more instructions, see [Reduce App Size](https://docs.agora.io/en/Video/reduce_rtc_app_size#extension-libraries).
...
- [`takeSnapshot`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#takesnapshot)
- [`SnapshotTaken`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/interfaces/rtcchannelevents.html#snapshottaken)
- [`enableRemoteSuperResolution`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#enableremotesuperresolution)
- [`UserSuperResolutionEnabled`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/interfaces/rtcchannelevents.html##a4437c6d4d04135837ddf79ce050132a0)
- `blur_degree` and `VirtualBackgroundBlurDegree` in [`VirtualBackgroundSource`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/virtualbackgroundsource.html)
- `Blur` in [`backgroundSourceType`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/virtualbackgroundsource.html#backgroundsourcetype)
- [`setAudioMixingPlaybackSpeed`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#setaudiomixingplaybackspeed)
- [`getAudioTrackCount`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#getaudiotrackcount)
- [`selectAudioTrack`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#selectaudiotrack)
- [`setAudioMixingDualMonoMode`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#a81b6a0f46612a6c4337d078b3af1681a)
- [`pauseAllChannelMediaRelay`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#pauseallchannelmediarelay)
- [`resumeAllChannelMediaRelay`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#resumeallchannelmediarelay)
- [`getAudioFileInfo`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#getaudiofileinfo)
- [`RequestAudioFileInfo`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/interfaces/rtcchannelevents.html#requestaudiofileinfo)
- `Mobile5G(6)`in [`NetworkType`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/enums/networktype.html)

**Modified**

- [`startEchoTest`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#startechotest)
...
See <Link to="../advanced-features/set-audio-route?platform=android">Set the Audio Route</Link> for Android platform.
...
<div class="alert note">Before you use virtual backgrounds, ensure that the device performance and user scenarios meet the requirements. See <a href="https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#enablevirtualbackground">enableVirtualBackground</a > documentation.</div>
...
- [`enableVirtualBackground`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#enablevirtualbackground)
- [`VirtualBackgroundSourceEnabled`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/interfaces/rtcchannelevents.html#virtualbackgroundsourceenabled)

**Modified**

- [`setEnableSpeakerphone`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#setenablespeakerphone)
- [`setDefaultAudioRouteToSpeakerphone`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#setdefaultaudioroutetospeakerphone)
...
- [`RtcEngineContext`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcenginecontext.html) class
- [`createWithContext`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#createwithcontext)
- [`UnPublishOK (100)`](/API%20Reference/react_native/enums/rtmpstreamingerrorcode.html#unuublishok) in `RtmpStreamingErrorCode` 
- [`UrlAlreadyInUse (2)`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/enums/rtmpstreamingevent.html#urlalreadyinuse) in `RtmpStreamingEvent`
- `AES128GCM2 (7)` and `AES256GCM2 (8)`in [`EncryptionMode`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/enums/encryptionmode.html) 
- `encryptionKdfSalt` in [`EncryptionConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/enums/encryptionmode.html)
- [`muteLocalAudioStream`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcchannel.html#mutelocalaudiostream) and [`muteLocalVideoStream`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcchannel.html#mutelocalvideostream) in `RtcChannel`
- [`publishLocalAudio`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/channelmediaoptions.html#publishlocalaudio) and [`publishLocalVideo`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/channelmediaoptions.html#publishlocalvideo) in `ChannelMediaOptions`
- [`Interrupted (8)`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/enums/audiolocalerror.html#interrupted) in `AudioLocalError`
...
- [`startRhythmPlayer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#startrhythmplayer)
- [`stopRhythmPlayer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#stoprhythmplayer)
- [`configRhythmPlayer`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#configrhythmplayer)
- [`startAudioRecordingWithConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#startaudiorecordingwithconfig)
- [`getEffectDuration`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#geteffectduration)
- [`setEffectPosition`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#seteffectposition)
- [`getEffectCurrentPosition`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#geteffectcurrentposition)
- `filePath` in [`getAudioMixingDuration`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#getaudiomixingduration)
- `startPos` in [`playEffect`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#playeffect)
- `startPos` in [`startAudioMixing`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#startaudiomixing)
- `DeviceNotFound(8)` in [`LocalVideoStreamError`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/enums/localvideostreamerror.html)
- [`Error code`](../reference/error-codes): `AlreadyInRecording(160)`

**Modified**

- [`AudioMixingStateChanged`]((https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/interfaces/rtcengineevents.html#audiomixingstatechanged))
...
- [`createWithConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#createwithconfig)
- [`setVoiceConversionPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#setvoiceconversionpreset)
- `AES128GCM` and `AES256GCM` in [`EncryptionMode`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/enums/encryptionmode.html)
- `mosValue` in [`RemoteAudioStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/interfaces/rtcengineevents.html#remoteaudiostats)
- [`setVoiceBeautifierParameters`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#setvoicebeautifierparameters)
- `SingingBeautifier` in [`VoiceBeautifierPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/enums/voicebeautifierpreset.html)
- [`enableDeepLearningDenoise`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#enabledeeplearningdenoise)
- `options` in [`joinChannel`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#joinchannel)
- `options` in [`switchChannel`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#switchchannel)
- [`createDataStreamWithConfig`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#createdatastreamwithconfig)
- `qoeQuality` and `qualityChangedReason` in [`RemoteAudioStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/interfaces/rtcengineevents.html#remoteaudiostats)
- [`setCloudProxy`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#setcloudproxy)
- The `captureBrightnessLevel` property in the [`LocalVideoStats`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/interfaces/localvideostats.html)
- The `captureWidth` and `captureHeight` properties in the [`CameraCapturerConfiguration`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/cameracapturerconfiguration.html) class
- `Manual(3)` in  [`CameraCaptureOutputPreference`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/enums/cameracaptureoutputpreference.html)
- `CaptureInBackGround(6)` and `CaptureMultipleForegroundApps(7)` in [`LocalVideoStreamError`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/enums/localvideostreamerror.html)
- Error code: [`ModuleNotFound(157)`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/enums/errorcode.html)
...
- `options`in [`setClientRole`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#setclientrole)
- [`setAudioEffectPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#setaudioeffectpreset)
- [`setVoiceBeautifierPreset`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#setvoicebeautifierpreset)
- [`setAudioEffectParameters`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/classes/rtcengine.html#setaudioeffectparameters)
- `MEETING(8)` in [`AudioScenario`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/react_native/enums/audioscenario.html)
