...
This release changes the name of the **Agora Voice** service to **Agora <Vg k="VIDEO" />**. After enabling the Agora <Vg k="VIDEO" /> service, you can choose the Agora Voice SDK (**Audio**) or the Agora Video SDK (**Video**) as needed.
...
- [API Reference](https://api-ref.agora.io/en/video-sdk/cocos-creator/1.x/index.html)
