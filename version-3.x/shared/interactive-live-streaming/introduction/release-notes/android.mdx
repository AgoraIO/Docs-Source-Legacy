...
- Reporting streaming states, errors, and events:
    ...
    - Adding the following to the `RTMP_STREAM_PUBLISH_ERROR` error code:
        ...
        - `RTMP_STREAM_PUBLISH_ERROR_INVALID_APPID(15)`: Your App ID does not have permission to use the Media Push function. Refer to [Prerequisites](../../../interactive-live-streaming/advanced-features/media-push#prerequisites) to enable the Media Push permission.
...
In scenarios such as the video chat, interactive streaming, and online education, basic beautification is a popular feature. v2.4.0 adds the [`setBeautyEffectOptions`](https://api-ref.agora.io/en/video-sdk/android/3.x/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#aa9327de4fb0c29f840b1e68ca2e83fc6) method, allowing you to adjust the contrast, brightness, smoothness and red saturation of an image.
