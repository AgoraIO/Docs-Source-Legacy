...
If you use Agora RTC SDK for Media Push, read [Media Push](../advanced-features/media-push) before upgrading; if you use the server-side service for Media Push, read [Push Stream RESTful API](https://docs-preprod.agora.io/en/Interactive%20Broadcast/streaming_restful?platform=All%20Platforms) before upgrading. Perform relevant tests to verify after upgrading.
