...
If you use Agora RTC SDK for Media Push, read [Media Push](../advanced-features/media-push) before upgrading; if you use the server-side service for Media Push, read [Push Stream RESTful API](/media-push/reference/restful-api) before upgrading. Perform relevant tests to verify after upgrading.
