...
- [Migrate from the Web SDK 3.x to 4.x](./migration_guide_web_ng)
- [SDK download links](https://docs.agora.io/en/sdks)
...
<div class="alert info">The service for Media Push (2.0) refers to the streaming service enabled by any of the following methods:<li>Using the Agora <Vg k="VSDK" /> (Native, third-party framework) v2.4.0 or earlier and calling the <code>addPublishStreamUrl</code> or other related methods.</li><li>Using the Agora <Vg k="VSDK" /> (Web) v2.8.0 or earlier and calling the <code>startLiveStreaming</code> or other related methods.</li></div>
...
<div class="alert info">The service for Media Push (3.0) refers to the streaming service enabled by any of the following methods:
    <li>Using the Agora <Vg k="VSDK" /> (Native, third-party framework) v2.4.1 or later and calling the <code>addPublishStreamUrl</code> or other related methods.</li>
