...
This page explains how Agora calculates your monthly bill for using [Voice Call](/en/Voice/product_voice), [Video Call](/en/Video/product_video), and [Interactive Live Streaming Premium](/en/Interactive%20Broadcast/product_live).
...
If your scenario involves video calling or interactive live streaming alongside other Agora products or services, such as [Real-time Messaging](https://docs.agora.io/en/Real-time-Messaging/billing_rtm?platform=Android), [Cloud Recording](https://docs.agora.io/en/cloud-recording/billing_cloud_recording?platform=RESTful), or [Interactive Whiteboard](https://docs.agora.io/en/whiteboard/billing_whiteboard?platform=Web), expect additional charges. For details, see the pricing documents for each Agora product or service.
