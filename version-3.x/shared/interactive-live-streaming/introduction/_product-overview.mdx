...
|All 3.x versions            | 14th March 2023 - 14th September 2024 | We will support existing implementations of 3.x with bug fixes and critical security updates.                                      |
|Versions earlier than 3.2.0 | 14th June 2024                   | Service shutdown. Customers won't be able to use these versions and will need to migrate to later versions to continue using Agora.|                                                             |
