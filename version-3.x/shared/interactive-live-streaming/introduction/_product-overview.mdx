...
| Date                              | Milestone                                                  |
| ----------------------------------| -----------------------------------------------------------| 
| 13th March 2023                   | We will no longer offer version 3.x of our Video, Voice and Interactive Live Streaming SDKs to new customers. |
| 13th March - 13th September 2023  | We will support existing implementations of 3.x with bug fixes and critical security updates. |
| 13th September 2023               | Only critical security patches will be supported. |
| 13th March 2024                   | We will stop supporting version 3.x|
...
<div class="alert info">Temporarily, the Agora <Vg k="VSDK" /> Web SDK does not support modifying the raw data. </div>
