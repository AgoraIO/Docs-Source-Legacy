...
We provide an open-source [JoinChannelAudio.swift](https://github.com/AgoraIO/API-Examples/tree/main/macOS/APIExample/Examples/Basic/JoinChannelAudio/JoinChannelAudio.swift) sample project that implements adjusting the capturing and playback on GitHub. You can download the sample project and view the source code.
