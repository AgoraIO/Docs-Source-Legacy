...
![1586770252932](https://web-cdn.agora.io/docs-files/1586770252932)

## Implementation
Before adjusting the audio volume, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Voice Call](/3.x/voice-calling/quickstart-guide/get-started-sdk) or [Start Live Interactive Streaming](../quickstart-guide/start-audio-streaming).
...
![1586770294896](https://web-cdn.agora.io/docs-files/1586770294896)
...
#### API reference
- [`SetAudioRecordingDeviceVolume`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_audio_recording_device_manager.html#ac278e396de3080f50ba59dc71e256a78)
- [`AdjustRecordingSignalVolume`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a367f7bc63304e1b4c215780af1df005b)
...
![1586770338360](https://web-cdn.agora.io/docs-files/1586770338360)
...
- [`SetAudioPlaybackDeviceVolume`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_audio_playback_device_manager.html#aca6f0daed9ea0fd012b17a213fe83d24)
- [`AdjustPlaybackSignalVolume`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a25c394db63570a6f45f9b40e8d7eb8e1)
...
**Audio mixing** is the process of combining local or online music files with the local stream so that all the remote users in the channel can hear the host and the music at the same time. See [Audio Effects/Mixing](../advanced-features/audio-effect-mixing) for more information about enabling this function.
![1586770368334](https://web-cdn.agora.io/docs-files/1586770368334)
...
- [`AdjustAudioMixingPlayoutVolume`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#ac7d6df07616489729d521ce47934bb29)
- [`AdjustAudioMixingVolume`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#ae6a3b1041004fdd5a031975a2f9cdb7e)

### Adjust the audio effects volume

 An **audio effects** here refers to a sound clip which plays a brief sound effect such as clapping or gunshots. See [Audio Effects/Mixing](../advanced-features/audio-effect-mixing) for more information on how to enable this function.

![1586770384829](https://web-cdn.agora.io/docs-files/1586770384829)
...
- [`SetEffectsVolume`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_audio_effect_manager_impl.html#a94b890267c9ce921fd07153515ce510b)
- [`SetVolumeOfEffect`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a8238ea891e6c030263179735c647b1f1)
...
![1586770402384](https://web-cdn.agora.io/docs-files/1586770402384)
...
- [`EnableInEarMonitoring`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#ab5e3a1ccf03508f96af241cc25aefecd)
- [`SetInEarMonitoringVolume`](https://api-ref.agora.io/en/video-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a0236c42fc3b664eb9e66f99e6209afc8)
...
- [`OnActiveSpeakerHandler`](https://api-ref.agora.io/en/video-sdk/unity/3.x/namespaceagora__gaming__rtc.html#ade84b7a1e925d77c049bbf955fb6104c)
