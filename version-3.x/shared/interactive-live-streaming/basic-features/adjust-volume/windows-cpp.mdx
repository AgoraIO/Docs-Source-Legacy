...
We provide an open-source [AudioVolume](https://github.com/AgoraIO/API-Examples/tree/legacy/windows/APIExample/APIExample/Advanced/AudioVolume) sample project that implements adjusting the capturing and playback on GitHub. You can download the sample project and view the source code.
