...
Before proceeding, ensure that you have implemented basic real-time functions in your project. See [Start a Call](/3.x/video-calling/quickstart-guide/get-started-sdk) or [Start Interactive Live Streaming](../quickstart-guide/start-video-streaming).
