...
Agora provides an open-source sample project that implements [pre-call tests](https://github.com/AgoraIO/API-Examples/tree/legacy/windows/APIExample/APIExample/Advanced/PreCallTest) on GitHub. You can download the sample project to try it out or refer to the source code.
