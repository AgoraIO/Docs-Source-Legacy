...
Before conducting the last-mile test, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Call](/3.x/video-calling/quickstart-guide/get-started-sdk) or [Start Live Interactive Streaming](../quickstart-guide/start-video-streaming).
...
![1569477125325](https://web-cdn.agora.io/docs-files/1569477125325)
...
- [`getStats`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.stream.html#getstats)
- [`LocalStreamStats`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.localstreamstats.html)
- [`RemoteStreamStats`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.remotestreamstats.html)
