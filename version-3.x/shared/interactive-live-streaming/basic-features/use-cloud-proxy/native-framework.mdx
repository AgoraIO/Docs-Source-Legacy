...
3. You have integrated the SDK and prepared the development environment. For details, see [QuickStart Guide](/3.7.1/video-calling/quickstart-guide/get-started-sdk).
