...
Force UDP and Force TCP cloud proxy minutes count toward the [10,000 free-of-charge minutes](https://docs.agora.io/en/Video/faq/billing_free) that Agora provides to every account. In addition, Agora automatically applies the following tiered discounts when your Force UDP and Force TCP cloud proxy usage exceeds 100,000 minutes:
...
1. Before joining a channel, call [`SetCloudProxy`](./API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#ad354f9ec01a0985f76f82cae1fafee5e), and set `proxyType` as `UDP_PROXY(1)` or `TCP_PROXY(2)`.
</PlatformWrapper>
...
- Android: [`setCloudProxy`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a191c08aa5bffe7083fa182729104244c)
- iOS: [`setCloudProxy`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#/api/name/setCloudProxy)
- macOS: [`setCloudProxy`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#/api/name/setCloudProxy)
- Windows: [`setCloudProxy`](./API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#aff1329c23bbcaff769101ae08f91b869)
