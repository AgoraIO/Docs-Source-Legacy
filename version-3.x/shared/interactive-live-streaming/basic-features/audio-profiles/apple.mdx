...
Agora provides an open-source demo project <Link to="{{GLOBAL.AGORA_API_EXAMPLES_ANDROID_BLOB}}/advanced/SetAudioProfile.java">SetAudioProfile</Link> that implements setting the audio profile and scenario on GitHub. You can download the sample project and view the source code.
