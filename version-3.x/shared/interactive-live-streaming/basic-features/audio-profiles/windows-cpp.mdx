...
The audio scenario affects the volume type. See [What is the difference between the in-call volume and the media volume](https://docs.agora.io/en/faq/system_volume).
