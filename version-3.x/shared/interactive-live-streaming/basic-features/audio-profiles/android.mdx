...
Agora provides an open-source demo project [PlayAudioFiles](https://github.com/AgoraIO/API-Examples/blob/main/Android/APIExample/app/src/main/java/io/agora/api/example/examples/advanced/PlayAudioFiles.java) that implements setting the audio profile and scenario on GitHub. You can download the sample project and view the source code.
