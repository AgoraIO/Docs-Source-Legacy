...
Refer to the [sample project](https://github.com/AgoraIO/API-Examples/tree/main/windows/APIExample/APIExample/Advanced/ScreenShare) on GitHub to learn how to share a screen or window with the Agora SDK.
