...
Agora provides an open-source macOS sample project on GitHub that implements screen sharing and window sharing in the [ScreenShare.swift](https://github.com/AgoraIO/API-Examples/tree/main/macOS/APIExample/Examples/Advanced/ScreenShare) file. You can download the sample project to try it out or refer to the source code.
