...
<div class="alert note">The Agora <Vg k="VSDK" /> Web SDK supports screen sharing in the following <b>desktop</b> browsers:<li>Chrome 58 or later</li><li>Firefox 56 or later</li><li>Edge 80 or later on Windows 10+</li></div>
