...
Before you begin, ensure that you understand how to [start a video call](/3.x/video-calling/quickstart-guide/get-started-sdk) or [start interactive video streaming](../quickstart-guide/start-video-streaming).
