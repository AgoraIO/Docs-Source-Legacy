...
Before you begin, ensure that you understand how to start a video call or start interactive video streaming. For details, see [Start a Video Call](/3.7.1/video-calling/quickstart-guide/get-started-sdk) or [Get Started with Interactive Live Streaming Premium](./start_live_flutter?platform=Flutter).
