...
Agora provides an open-source sample project on GitHub that implements <Link to="{{GLOBAL.AGORA_API_EXAMPLES_ANDROID_BLOB}}/advanced/SetVideoProfile.java">setting the video profile</Link>. You can download the sample project to try it out or view the source code.
