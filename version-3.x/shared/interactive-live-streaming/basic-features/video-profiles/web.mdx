...
Before setting the video profile, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Video Call](/3.x/video-calling/quickstart-guide/get-started-sdk) or [Start a Live Interactive Video Streaming](../quickstart-guide/start-video-streaming).
...
![1568878370519](https://web-cdn.agora.io/docs-files/1568878370519)
...
- [`setVideoEncoderConfiguration`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.stream.html#setvideoencoderconfiguration)
- [`setVideoProfile`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.stream.html#setvideoprofile)

## Considerations
- Supported resolutions vary from browser to browser. See [video profile and supported Browsers](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.stream.html#setvideoprofile) for details.
