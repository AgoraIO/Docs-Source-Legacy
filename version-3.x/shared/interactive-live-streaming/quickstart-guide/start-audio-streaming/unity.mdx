...
1. Go to [SDK Downloads](https://docs.agora.io/en/sdks?platform=unity), download the Agora SDK for Unity under **Voice SDK**, and extract the files from the downloaded SDK package.
