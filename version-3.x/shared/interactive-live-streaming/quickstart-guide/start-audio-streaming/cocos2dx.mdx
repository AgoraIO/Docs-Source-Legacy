...
1. Go to [SDK Downloads](https://docs.agora.io/en/sdks?platform=cocos-2d-x), download the latest version of the Agora Voice SDK, and extract the files from the downloaded SDK package.
