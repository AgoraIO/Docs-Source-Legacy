...
Agora provides an open-source sample project [JoinChannelVideo](https://github.com/AgoraIO/API-Examples/blob/main/Android/APIExample/app/src/main/java/io/agora/api/example/examples/basic/JoinChannelVideo.java) on GitHub that implements interactive live video streaming for your reference.
