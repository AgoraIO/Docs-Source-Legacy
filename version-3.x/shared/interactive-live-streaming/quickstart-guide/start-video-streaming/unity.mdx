...
1. Go to [SDK Downloads](https://docs.agora.io/en/sdks), download the Agora SDK for Unity under **Video SDK**, and extract the files from the downloaded SDK package.
