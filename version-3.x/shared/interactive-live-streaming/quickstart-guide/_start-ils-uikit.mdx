...
5. Ask a friend to join the live streaming with you using the [Agora Web demo app](https://webdemo.agora.io/basicVoiceCall/index.html). Ensure that your friend enters the same App ID, channel name, and temporary token. You can then hear or see each other.
