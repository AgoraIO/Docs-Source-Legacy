...
Agora provides an open-source [API-Examples](https://github.com/AgoraIO/API-Examples/tree/main/Android) sample project on GitHub. This page describes how to run this project and experience interactive live audio or video streaming.
