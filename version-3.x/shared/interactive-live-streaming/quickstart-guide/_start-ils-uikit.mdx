...
Agora provides an open-source <Link to="{{GLOBAL.ANDROID_API_EXAMPLES_ROOT">API-Examples</Link> sample project on GitHub. This page describes how to run this project and experience interactive live audio or video streaming.
