...
This plug-in helps developers enable the function of playing media resources in real-time interactive live streaming through the use of streamlined and flexible APIs, and synchronously sharing local or online media resources played by the host to all users in the channel. See [function description](../../../interactive-live-streaming/advanced-features/mediaplayer-kit#function-description) for details.
...
As of this release, Agora publishes the SDK package to mavenCentral. To integrate the SDK with mavenCentral, see [Integrate the MediaPlayer Kit](../../../interactive-live-streaming/advanced-features/mediaplayer-kit#integrate-the-mediaplayer-kit).
...
** Integration changes**
Because JCenter is about to retire, as of this release, Agora publishes the SDK package to JitPack instead of JCenter. To integrate the SDK with JitPack, see [Integrate the MediaPlayer Kit](../../../interactive-live-streaming/advanced-features/mediaplayer-kit#integrate-the-mediaplayer-kit).
