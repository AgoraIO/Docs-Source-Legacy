...
As of this release, Agora publishes the SDK package to mavenCentral. To integrate the SDK with mavenCentral, see [Integrate the MediaPlayer Kit](../advanced-features/mediaplayer-kit#integrate-the-mediaplayer-kit).
...
** Integration changes**
Because JCenter is about to retire, as of this release, Agora publishes the SDK package to JitPack instead of JCenter. To integrate the SDK with JitPack, see [Integrate the MediaPlayer Kit](../advanced-features/mediaplayer-kit#integrate-the-mediaplayer-kit).
