...
When initializing the SDK by calling [`initialize`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#ac71db65e66942e4e0a0550e95c16890f), set the `areaCode` parameter in `RtcEngineContext` to specify the region for connection.
