...
When initializing the SDK by calling [`GetEngine`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#ac1a02000088c915aa36065325f42d166) , set the `areaCode` parameter in `RtcEngineConfig` to specify the region for connection.
