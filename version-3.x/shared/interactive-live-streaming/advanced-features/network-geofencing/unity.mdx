...
As of v3.0.1, the Agora <Vg k="VSDK" /> Unity SDK supports network geofencing.
...
<div class="alert note"><ul><li>The area codes listed above apply to the <Vg k="VSDK" /> Unity SDK v3.2.1 and later. For area codes earlier than v3.2.1, you can refer to the API reference of a specified version.</li><li>The area codes support bitwise operation.</li></ul></div>
