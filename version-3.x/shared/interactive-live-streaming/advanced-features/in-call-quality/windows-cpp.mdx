...
Agora provides an open-source sample project on GitHub that implements the [in-call statistics monitoring](https://github.com/AgoraIO/API-Examples/tree/legacy/windows/APIExample/APIExample/Advanced/ReportInCall) function. You can download the sample project to try it out or view the source code.
...
- [`onNetworkQuality`](https://api-ref.agora.io/en/video-sdk/cpp/3.x//classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a80003ae8cce02039f3aa0e8ffad7deed)
- [`onRtcStats`](https://api-ref.agora.io/en/video-sdk/cpp/3.x//classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#ada38743982296a75879018c5773f08a1)
...
- [`onLocalVideoStats`](https://api-ref.agora.io/en/video-sdk/cpp/3.x//classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#ab611030063161c594cd7c4cc0dfe0681)
...
- [`onRemoteVideoStateChanged`](https://api-ref.agora.io/en/video-sdk/cpp/3.x//classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#aac7b62b1307be124423008e45eb02f80)
