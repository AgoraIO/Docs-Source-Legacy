...
Agora provides an open-source sample project on GitHub that implements the [in-call statistics monitoring](https://github.com/AgoraIO/API-Examples/tree/main/windows/APIExample/APIExample/Advanced/ReportInCall) function. You can download the sample project to try it out or view the source code.
