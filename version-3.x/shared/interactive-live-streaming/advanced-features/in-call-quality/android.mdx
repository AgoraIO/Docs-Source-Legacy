...
Agora provides an open-source sample project that implements the [in-call statistics monitoring](https://github.com/AgoraIO/API-Examples/blob/main/Android/APIExample/app/src/main/java/io/agora/api/example/examples/advanced/InCallReport.java) function on GitHub. You can download the sample project to try it out or refer to the source code.
