...
<div class="alert note">Ensure that you implement a video call or interactive video streaming in your project. For details, see <a href="/3.x/video-calling/quickstart-guide/get-started-sdk">Start a Call</a> or <a href="../quickstart-guide/start-video-streaming">Start Interactive Live Streaming</a>.</div>
