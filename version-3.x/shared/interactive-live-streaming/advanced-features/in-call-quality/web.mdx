...
Ensure that you implement a video call or interactive video streaming in your project. For details, see [Start a Call](/3.x/video-calling/quickstart-guide/get-started-sdk) or [Start Interactive Live Streaming](/3.x/interactive-live-streaming/quickstart-guide/start-video-streaming).

<a name ="system_statistics"></a>

### Get the statistics of the system

Call the [`Client.getSystemStats`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.client.html#getsystemstats) method to get the statistics of the system for optimizing your app. Currently, only the battery level information is provided.
...
Call the  [`Client.getTransportStats`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.client.html#gettransportstats)[<sup>[1]</sup>](#reference) method to get the network type and the statistics of the network connection[<sup>[2]</sup>](#reference), including:
...
Call the [`Client.getSessionStats`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.client.html#getsessionstats) method to get the statistics of the session, including:
...
- Call the [`Client.getLocalAudioStats`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.client.html#getlocalaudiostats) method to get the **audio** statistics of the local stream, including:
...
- Call the [`Client.getLocalVideoStats`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.client.html#getlocalvideostats) method to get the **video** statistics of the local stream, including:
...
- Call the [`Client.getRemoteAudioStats`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.client.html#getremoteaudiostats) method to get the **audio** statistics of the remote stream.
...
- Call the [`Client.getRemoteVideoStats`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.client.html#getremotevideostats) method to get the **video** statistics of the remote stream.
...
The [`network-quality`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.client.html#on) callback in  `Client.on` reports on the uplink and downlink network conditions of the local user once every two seconds.
...
The [`exception`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.client.html#on)  callback in  `Client.on` reports on exception events in the channel. Exceptions are not errors, but usually mean quality issues. This callback also reports recovery from an exception.
...
![1550136373895](https://web-cdn.agora.io/docs-files/1550136373895)
