...
<div class="alert note">Ensure that you implement a video call or interactive video streaming in your project. For details, see the following documents:
  <li>iOS: <a href="start_call_ios">Start a Call</a> or <a href="start_live_ios">Start Live Interactive Streaming</a></li>
  <li>macOS: <a href="start_call_mac">Start a Call</a> or <a href="start_live_mac">Start Live Interactive Streaming</a></li></div>
