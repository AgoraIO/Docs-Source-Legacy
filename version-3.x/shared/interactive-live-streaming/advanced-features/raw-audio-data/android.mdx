...
Agora provides an open-source sample project that implements [processing raw audio data using Java APIs](https://github.com/AgoraIO/API-Examples/blob/legacy/Android/APIExample/app/src/main/java/io/agora/api/example/examples/advanced/ProcessRawData.java) on GitHub. You can try the demo and view the source code.
