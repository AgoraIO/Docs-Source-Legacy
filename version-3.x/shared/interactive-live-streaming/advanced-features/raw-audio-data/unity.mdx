...
Before using the raw audio data function, ensure that you have implemented the basic real-time communication functions in your project. See [Start a Call](start_call_audio_unity) and [Start Live Interactive Streaming](start_live_audio_unity) for details.
