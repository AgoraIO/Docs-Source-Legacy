...
- Process raw audio data using iOS/macOS APIs
  - iOS:  [RawAudioData](https://github.com/AgoraIO/API-Examples/tree/legacy/iOS/APIExample/Examples/Advanced/RawAudioData/RawAudioData.swift)
  - macOS:  [RawAudioData](https://github.com/AgoraIO/API-Examples/tree/legacy/macOS/APIExample/Examples/Advanced/RawAudioData/RawAudioData.swift)
- Process raw audio data using C++ APIs
  - iOS: [RawMediaData](https://github.com/AgoraIO/API-Examples/blob/legacy/iOS/APIExample/Examples/Advanced/RawMediaData/RawMediaData.swift)
  - macOS: [RawMediaData](https://github.com/AgoraIO/API-Examples/blob/legacy/macOS/APIExample/Examples/Advanced/RawMediaData/RawMediaData.swift)
...
* The raw audio data function is implemented by the C++ APIs of the SDK, and you need to mix the Objective-C and C++ methods in an `.mm` file. See [AgoraMediaDataPlugin.mm](https://github.com/AgoraIO/API-Examples/blob/legacy/iOS/APIExample/Common/RawDataApi/AgoraMediaDataPlugin.mm) for reference.
