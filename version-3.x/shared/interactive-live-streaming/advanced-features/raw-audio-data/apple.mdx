...
- Process raw audio data using iOS/macOS APIs
  - iOS:  [RawAudioData](https://github.com/AgoraIO/API-Examples/tree/master/iOS/APIExample/Examples/Advanced/RawAudioData/RawAudioData.swift)
  - macOS:  [RawAudioData](https://github.com/AgoraIO/API-Examples/tree/master/macOS/APIExample/Examples/Advanced/RawAudioData/RawAudioData.swift)
...
- [`setAudioDataFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioDataFrame:)
- [`onRecordAudioFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/onRecordAudioFrame:)
- [`onPlaybackAudioFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/onPlaybackAudioFrame:)
- [`onMixedAudioFrame`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/onMixedAudioFrame:)
- [`onPlaybackAudioFrameBeforeMixing`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/onPlaybackAudioFrameBeforeMixing:uid:)
...
* The raw audio data function is implemented by the C++ APIs of the SDK, and you need to mix the Objective-C and C++ methods in an `.mm` file. See [AgoraMediaDataPlugin.mm](https://github.com/AgoraIO/API-Examples/blob/master/iOS/APIExample/Common/RawDataApi/AgoraMediaDataPlugin.mm) for reference.
