...
In video scenarios, if the remote user joins the channel using `IChannel`, ensure that you specify the `channelId` of the remote user in  [`VideoCanvas`](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/cpp/v3.0.0/structagora_1_1rtc_1_1_video_canvas.html) when setting the remote video view.
