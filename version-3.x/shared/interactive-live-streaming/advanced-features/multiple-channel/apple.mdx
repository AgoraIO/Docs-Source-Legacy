...
- Publish the local stream in an `AgoraRtcChannel` channel:
  - iOS: [JoinMultiChannel](https://github.com/AgoraIO/API-Examples/blob/legacy/iOS/APIExample/Examples/Advanced/JoinMultiChannel/JoinMultiChannel.swift)
  - macOS: [JoinMultiChannel](https://github.com/AgoraIO/API-Examples/blob/legacy/macOS/APIExample/Examples/Advanced/JoinMultiChannel/JoinMultiChannel.swift)
