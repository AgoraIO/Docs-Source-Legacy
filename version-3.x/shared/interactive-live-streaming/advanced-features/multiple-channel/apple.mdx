...
- Publish the local stream in an `AgoraRtcChannel` channel:
  - iOS: [JoinMultiChannel](https://github.com/AgoraIO/API-Examples/blob/main/iOS/APIExample/APIExample/Examples/Advanced/JoinMultiChannel/JoinMultiChannel.swift)
  - macOS: [JoinMultiChannel](https://github.com/AgoraIO/API-Examples/blob/main/macOS/APIExample/Examples/Advanced/JoinMultiChannel/JoinMultiChannel.swift)
