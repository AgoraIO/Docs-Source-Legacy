...
Agora provides an [open-source project](https://github.com/AgoraIO/API-Examples/tree/main/windows/APIExample/APIExample/Advanced/CustomAudioCapture) on GitHub. You can download it for source code reference.
