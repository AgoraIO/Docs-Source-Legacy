...
Agora provides an open-source [demo project](https://github.com/AgoraIO/API-Examples/tree/legacy/Android/APIExample/app/src/main/java/io/agora/api/example/examples/advanced/customaudio) on GitHub. You can view the source code on Github or download the project to try it out.
Before proceeding, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Voice Call](/3.x/voice-calling/quickstart-guide/get-started-sdk) or [Start Interactive Live Audio Streaming](../quickstart-guide/start-audio-streaming).
098.
### Custom audio source
