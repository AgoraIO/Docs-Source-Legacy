...
Before proceeding, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Voice Call](/3.x/voice-calling/quickstart-guide/get-started-sdk) or [Start Interactive Live Audio Streaming](../../../interactive-live-streaming/quickstart-guide/start-audio-streaming).
