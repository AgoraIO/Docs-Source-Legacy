...
Agora provides an open-source <Link to="{{GLOBAL.AGORA_API_EXAMPLES_ANDROID_BLOB}}/advanced/customaudio">demo project</Link> on GitHub. You can view the source code on Github or download the project to try it out.
