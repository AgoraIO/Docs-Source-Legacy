...
Before customizing the audio source or sink, ensure that you implement the basic real-time communication functions in your project. For details, see [Start a Call](start_call_audio_unity) or [Start Live Interactive Streaming](start_live_audio_unity).
