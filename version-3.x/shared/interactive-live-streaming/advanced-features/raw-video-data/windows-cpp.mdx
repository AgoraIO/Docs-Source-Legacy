...
Refer to the sample project on [GitHub](https://github.com/AgoraIO/API-Examples/tree/main/windows/APIExample/APIExample/Advanced/OriginalVideo) to learn how to use raw video data in your project.
