...
Before proceeding, ensure that you have implemented interactive live video streaming or a video call in your project. See [Start Live Interactive Video Streaming](../quickstart-guide/start-video-streaming) or [Start a Call](/3.x/video-calling/quickstart-guide/get-started-sdk) for details.
