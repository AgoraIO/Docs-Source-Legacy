...
- iOS: [StreamEncryption](https://github.com/AgoraIO/API-Examples/blob/main/iOS/APIExample/APIExample/Examples/Advanced/StreamEncryption/StreamEncryption.swift)
- macOS: [StreamEncryption](https://github.com/AgoraIO/API-Examples/blob/main/macOS/APIExample/Examples/Advanced/StreamEncryption/StreamEncryption.swift)
