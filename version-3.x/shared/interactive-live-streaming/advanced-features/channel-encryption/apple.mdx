...
- iOS: [StreamEncryption](https://github.com/AgoraIO/API-Examples/blob/legacy/iOS/APIExample/Examples/Advanced/StreamEncryption/StreamEncryption.swift)
- macOS: [StreamEncryption](https://github.com/AgoraIO/API-Examples/blob/legacy/macOS/APIExample/Examples/Advanced/StreamEncryption/StreamEncryption.swift)
