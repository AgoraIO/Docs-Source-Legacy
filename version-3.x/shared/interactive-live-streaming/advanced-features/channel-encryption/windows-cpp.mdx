...
Agora provides an open-source sample project that implements [built-in encryption](https://github.com/AgoraIO/API-Examples/tree/legacy/windows/APIExample/APIExample/Advanced/MediaEncrypt) and [customized encryption](https://github.com/AgoraIO/API-Examples/tree/legacy/windows/APIExample/APIExample/Advanced/CustomEncrypt) on GitHub. You can try the demo and view the source code.
