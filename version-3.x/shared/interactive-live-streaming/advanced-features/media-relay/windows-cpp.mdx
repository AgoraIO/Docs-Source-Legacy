...
We provide an open-source demo project that implements [channel media relay](https://github.com/AgoraIO/API-Examples/tree/master/windows/APIExample/APIExample/Advanced/CrossChannel) on GitHub. You can try the demo and view the source code.
