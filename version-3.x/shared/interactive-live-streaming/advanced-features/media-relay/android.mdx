...
Agora provides an open-source [HostAcrossChannel](https://github.com/AgoraIO/API-Examples/blob/legacy/Android/APIExample/app/src/main/java/io/agora/api/example/examples/advanced/HostAcrossChannel.java) sample project on GitHub. You can download the project to try it out or view the source code.
