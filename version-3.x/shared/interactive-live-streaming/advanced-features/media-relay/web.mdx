...
Before relaying media streams across channels, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start Live Interactive Streaming](../quickstart-guide/start-video-streaming).
...
| 3          | See [error code](https://api-ref.agora.io/en/video-sdk/web/3.x/classes/agorartc.channelmediaerror.html). | /          | An exception occurs during the media stream relay. Call `startChannelMediaRelay` to restart. |
...
- [`startChannelMediaRelay`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.client.html#startchannelmediarelay)
- [`updateChannelMediaRelay`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.client.html#updatechannelmediarelay)
- [`stopChannelMediaRelay`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.client.html#stopchannelmediarelay)
...
- When setting the source channel information (`setSrcChannelInfo`), ensure that the setting of `uid` is different from the user ID of the current host and any other user in the source channel. We recommend setting this `uid` as `0`.
