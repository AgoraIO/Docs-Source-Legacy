...
Agora provides an open-source demo project on GitHub that implements [audio effect files](https://github.com/AgoraIO/API-Examples/tree/main/windows/APIExample/APIExample/Advanced/AudioEffect) and a [music file](https://github.com/AgoraIO/API-Examples/tree/main/windows/APIExample/APIExample/Advanced/AudioMixing). You can view the source code on Github or download the project to try it out.
