...
Agora provides an [open-source demo project](https://github.com/AgoraIO/API-Examples/blob/legacy/Android/APIExample/app/src/main/java/io/agora/api/example/examples/advanced/PlayAudioFiles.java) on GitHub that implements playing audio effect files and a music file. You can view the source code on Github or download the project to try it out.
...
- [What formats of audio files does the Agora RTC SDK support?](https://docs.agora.io/en/help/general-product-inquiry/audio_format)
