...
Before proceeding, ensure that you implement a basic call or interactive live streaming in your project. See [Start a Voice Call](/3.7.1/voice-calling/quickstart-guide/get-started-sdk) and [Start interactive live streaming](../quickstart-guide/start-audio-streaming) for details.
