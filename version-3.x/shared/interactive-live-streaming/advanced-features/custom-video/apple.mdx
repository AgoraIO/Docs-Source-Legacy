...
- After receiving  [`bufferType`](./API%20Reference/oc/Protocols/AgoraVideoSourceProtocol.html#//api/name/bufferType), specify the format of the captured video frames in the return value.
- After receiving [`shouldInitialize`](./API%20Reference/oc/Protocols/AgoraVideoSourceProtocol.html#//api/name/shouldInitialize), initialize the custom video source, for example, by turning on the video capture device. The SDK maintains the AgoraVideoFrameConsumer instance contained in the callback.
- After receiving [`shouldStart`](./API%20Reference/oc/Protocols/AgoraVideoSourceProtocol.html#//api/name/shouldStart), send video frames to the SDK using [`consumePixelBuffer`](./API%20Reference/oc/Protocols/AgoraVideoFrameConsumer.html#//api/name/consumePixelBuffer:withTimestamp:rotation:) or [`consumeRawData`](./API%20Reference/oc/Protocols/AgoraVideoFrameConsumer.html#//api/name/consumeRawData:withTimestamp:format:size:rotation:). You can modify the video frame parameters in `AgoraVideoFrameConsumer` according to your app scenario.
- After receiving [`shouldStop`](./API%20Reference/oc/Protocols/AgoraVideoSourceProtocol.html#//api/name/shouldStop), stop sending video frames to the SDK.
- After receiving [`shouldDispose`](./API%20Reference/oc/Protocols/AgoraVideoSourceProtocol.html#//api/name/shouldDispose), release the custom video source, for example, by turning off the video capture device.
...
- After receiving [`bufferType`](./API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/bufferType) and [`pixelFormat`](./API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/pixelFormat), specify the format of rendered video frames in the return value.
- Control the video rendering process with the [`shouldInitialize`](./API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/shouldInitialize), [`shouldStart`](./API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/shouldStart), [`shouldStop`](./API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/shouldStop), and [`shouldDispose`](./API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/shouldDispose) callbacks.
- The SDK triggers [`renderPixelBuffer`](./API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/renderPixelBuffer:rotation:) or [`renderRawData`](./API%20Reference/oc/Protocols/AgoraVideoSinkProtocol.html#//api/name/renderRawData:size:rotation:) according to the video-frames format that you set in `bufferType` or `pixelFormat`.
...
Call [`setLocalVideoRenderer`](./API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setLocalVideoRenderer:) of the SDK to display the video in the local view.
