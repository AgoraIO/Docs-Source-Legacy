...
- [Custom video capture (Push)](https://github.com/AgoraIO/API-Examples/tree/legacy/windows/APIExample/APIExample/Advanced/CustomVideoCapture)
- [Custom video capture (mediaIO)](https://github.com/AgoraIO/API-Examples/tree/legacy/windows/APIExample/APIExample/Advanced/MediaIOCustomVideoCaptrue)
