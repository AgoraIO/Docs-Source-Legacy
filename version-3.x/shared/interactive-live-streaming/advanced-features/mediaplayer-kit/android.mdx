...
Refer to [the RTC quickstart guide](../quickstart-guide/start-video-streaming) for details about how to enable the local user to join the `LIVE_BROADCASTING` channel in the role of `BROADCASTER`:
