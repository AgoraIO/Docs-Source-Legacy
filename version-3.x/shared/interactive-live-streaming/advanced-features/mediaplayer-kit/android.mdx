...
1. Go to [Downloads](https://docs.agora.io/en/sdks?platform=android), download the latest version of the MediaPlayer Kit, and unzip the download package.
...
Integration steps: See [Integrate the Native SDK](/en/3.x/interactive-live-streaming/quickstart-guide/start-video-streaming#integrate-the-sdk)

### Integrate the RtcChannelPublishHelper

Integration steps:

1. Go to [Download](https://docs.agora.io/en/sdks?platform=android), download the latest version of the Agora Native SDK, and unzip the download package.
...
1. [Instantiate an RtcEngine object](/en/3.x/interactive-live-streaming/quickstart-guide/start-video-streaming#4-initialize-rtcengine).
...
Refer to [the RTC quickstart guide](/en/3.x/interactive-live-streaming/quickstart-guide/start-video-streaming) for details about how to enable the local user to join the `LIVE_BROADCASTING` channel in the role of `BROADCASTER`:
...
## API documentation
See the [API documentation](https://api-ref.agora.io/en/mediaplayer-kit/android/1.x/index.html).
