This page provides download links and release notes for more versions of the Agora Voice SDK. To ensure a trouble-free development experience, Agora strongly recommends that you use [official mainline versions](./release_android_audio).
...
|------- |-------|--------|
|Android | [v3.7.0.2](https://download.agora.io/sdk/release/Agora_Native_SDK_for_Android_v3_7_0_2_VOICE.zip)      | [v3.7.0.1](./release_android_audio?platform=Android)      |
|iOS | [v3.7.0.2](https://download.agora.io/sdk/release/Agora_Native_SDK_for_iOS_v3_7_0_2_VOICE.zip)      | [v3.7.0](./release_ios_audio?platform=iOS)      |
|macOS| [v3.7.0.2](https://download.agora.io/sdk/release/Agora_Native_SDK_for_Mac_v3_7_0_2_VOICE.zip)      | [v3.7.0](./release_mac_audio?platform=macOS)      |
|Windows | [v3.7.0.2](https://download.agora.io/sdk/release/Agora_Native_SDK_for_Windows_v3_7_0_2_VOICE.zip)      | [v3.7.0](./release_windows_audio?platform=Windows)      |
...
- [Android Release Notes](./release_android_audio?platform=Android)
- [iOS Release Notes](./release_ios_audio?platform=iOS)
- [macOS Release Notes](./release_mac_audio?platform=macOS)
- [Windows Release Notes](./release_windows_audio?platform=Windows)
