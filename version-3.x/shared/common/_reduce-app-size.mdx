...
As of v3.7.0, the SDK provides the `startScreenCapture` method and the `AgoraReplayKitExtension.xcframework` extension library for screen sharing. See <Link to="../basic-features/screensharing?platform=iOS">Share the Screen</Link>.
