...
As of v3.7.0, the SDK provides the `startScreenCapture` method and the `AgoraReplayKitExtension.xcframework` extension library for screen sharing. See [Share the Screen](../../../video-calling/basic-features/screensharing?platform=iOS).
