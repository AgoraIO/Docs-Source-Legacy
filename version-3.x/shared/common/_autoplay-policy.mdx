...
This feature is supported for Web only.

</PlatformWrapper>

<PlatformWrapper platform="web">

To prevent a webpage from playing sound without permission, most web browsers restrict the autoplay function: Autoplay with sound is blocked unless the user has interacted with the webpage.
