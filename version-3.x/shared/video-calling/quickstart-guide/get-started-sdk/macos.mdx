...
1. Navigate to [SDK Downloads](https://docs.agora.io/en/Video/downloads?platform=macOS), download the latest version of the Agora macOS SDK, and extract the files from the downloaded SDK package.
