...
1. Navigate to [SDK Downloads](https://docs.agora.io/en/Voice//downloads?platform=macOS), download the latest version of the Agora macOS SDK, and extract the files from the downloaded SDK package.
...
````html
======= ```shellscript >>>>>>> d84c52ac5de0cbe354c8887ade79e98fe99216c9
...
> > > > > > > d84c52ac5de0cbe354c8887ade79e98fe99216c9 3. In Xcode 12.2 and later, to avoid compliation errors, you need to navigate to **TARGETS** > **Project Name** > **Build Settings** > **Architectures**, and set the **Architectures** property to **x86_64** before the compilation.
