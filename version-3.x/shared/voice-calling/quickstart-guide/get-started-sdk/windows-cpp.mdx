...
<div class="alert note">Open the specified ports in <Link to="../reference/firewall?platform={{platform.PATH}}">Firewall Requirements</Link> if your network has a firewall.</div>
...
In this step, you need to use the App ID of your project. Refer to <Link to="../reference/manage-agora-account?platform={{platform.PATH}}">Get Started With Agora</Link> to create an Agora project and get the App ID in Console.
