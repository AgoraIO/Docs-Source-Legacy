...
- An [Agora project](../reference/manage-agora-account#create-an-agora-project) with an App ID and a temp token
- A Windows or macOS computer meets the following requirements:
  ...
  - A browser that matches the [supported browser list](https://docs.agora.io/en/Agora%20Platform/faq/browser_support). Agora highly recommends using the [latest version](https://www.google.com/chrome/) of Google Chrome.
...
1. Download the latest [Agora Web SDK](https://docs.agora.io/en/Voice/downloads?platform=Web).
...
![1592906455910](https://web-cdn.agora.io/docs-files/1592906455910)
