...
This release adds the [`startEchoTest`](./API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#a394c60056c0cd31af48e8015b0c553f4) [3/3] method.
...
This release added the [error code](./error_rtc?platform=Windows): `ERR_ADM_WIN_CORE_SERVRE_SHUT_DOWN (1735)`.
...
- [`muteLocalAudioStream`](./API%20Reference/cpp/classagora_1_1rtc_1_1_i_channel.html#aef5c790faea22bfefe7299bb62bdb899) in `IChannel`
- `publishLocalAudio` in [`ChannelMediaOptions`](./API%20Reference/cpp/structagora_1_1rtc_1_1_channel_media_options.html)
...
This release adds the Agora basic calculation framework `libagora-core.dll`. To integrate the SDK into your project, see [Integrate the SDK](./start_call_audio_windows?platform=Windows#integrate-the-sdk).
...
- `publishDuration` in the [`RemoteAudioStats`](./API%20Reference/cpp/structagora_1_1rtc_1_1_remote_audio_stats.html) struct
...
- [Quick start](./start_call_windows)
- [Use security keys](./token)
- [Report in-call statistics](./in-call_quality_windows)
- [Adjust the volume](./volume_windows)
- [Play audio effects/audio mixing](./audio_effect_mixing_windows)
- [Set the voice changer and reverberation effects](./voice_changer_windows)
- [Test or select a media device](./test_switch_device_windows)
- [Use Cloud Proxy](./cloudproxy_native?platform=Windows)
