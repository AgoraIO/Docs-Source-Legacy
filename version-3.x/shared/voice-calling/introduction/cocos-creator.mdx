...
![](https://web-cdn.agora.io/docs-files/1608023889245)
...
- [Start a Video Call](./start_call_cocos_creator)
- [Start Interactive Live Video Streaming](./start_live_cocos_creator)
- [API Reference](./API%20Reference/cocos_creator/index.html)
...
- [Start a Voice Call](./start_call_audio_cocos_creator) or [Start Interactive Live Audio Streaming](./start_live_audio_cocos_creator)
- [API Reference](./API%20Reference/cocos_creator/index.html)

Agora also provides an open-source [sample project](https://github.com/AgoraIO-Community/Agora-Cocos-Quickstart/tree/master/CocosCreator) on GitHub.
