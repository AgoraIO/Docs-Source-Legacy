...
1. Install AgoraALD. See <Link to="/3.x/shared/interactive-live-streaming/advanced-features/virtual-sound-card?platform={{platform.PATH}}">AgoraALD Virtual Sound Card</Link>
...
<div class="alert info"> This release deprecates three old methods for CDN live streaming: <code>AddPublishStreamUrl</code>, <code>SetLiveTranscoding</code>, and <code>RemovePublishStreamUrl</code>. Agora recommends that you use the new methods for CDN live streaming and update your code logic by referring to <Link to="/3.x/shared/interactive-live-streaming/media-push?platform={{platform.PATH}}">Media Push</Link>. </div>
...
- Reporting streaming states, errors, and events:
  ...
  - Renaming `RTMP_STREAM_PUBLISH_ERROR` to `RTMP_STREAM_PUBLISH_ERROR_TYPE` and adding the following to the `RTMP_STREAM_PUBLISH_ERROR_TYPE` error code:
    ...
    - `RTMP_STREAM_PUBLISH_ERROR_INVALID_APPID(15)`: Your App ID does not have permission to use the CDN live streaming function. Refer to <Link to="/3.x/shared/interactive-live-streaming/media-push#prerequisites?platform={{platform.PATH}}">Prerequisites</Link> to enable the CDN live streaming permission.
...
- [`PushAudioFrame`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#aa791dd3de749a2a2e144e5e28d0b4170)
- [`SetExternalAudioSourceVolume`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a07bb1b1736107af4b4cdb2523f093e17)
- [`SetAudioMixingPlaybackSpeed`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#ab09032a08860ae8a3fc2cc390c353320)
- [`GetAudioTrackCount`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a36fd324b786827c3dfcc7dd4c84026ca)
- [`SelectAudioTrack`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#ab7394e0ee051280637c89c432dc03679)
- [`SetAudioMixingDualMonoMode`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a79e893c724bc60d3a01d022a69983704)
- [`PauseAllChannelMediaRelay`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a652e58225c2d13e4f9b3c61e43963a9b)
- [`ResumeAllChannelMediaRelay`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#ae6dd13ac6cd8e77652ee6b6b74be5e8a)
- The following enumerators in [`CHANNEL_MEDIA_RELAY_EVENT`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/namespaceagora__gaming__rtc.html#a02d1e8579142814739af24c65f320d6e):
...
- [`GetAudioFileInfo`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a6f9438df3f15a0052cc282d42681a655)
- [`OnRequestAudioFileInfoHandler`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/namespaceagora__gaming__rtc.html#a0090cc1f5259b022105d3bb3cea84337)
- `LOCAL_AUDIO_STREAM_ERROR_RECORD_INVALID_ID(9)` and `LOCAL_AUDIO_STREAM_ERROR_PLAYOUT_INVALID_ID(10)` in [`LOCAL_AUDIO_STREAM_ERROR`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/namespaceagora__gaming__rtc.html#a635752ff6077fa96e730f513668a0c04)
-  `NETWORK_TYPE_MOBILE_5G(6)` in [`NETWORK_TYPE`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/namespaceagora__gaming__rtc.html#ad2817b616c08cb15a3505caa75e413b1) 
- [`StartEchoTest`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a3eed33e686179e037e3cd43c9f597667) [3/3]
- The following enumerators in [`LOCAL_VIDEO_STREAM_ERROR`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/namespaceagora__gaming__rtc.html#a66baa891d5de1a2d43341b5460b2f059)：
  - `LOCAL_VIDEO_STREAM_ERROR_DEVICE_INVALID_ID(10)`
  - `LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_OCCLUDED(13)`
  - `LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_NOT_SUPPORTED(20)`
- [`StartRtmpStreamWithoutTranscoding`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a2f0994dbc3b1bb8e23853ffdb67d0dd9)
- [`StartRtmpStreamWithTranscoding`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a34fbe006d84d0542e652a49492711900)
- [`UpdateRtmpTranscoding`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a2454acc0080f36a32c98a41d3c7f08ae)
- [`StopRtmpStream`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_i_rtc_engine.html#a4a48fd2558f15a25e0845e57f08dc7f3)
- `RTMP_STREAM_PUBLISH_STATE_DISCONNECTING(5)` in  [`RTMP_STREAM_PUBLISH_STATE`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/namespaceagora__gaming__rtc.html#a2132250fb5d8c8e0f3e52bf15449f2ff) 
- The following enumerators in [`RTMP_STREAM_PUBLISH_ERROR_TYPE`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/namespaceagora__gaming__rtc.html#acf64f163b1768d834ce6b8cbabcf235d):
...
- The following enumerators in[`RTMP_STREAMING_EVENT`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/namespaceagora__gaming__rtc.html#a1161b5f270933ebd660b9c29848161aa):
  - `RTMP_STREAMING_EVENT_ADVANCED_FEATURE_NOT_SUPPORT(3)`
  - `RTMP_STREAMING_EVENT_REQUEST_TOO_OFTEN(4)`
- `AUDIO_CODEC_PROFILE_HE_AAC_V2(2)` in  [`AUDIO_CODEC_PROFILE_TYPE`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/namespaceagora__gaming__rtc.html#ac158d8109203b32bfe60cbadf37dfe80) 
- [`GetAudioRecordingDefaultDevice`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_audio_recording_device_manager.html#a817e38006202b733f8608765d7353a7d)
- [`GetAudioPlaybackDefaultDevice`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_audio_playback_device_manager.html#ad91f0d3230c10042498bfecdbbe9a7c5)
- [`FollowSystemPlaybackDevice`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_audio_playback_device_manager.html#a2884fba3f5506bfc6658c431b3a75111)
- [`FollowSystemRecordingDevice`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.6.1.1/classagora__gaming__rtc_1_1_audio_recording_device_manager.html#a52fe58871ce03f0893e19173fa77baaa)
...
- When the SDK uses the media volume, the audio route is affected as follows:
  ...
  <div class="alert info">To learn about the scenarios where the SDK uses the media volume, see <a href="https://docs.agora.io/en/Video/faq/system_volume">What is the difference between the in-call volume and the media volume</a>.</div>
...
- [`SetEnableSpeakerphone`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#aa8ef8504581b10975ceb2dc86c133481)
- [`SetDefaultAudioRouteToSpeakerphone`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a7ed850ab08664fb9b847ac9416e7fec5)
...
- `RTMP_STREAM_UNPUBLISH_ERROR_OK (100)` in [`RTMP_STREAM_PUBLISH_ERROR`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html?platform=Unity#adf0b94807c88344092613487b0dfa0c9)
- `RTMP_STREAMING_EVENT_URL_ALREADY_IN_USE (2)` in [`RTMP_STREAMING_EVENT`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html?platform=Unity#a1161b5f270933ebd660b9c29848161aa) 
-  `AES_128_GCM2 (7)` and `AES_256_GCM2 (8)` in [`EncryptionMode`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html#a94f249e19d1de6e0a6ac2348ace088fb) 
- [`encryptionKdfSalt`](https://docs.agora.io/en/Voice/API%20Reference/unity/v3.4.5/structagora__gaming__rtc_1_1_encryption_config.html#ae88de9e9ef42b206d9de307d2f4bc47a) in [`EncryptionConfig`](https://docs.agora.io/en/Voice/API%20Reference/unity/structagora__gaming__rtc_1_1_encryption_config.html) 
- [`MuteLocalAudioStream`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html?platform=Unity#a6260eac33b6624824872a7140a229ef3) in `IRtcEngine` 
...
[`MEDIA_DEVICE_STATE_TYPE`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html?platform=Unity#ad862a26da27e398f045eb4a95bcfa530)
...
- [`AdjustLoopbackRecordingSignalVolume`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a2b44e09cccfed942c6df06551d3aca29)
- [`GetAudioMixingDuration`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a581955d6b97a81c7edf2b9aea88cfcb2) [2/2]
- [`StartAudioRecording`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a3fde78b23f4f36610c15d22f9392f2ca) [3/3]
- [`GetEffectDuration`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_audio_effect_manager_impl.html#a9dbc262a96b256b3fcc04c510cc8666a)
- [`SetEffectPosition`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_audio_effect_manager_impl.html#a89bf6f0ae950354545dc94f94609b753)
- [`GetEffectCurrentPosition`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_audio_effect_manager_impl.html#a415b3e9805bbf513039ed7ef48c74bd8)
- [`PlayEffect`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_audio_effect_manager_impl.html#a221f53a8c7c857c1b94133f481a9c3d4) [2/2]
- [`StartAudioMixing`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a37642f8384220a6494232d90e1fbd8c3) [2/2]
- `LOCAL_AUDIO_STREAM_ERROR_NO_RECORDING_DEVICE(6)` and `LOCAL_AUDIO_STREAM_ERROR_NO_PLAYOUT_DEVICE(7)` in [`LOCAL_AUDIO_STREAM_ERROR`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html#a635752ff6077fa96e730f513668a0c04)
- Error code: `-160`

**Modified**

- [`OnAudioMixingStateChangedHandler`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html#a41f42633cf2053de2dc6b4dd0a085a1f)
...
- [`SetVoiceConversionPreset`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#aee2fb5664266783a9ff855b4ef81e1b6)
- `AES_128_GCM` and `AES_256_GCM` in [`ENCRYPTION_MODE`](https://docs.agora.io/en/Voice/API%20Reference/unity/structagora__gaming__rtc_1_1_encryption_config.html)
- [`SetVoiceBeautifierParameters`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#acb6c5d42ea4e14b0f2e7bc8f27bc2def)
- `SINGING_BEAUTIFIER` in [`VOICE_BEAUTIFIER_PRESET`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html#a95376eca24c67a6c2bee9d0ca2b2e7d6)
- [`EnableDeepLearningDenoise`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a401707e8917f9af84c3a77e77f0160e5)
- [`JoinChannel`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#ad64ca959b93b2678df44777ad20e2072)2
- [`SwitchChannel`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a44cde739692d5a4326b918d631170be9)2
- [`CreateDataStream`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a2779954830d051179e574e1c744fb411)
- `logConfig` in [`RtcEngineConfig`](https://docs.agora.io/en/Voice/API%20Reference/unity/structagora__gaming__rtc_1_1_rtc_engine_config.html)
- `qoeQuality`, `qualityChangedReason` and `mosValue` in [`RemoteAudioStats`](https://docs.agora.io/en/Voice/API%20Reference/unity/structagora__gaming__rtc_1_1_remote_audio_stats.html)
- [`SetCloudProxy`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#ad354f9ec01a0985f76f82cae1fafee5e)
- `captureWidth` and `captureHeight` in [`CameraCapturerConfiguration`](https://docs.agora.io/en/Voice/API%20Reference/unity/structagora__gaming__rtc_1_1_camera_capturer_configuration.html)
- `CAPTURER_OUTPUT_PREFERENCE_MANUAL(3)` in [`CAPTURER_OUTPUT_PREFERENCE`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html#a6642195eed7dc4bd5457f41992bf0e36)
...
If you upgrade the SDK to v3.2.1, ensure that you have added the above files in your project according to [Quickstart Guide](../quickstart-guide/start-audio-streaming).
...
- [`SetClientRole`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a9a31f9b8e45c6528d6f56914619de314)
- [`SetAudioEffectPreset`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a4bbf600b51a400fe6ab261a95e47bad6)
- [`SetVoiceBeautifierPreset`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#ab4953c6ce75adc42a13297af41676d9a)
- [`SetAudioEffectParameters`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a9ccf7abdd5f7b4bc0e7f0a7807e34390)
- [`EnableEncryption`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a54214baf0b421161990eded9c7401976)
- [`OnAudioPublishStateChangedHandler`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html#aabfff11675d45572de8eb5f28d80ac33)
- [`OnAudioSubscribeStateChangedHandler`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html#aa0283db27464a1cc827515853db924c5)
- [`OnFirstLocalAudioFramePublishedHandler`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html#a2be635d5257a7673102e0e0e62c73793)
- `txPacketLossRate` in [`LocalAudioStats`](https://docs.agora.io/en/Voice/API%20Reference/unity/structagora__gaming__rtc_1_1_local_audio_stats.html)
- `publishDuration` in [`RemoteAudioStats`](https://docs.agora.io/en/Voice/API%20Reference/unity/structagora__gaming__rtc_1_1_remote_audio_stats.html)
- `AUDIO_SCENARIO_MEETING(8)` in [`AUDIO_SCENARIO_TYPE`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html#a7630f2ee913986430344d4aad26098a3) enum
- `AUDIO_ROUTE_USB`, `AUDIO_ROUTE_HDMI`, `AUDIO_ROUTE_DISPLAYPORT` and `AUDIO_ROUTE_AIRPLAY` in [`AUDIO_ROUTE`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html#aca310af5a1412fa7a7475b245994b3ae) enum
...
- Nine enumerations in [`VOICE_CHANGER_PRESET`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html#a710b9754965ccb92ed968a562968df2c), such as `VOICE_BEAUTY_VIGOROUS`
- Twelve enumerations in [`AUDIO_REVERB_PRESET`](https://docs.agora.io/en/Voice/API%20Reference/unity/namespaceagora__gaming__rtc.html#a1e681589411dd2f5df62dab5c1fca7b9), such as `AUDIO_REVERB_FX_KTV`
