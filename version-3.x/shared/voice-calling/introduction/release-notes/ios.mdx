...
- Supports more audio file formats. See [Which audio file formats does the Agora RTC SDK support](https://docs.agora.io/en/faq/audio_format).
...
- The `gatewayRtt`, `memoryAppUsageRatio`, `memoryTotalUsageRatio` and `memoryAppUsageInKbytes` members in the [`AgoraChannelStats`](https://api-ref.agora.io/en/voice-sdk/macos/3.x/Classes/AgoraChannelStats.html) class
