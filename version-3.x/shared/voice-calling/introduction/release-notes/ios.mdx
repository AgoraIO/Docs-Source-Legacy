...
- [`startRtmpStreamWithoutTranscoding`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startRtmpStreamWithoutTranscoding:)

- [`startRtmpStreamWithTranscoding`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startRtmpStreamWithTranscoding:transcoding:)

- [`updateRtmpTranscoding`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/updateRtmpTranscoding:)

- [`stopRtmpStream`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/stopRtmpStream:)

- `AgoraRtmpStreamingStateDisconnecting(5)` in [`AgoraRtmpStreamingState`](https://docs.agora.io/en/Voice/API%20Reference/oc/Constants/AgoraRtmpStreamingState.html) 

- The following enumerators in [`AgoraRtmpStreamingErrorCode`](https://docs.agora.io/en/Voice/API%20Reference/oc/Constants/AgoraRtmpStreamingErrorCode.html):
...
- The following enumerators in [`AgoraRtmpStreamingEvent`](https://docs.agora.io/en/Voice/API%20Reference/oc/Constants/AgoraRtmpStreamingEvent.html):

  - `RTMP_STREAMING_EVENT_ADVANCED_FEATURE_NOT_SUPPORT(3)`
  - `RTMP_STREAMING_EVENT_REQUEST_TOO_OFTEN(4)`

- `AgoraAudioCodecProfileHEAACv2` in the [`AgoraAudioCodecProfileType`](https://docs.agora.io/en/Voice/API%20Reference/oc/Constants/AgoraAudioCodecProfileType.html) class
...
This release adds the [`startEchoTestWithConfig`](https://docs.agora.io/en/Voice/API%20Reference/oc//Classes/AgoraRtcEngineKit.html#//api/name/startEchoTestWithConfig:) method.
...
- [`isMultipleChannelFrameWanted`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/isMultipleChannelFrameWanted)
- [`onPlaybackAudioFrameBeforeMixingEx`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/onPlaybackAudioFrameBeforeMixingEx:channelId:uid:)
...
- `AgoraRtmpStreamingErrorCodeUnpublishOK (100)` in [`AgoraRtmpStreamingErrorCode`](https://docs.agora.io/en/Voice/API%20Reference/oc/Constants/AgoraRtmpStreamingErrorCode.html)
- `AgoraRtmpStreamingEventUrlAlreadyInUse (2)` in [`AgoraRtmpStreamingEvent`](https://docs.agora.io/en/Voice/API%20Reference/oc/Constants/AgoraRtmpStreamingEvent.html)
- `AgoraEncryptionModeAES128GCM2 (7)` and `AgoraEncryptionModeAES256GCM2 (8)` in [`AgoraEncryptionMode`](https://docs.agora.io/en/Voice/API%20Reference/oc/Constants/AgoraEncryptionMode.html)
- [`encryptionKdfSalt`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraEncryptionConfig.html#//api/name/encryptionKdfSalt) in `AgoraEncryptionConfig`
- [`muteLocalAudioStream`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcChannel.html#//api/name/muteLocalAudioStream:) in `AgoraRtcChannel`
- `publishLocalAudio` in [`AgoraRtcChannelMediaOptions`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcChannelMediaOptions.html)
- The following callbacks in [`AgoraAudioDataFrameProtocol`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html):
  - [`getObservedAudioFramePosition`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/getObservedAudioFramePosition)
  - [`getRecordAudioParams`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/getRecordAudioParams)
  - [`getMixedAudioParams`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/getMixedAudioParams)
  - [`getPlaybackAudioParams`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html#//api/name/getPlaybackAudioParams)

**Modified**

- `setAudioFrameDelegate` to [`setAudioDataFrame`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioDataFrame:)
- `AgoraAudioFrameDelegate` to [`AgoraAudioDataFrameProtocol`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraAudioDataFrameProtocol.html)
- [`startAudioMixing`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startAudioMixing:loopback:replace:cycle:startPos:)
...
- [`startRhythmPlayer`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startRhythmPlayer:sound2:config:)
- [`stopRhythmPlayer`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/stopRhythmPlayer)
- [`configRhythmPlayer`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/configRhythmPlayer:)
- [`playEffect`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/playEffect:filePath:loopCount:pitch:pan:gain:publish:startPos:)3
- [`getEffectDuration`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/getEffectDuration:)
- [`setEffectPosition`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setEffectPosition:pos:)
- [`getEffectCurrentPosition`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/getEffectCurrentPosition:)
- [`startAudioMixing`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startAudioMixing:loopback:replace:cycle:startPos:)2
- [`startAudioRecordingWithConfig`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/startAudioRecordingWithConfig:)3
- [Error Code](../reference/error-codes): `AgoraErrorCodeAlreadyInRecording(160)`

**Modified**

- [`localAudioMixingStateDidChanged`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:localAudioMixingStateDidChanged:reason:)
...
- [`setVoiceConversionPreset`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setVoiceConversionPreset:)
- `AgoraEncryptionModeAES128GCM` and `AgoraEncryptionModeAES256GCM` in [`AgoraEncryptionMode`](https://docs.agora.io/en/Voice/API%20Reference/oc/Constants/AgoraEncryptionMode.html) 
- `mosValue` in [`AgoraRtcRemoteAudioStats`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcRemoteAudioStats.html)
...
- [`setVoiceBeautifierParameters`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setVoiceBeautifierParameters:param1:param2:)
- `AgoraSingingBeautifier` in the [`AgoraVoiceBeautifierPreset`](https://docs.agora.io/en/Voice/API%20Reference/oc/Constants/AgoraVoiceBeautifierPreset.html) constant
- [`enableDeepLearningDenoise`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/enableDeepLearningDenoise:)
- [`joinChannelByToken`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/joinChannelByToken:channelId:info:uid:options:)2
- [`switchChannelByToken`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/switchChannelByToken:channelId:options:)2
- [`createDataStream`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/createDataStream:config:)
- The `logConfig` property in the [`AgoraRtcEngineConfig`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineConfig.html) class
- [`setAudioFrameDelegate`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioFrameDelegate:)
- [`onRecordAudioFrame`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraAudioFrameDelegate.html#//api/name/onRecordAudioFrame:)
- [`onPlaybackAudioFrame`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraAudioFrameDelegate.html#//api/name/onPlaybackAudioFrame:)
- [`onMixedAudioFrame`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraAudioFrameDelegate.html#//api/name/onMixedAudioFrame:)
- [`onPlaybackAudioFrameBeforeMixing`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraAudioFrameDelegate.html#//api/name/onPlaybackAudioFrameBeforeMixing:uid:)
- The `qoeQuality` and `qualityChangedReason` properties in the [`AgoraRtcRemoteAudioStats`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcRemoteAudioStats.html) class
- [`setCloudProxy`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setCloudProxy:)
- Error code: [`AgoraErrorCodeModuleNotFound(157)`](https://docs.agora.io/en/Voice/API%20Reference/oc/Constants/AgoraErrorCode.html)
...
For details, see the [product overview](https://docs.agora.io/en/live-streaming/product_live_standard?platform=iOS) of Interactive Live Streaming Standard. 
...
- [`setClientRole`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setClientRole:options:)
- [`setAudioEffectPreset`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioEffectPreset:)
- [`setVoiceBeautifierPreset`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setVoiceBeautifierPreset:)
- [`setAudioEffectParameters`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setAudioEffectParameters:param1:param2:)
- `AgoraAudioScenarioMeeting(8)` in [`AgoraAudioScenario`](https://docs.agora.io/en/Voice/API%20Reference/oc/Constants/AgoraAudioScenario.html)
...
If you have specified a region for connection when calling [`sharedEngineWithConfig`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/sharedEngineWithConfig:delegate:), ensure that you use the latest area code when migrating from an earlier SDK version.
...
- `firstRemoteAudioFrameDecodedOfUid` and `firstRemoteAudioFrameOfUid`. Use the [`remoteAudioStateChangedOfUid`](https://docs.agora.io/en/Voice/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:remoteAudioStateChangedOfUid:state:reason:elapsed:) callback instead.
