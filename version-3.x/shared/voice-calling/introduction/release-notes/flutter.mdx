...
As of v5.0.0, the Agora <Vg k="ASDK" /> Flutter SDK supports Flutter 2.x and can run on Android, iOS, macOS, and Windows platforms.
...
Since this version, Agora <Vg k="ASDK" /> Flutter SDK supports null safety. Because null safety is not backward compatible, **you must ensure that the dart version is 2.12 or higher**. See [Flutter documentation](https://dart.dev/null-safety) for more information.

2. Flutter 2.x support (Android and iOS only)

Since this version, Agora <Vg k="ASDK" /> Flutter SDK supports Flutter 2.x (Android and iOS only.)
