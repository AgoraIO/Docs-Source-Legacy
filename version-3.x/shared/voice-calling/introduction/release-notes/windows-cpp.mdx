...
<div class="alert note">This release deprecates three old methods for Media Push: <code>addPublishStreamUrl</code>, <code>setLiveTranscoding</code>, and <code>removePublishStreamUrl</code>. Agora recommends that you use the new methods for Media Push and update your code logic by referring to <Link to="/3.x/interactive-live-streaming/advanced-features/media-push">Media Push</Link>.</div>
...
- Reporting streaming states, errors, and events:
    ...
    - Renaming `RTMP_STREAM_PUBLISH_ERROR` to `RTMP_STREAM_PUBLISH_ERROR_TYPE` and adding the following to the `RTMP_STREAM_PUBLISH_ERROR_TYPE` error code:
        ...
        - `RTMP_STREAM_PUBLISH_ERROR_INVALID_APPID(15)`: Your App ID does not have permission to use the Media Push function. Refer to <Link to="/3.x/interactive-live-streaming/advanced-features/media-push#prerequisites">Prerequisites</Link> to enable the Media Push permission.
...
This release adds the [`startEchoTest`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a394c60056c0cd31af48e8015b0c553f4) [3/3] method.
...
- [`pushAudioFrame`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1media_1_1_i_media_engine.html#ae8c816681bcf4843f59dc7a8bdba89d7)[3/3]
- [`setExternalAudioSourceVolume`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1media_1_1_i_media_engine.html#a802af60896bcb126e099b9d199eb6249)
- [`setAudioMixingPlaybackSpeed`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a1850045b8ced9a43118b660f808fed9e)
- [`getAudioTrackCount`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a7d365b13d852a46192c663440c598304)
- [`selectAudioTrack`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a21e4aa7b76079be0f91f19acd5e9c42b)
- [`setAudioMixingDualMonoMode`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a90879ca474a4fcaac94b28b9d9bc06c1)
- [`pauseAllChannelMediaRelay`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a6761e2f090290567d1f592841c40d96c)
- [`resumeAllChannelMediaRelay`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a92a74b5b3752d285dfdb769607220e70)
- The following enumerators in [`CHANNEL_MEDIA_RELAY_EVENT`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#af564e2eaf05e8391929b881978821c78):
...
- [`getAudioFileInfo`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a750ac7f4cf1c471fb1c8a0a8f4346f51)
- [`onRequestAudioFileInfo`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a69e4af0282ba8b2b97a6e2fbe2ca43c4)
- `LOCAL_AUDIO_STREAM_ERROR_RECORD_INVALID_ID(9)` and `LOCAL_AUDIO_STREAM_ERROR_PLAYOUT_INVALID_ID(10)` in [`LOCAL_AUDIO_STREAM_ERROR`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#a3929991eea3a522dcbf6ac078810045e)
- `NETWORK_TYPE_MOBILE_5G(6)` in [`NETWORK_TYPE`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#ab5e06b511f978f1a997008401da46505)
...
This release added the <Link to="../reference/error-codes">error code</Link>: `ERR_ADM_WIN_CORE_SERVRE_SHUT_DOWN (1735)`.
...
See <Link to="/3.x/interactive-live-streaming/advanced-features/channel-encryption">Media Stream Encryption</Link>.
...
See <Link to="../best-practices/set-subscribing-state">Set the Subscribing State</Link> and <Link to="/3.x/interactive-live-streaming/advanced-features/multiple-channel">Join multiple channels</Link>.
...
- `RTMP_STREAM_UNPUBLISH_ERROR_OK (100)` in [`RTMP_STREAM_PUBLISH_ERROR`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#a4e520a87875a922c00cee3998d220af3)
- `RTMP_STREAMING_EVENT_URL_ALREADY_IN_USE (2)` in [`RTMP_STREAMING_EVENT`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#a82a4c69d97a3dac5b55f9bd5b423f14c)
- `AES_128_GCM2 (7)` and `AES_256_GCM2 (8)` in [`ENCRYPTION_MODE`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#a906cebebbabf534c86ca71de0d1a4cf0)
- `encryptionKdfSalt` in [`EncryptionConfig`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_encryption_config.html)
- [`muteLocalAudioStream`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_channel.html#aef5c790faea22bfefe7299bb62bdb899) in `IChannel`
- `publishLocalAudio` in [`ChannelMediaOptions`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_channel_media_options.html)
- `MEDIA_DEVICE_STATE_IDLE (0)` in [`MEDIA_DEVICE_STATE_TYPE`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#a089cee6e2323c5bb04849df711bb4a52)

**Modified**

- [`MEDIA_DEVICE_STATE_TYPE`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#a089cee6e2323c5bb04849df711bb4a52)
- [`startAudioMixing`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a21063bfb71a8a5cbc0d391f9d7ac75be)
...
To reduce the app size after integrating the SDK, this release packages some features as extension libraries (with the `Extension` suffix). For details, see <Link to="../best-practices/reduce-app-size#extension-libraries">Extension libraries</Link>. If you do not need to use the related features, you can remove the corresponding extension libraries and recompile the project.
...
- [`adjustLoopbackRecordingSignalVolume`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#aabf1aa2610811622acc8a4167e4d64b5)
- [`getAudioMixingDuration`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a3b67f2476a43679cc5174ac5424efed5)[2/2]
- [`startAudioRecording`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#ace2bdbb7456d52e117e80a96c9e9b7b4)[3/3]
- [`getEffectDuration`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a4d2a31c0016d1da9106222edb6c395fd)
- [`setEffectPosition`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#acc753bf864b6c84d97c2d6778234c36e)
- [`getEffectCurrentPosition`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#abe60e8ce475a3fef96245ffc47e95e50)
- [`playEffect`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#aa713b173d4b9aa234f482ebb932f5955)[2/2]
- [`startAudioMixing`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a21063bfb71a8a5cbc0d391f9d7ac75be)[2/2]
- `LOCAL_VIDEO_STREAM_ERROR_DEVICE_NOT_FOUND(8)` in [`LOCAL_VIDEO_STREAM_ERROR`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#aca8292c30c50a78f6fbd1ef1b264d842)
- `LOCAL_AUDIO_STREAM_ERROR_NO_RECORDING_DEVICE(6)` and `LOCAL_AUDIO_STREAM_ERROR_NO_PLAYOUT_DEVICE(7)` in [`LOCAL_AUDIO_STREAM_ERROR`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#a3929991eea3a522dcbf6ac078810045e)
- [Error code](https://docs.agora.io/en/Voice/error_rtc): `ERR_ALREADY_IN_RECORDING(160)`

**Modified**

- [`onAudioMixingStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#ae2e257d7bbf120b970b600b9b3731a07)
...
- [`setVoiceConversionPreset`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#aee9553948bf2c4e2b79a00cddce41499)
- `AES_128_GCM` and `AES_256_GCM` in [`ENCRYPTION_MODE`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#a906cebebbabf534c86ca71de0d1a4cf0)
- `mosValue` in [`RemoteAudioStats`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_remote_audio_stats.html)
...
This release adds the Agora basic calculation framework `libagora-core.dll`. To integrate the SDK into your project, see <Link to="../quickstart-guide/get-started-sdk#integrate-the-sdk">Integrate the SDK</Link>.
...
See details in <Link to="../best-practices/set-subscribing-state">Set the Subscribing State</Link>.
...
To improve the usability of the Agora Cloud Proxy, this release adds the `setCloudProxy` method to set the cloud proxy and allows you to select a cloud proxy that uses the UDP protocol. For details, see <Link to="../basic-features/use-cloud-proxy">Cloud Proxy</Link>.
...
- [`setVoiceBeautifierParameters`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#afe1e3302f3d1f670bc5cdaa870fe95e8)
- `SINGING_BEAUTIFIER` in the [`VOICE_BEAUTIFIER_PRESET`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#a1e88a96390a2c9fcca2db1ec56ee01fd) enum
- [`enableDeepLearningDenoise`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#ac0ba6ab3d831c93ae5916dd62d5d5888)
- [`joinChannel` [2/2]](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a31ae82fd9862ba8e6912655e4c1a4290)
- [`switchChannel` [2/2]](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#aa53dc6f39ee75549e170b68630b9faaf)
- [`createDataStream`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a7cfb5869a4554242875b6a7225a69b1e)
- `logConfig` in the [`RtcEngineContext`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_rtc_engine_context.html) struct
- `qoeQuality` and `qualityChangedReason` in the [`RemoteAudioStats`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_remote_audio_stats.html) struct
- [`setCloudProxy`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#aff1329c23bbcaff769101ae08f91b869)
...
This release optimizes the Agora cloud proxy architecture. If you are already using cloud proxy, to avoid compatibility issues between the new SDK and the old cloud proxy, please contact support@agora.io before upgrading the SDK. See <Link to="../basic-features/use-cloud-proxy">Cloud Proxy</Link>.

**3. Security and compliance**

Agora has passed ISO 27001, ISO 27017, and ISO 27018 international certifications, providing safe and reliable real-time interactive cloud services for users worldwide. See <Link to="../reference/security#iso-certificates">ISO Certificates</Link>.
...
- [`setAudioEffectPreset`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a6111d2648909601c976b0190fe6de798)
- [`setVoiceBeautifierPreset`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a577b68f53ed63771da80ec8901ed93e5)
- [`setAudioEffectParameters`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a9e5a3c34818abd26b0d0a9434f7ce4ca)
- `AUDIO_SCENARIO_MEETING(8)` in [`AUDIO_SCENARIO_TYPE`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#a2c5708461a9e1568bbda636d95055533) `enum`
- [`setClientRole`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a7f01b7bbf512a041afa99ec7ecfa11c4)
...
If you have specified a region for connection when calling [`initialize`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#ac71db65e66942e4e0a0550e95c16890f), ensure that you use the latest area code when migrating from an earlier SDK version.
...
- [`onAudioPublishStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#af5188bdc817fa62aac51b3dc627dfb64)
- [`onAudioSubscribeStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#ae3f517bd166a9e34aa77f9fbf137a7b9)
- [`onFirstLocalAudioFramePublished`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a03058e62a0a4a41e80ecf0279975ab99)
- [`enableEncryption`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#ad5ea5f0dfd8117f38d9c4b12fe01fece)
- `txPacketLossRate` in the [`LocalAudioStats`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_local_audio_stats.html) struct
- `txPacketLossRate` and `captureFrameRate` in the [`LocalVideoStats`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_local_video_stats.html) struct
- `publishDuration` in the [`RemoteAudioStats`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_remote_audio_stats.html) struct
- [`onRtmpStreamingEvent`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#aa2beb17562a3be9b5ddbe9366245cb0e)
...
- Inaccurate report of the [`onClientRoleChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a36d3f45184cbb37ed2c4846654a14368) callback, authentication with an App ID and token, and a garbled log directory.

#### API changes

**Added**

- [`setAudioMixingPitch`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a26b117f7e097801b03522f7da9257425)
- Nine enumerations in [`VOICE_CHANGER_PRESET`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#ae29d1fb09d785334eabf0f3def8b4117), such as `VOICE_BEAUTY_VIGOROUS`
- Twelve enumerations in [`AUDIO_REVERB_PRESET`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora_1_1rtc.html#a2476d004b44df3950ef62022cd41e564), such as `AUDIO_REVERB_FX_KTV`
- [`isMultipleChannelFrameWanted`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1media_1_1_i_audio_frame_observer.html#a4b6bdf2a975588cd49c2da2b6eff5956) and [`onPlaybackAudioFrameBeforeMixingEx`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1media_1_1_i_audio_frame_observer.html#ab0cf02ba307e91086df04cda4355905b) in the [`IAudioFrameObserver`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1media_1_1_i_audio_frame_observer.html) class
- The `totalActiveTime` member in the [`RemoteAudioStats`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_remote_audio_stats.html) struct
- `WARN_ADM_WINDOWS_NO_DATA_READY_EVENT(1040)` and `WARN_ADM_INCONSISTENT_AUDIO_DEVICE(1042)` in the [warning codes](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/namespaceagora.html#a32d042123993336be6646469da251b21)
...
`areaCode` member in the [`RtcEngineContext`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_rtc_engine_context.html) struct
...
After joining multiple channels, users can receive the audio and video streams of all the channels, but publish one stream to only one channel at a time. This feature applies to scenarios where users need to receive streams from multiple channels, or frequently switch between channels to publish streams. See <Link to="/3.x/interactive-live-streaming/advanced-features/multiple-channel">Join Multiple Channels</Link> for details.
...
- The [`channelId`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_audio_volume_info.html#ab67471def88118f010e6d5add7d83f64) member in the [`AudioVolumeInfo`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_audio_volume_info.html) struct
- [`createChannel`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine2.html#a9cabefe84d3a52400f941f1bd8c0f486)
- [`IChannel`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_channel.html) class
- [`IChannelEventHandler`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_channel_event_handler.html) class
- The [[gatewayRtt](https://api-ref.agora.io/en/video-sdk/ios/3.x/Classes/AgoraChannelStats.html#//api/name/gatewayRtt)](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_rtc_stats.html#a30cc889ef34f63e23950b54591218cb5), [`memoryAppUsageRatio`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_rtc_stats.html#aab879ec9c52f2dd8d662c26c4939a7d3), [`memoryTotalUsageRatio`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_rtc_stats.html#aae6d57e709b08258be372960f9e19fd6) and [`memoryAppUsageInKbytes`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_rtc_stats.html#a17258e12476bb9106ccc248af4cfe734) members in the [`RtcStats`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_rtc_stats.html) class

**Deprecated**

* `RtcEngineParameters` class
* `enableWebSdkInteroperability`
* `onFirstRemoteAudioDecoded`, and `onFirstRemoteAudioFrame`, replaced by [`onRemoteAudioStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#aa168380f86f1dc2df1c269a785c56612)
* `onStreamPublished` and `onStreamUnpublished`, replaced by [`onRtmpStreamingStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a29754dc9d527cbff57dbc55067e3287d)
...
This release adds the `report_vad(bool)` parameter to the [`enableAudioVolumeIndication`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a4b30a8ff1ae50c4c114ae4f909c4ebcb) method to enable local voice activity detection. Once it is enabled, you can check the [`AudioVolumeInfo`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_audio_volume_info.html) struct of the [`onAudioVolumeIndication`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#aab1184a2b276f509870c055a9ff8fac4) callback for the voice activity status of the local user.

#### Improvements

**Supporting more audio sample rates for recording**

To enable more audio sample rate options for recording, this release adds a new [`startAudioRecording`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a3c05d82c97a9d63ebda116b9a1e5ca3f) method with a `sampleRate` parameter. In the new method, you can set the sample rate as 16, 32, 44.1 or 48 kHz. The original method supports only a fixed sample rate of 32 kHz and is deprecated.
...
- [`startAudioRecording`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a3c05d82c97a9d63ebda116b9a1e5ca3f)
- The `report_vad` parameter in the [`enableAudioVolumeIndication`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a4b30a8ff1ae50c4c114ae4f909c4ebcb) method
- The `vad` member in the [`AudioVolumeInfo`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_audio_volume_info.html) class
...
- [`setLiveTranscoding`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a0601e4671357dc1ec942cccc5a6a1dde)
- [`addPublishStreamUrl`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a5d62a13bd8391af83fb4ce123450f839)
- [`removePublishStreamUrl`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a30e6c64cb616fbd78bedd8c516c320e7)
- [`onRtmpStreamingStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a29754dc9d527cbff57dbc55067e3287d)
...
This release adds the [`switchChannel`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a3eb5ee494ce124b34609c593719c89ab) method to enable the audience in a `LIVE_BROADCASTING` channel to quickly switch to another channel. With this method, you can achieve a much faster switch than with the `leaveChannel` and `joinChannel` methods. After the audience successfully switches to another channel by calling the `switchChannel` method, the SDK triggers the `onLeaveChannel` and `onJoinChannelSuccess` callbacks to indicate that the audience has left the original channel and joined a new one.
...
- [`startChannelMediaRelay`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#acb72f911830a6fdb77e0816d7b41dd5c)
- [`updateChannelMediaRelay`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#afad0d3f3861c770200a884b855276663)
- [`stopChannelMediaRelay`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#ab4a1c52a83a08f7dacab6de36f4681b8)

During the media stream relay, the SDK reports the states and events of the relay with the [`onChannelMediaRelayStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a8f22b85194d4b771bbab0e1c3b505b22) and [`onChannelMediaRelayEvent`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a89a4085f36c25eeed75c129c82ca9429) callbacks.

**3. Reporting the local and remote audio state**

This release adds the [`onLocalAudioStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a9296c329331eb83b3af1315c52e7f91a) and [`onRemoteAudioStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#aa168380f86f1dc2df1c269a785c56612) callbacks to report the local and remote audio states. With these callbacks, the SDK reports the following states for the local and remote audio:
...
- [`RtcStats`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_rtc_stats.html): The total number of the sent audio bytes and  received audio bytes during a session.
...
- [`onLocalAudioStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a9296c329331eb83b3af1315c52e7f91a)
- [`onRemoteAudioStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#aa168380f86f1dc2df1c269a785c56612)
- [`onLocalAudioStats`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a0cb47df6a8ef7acee229eb307d6f32c3)
- [`switchChannel`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a3eb5ee494ce124b34609c593719c89ab)
- [`startChannelMediaRelay`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#acb72f911830a6fdb77e0816d7b41dd5c)
- [`updateChannelMediaRelay`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#afad0d3f3861c770200a884b855276663)
- [`stopChannelMediaRelay`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#ab4a1c52a83a08f7dacab6de36f4681b8)
- [`onChannelMediaRelayStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a8f22b85194d4b771bbab0e1c3b505b22)
- [`onChannelMediaRelayEvent`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a89a4085f36c25eeed75c129c82ca9429)
- [`RtcStats`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_rtc_stats.html): `txAudioBytes` and `rxAudioBytes`

**Deprecated**

- `onMicrophoneEnabled`. Use LOCAL_AUDIO_STREAM_STATE_CHANGED(0) or LOCAL_AUDIO_STREAM_STATE_RECORDING(1) in the [`onLocalAudioStateChanged`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a9296c329331eb83b3af1315c52e7f91a) callback instead.
- `onRemoteAudioTransportStats`. Use the [`onRemoteAudioStats`](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#af8a59626a9265264fb4638e048091d3a) callback instead.
...
- [registerLocalUserAccount](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a0d44b74ced4005ee86353c13186f870d)
- [joinChannelWithUserAccount](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a14f8c308c6c57c55653552b939a8527a)
...
To monitor the audio transmission quality during a call interactive live streaming, this release adds the `totalFrozenTime` and `frozenRate` members in the [RemoteAudioStats](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_remote_audio_stats.html) class, to report the audio freeze time and freeze rate of the remote user.

This release also adds the `numChannels`, `receivedSampleRate`, and `receivedBitrate` members in the [RemoteAudioStats](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_remote_audio_stats.html) class.

#### Improvements

This release adds a `CONNECTION_CHANGED_KEEP_ALIVE_TIMEOUT(14)` member to the `reason` parameter of the [onConnectionStateChanged](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#af409b2e721d345a65a2c600cea2f5eb4) callback. This member indicates a connection state change caused by the timeout of the connection keep-alive between the SDK and Agora's edge server.
...
- [registerLocalUserAccount](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a0d44b74ced4005ee86353c13186f870d)
- [joinChannelWithUserAccount](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a14f8c308c6c57c55653552b939a8527a)
- [getUserInfoByUid](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#abf4572004e6ceb99ce0ff76a75c69d0b)
- [getUserInfoByUserAccount](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine.html#a4f75984d3c5de5f6e3e4d8bd81e3b409)
- [onLocalUserRegistered](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a919404869f86412e1945c730e5219b20)
- [onUserInfoUpdated](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#ad086cc4d8e5555cc75a0ab264c16d5ff)
- The `numChannels`, `receivedSampleRate`, `receivedBitrate`, `totalFrozenTime`, and `frozenRate` members in the [RemoteAudioStats](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_remote_audio_stats.html) class

**Deprecated**

- The `lowLatency` member in the [LiveTranscoding](https://api-ref.agora.io/en/voice-sdk/cpp/3.x/structagora_1_1rtc_1_1_live_transcoding.html) class
...
- [Quickstart Guide](../quickstart-guide/get-started-sdk)
- <Link to="../basic-features/token-server">Use security keys</Link>
- <Link to="../advanced-features/in-call-quality">Report in-call statistics</Link>
- <Link to="../basic-features/adjust-volume">Adjust the volume</Link>
- <Link to="../advanced-features/audio-effect-mixing">Play audio effects/audio mixing</Link>
- <Link to="../advanced-features/voice-changer">Set the voice changer and reverberation effects</Link>
- [Test or select a media device](./test_switch_device_windows)
- <Link to="../basic-features/use-cloud-proxy">Use Cloud Proxy</Link>

If you migrate to this SDK from the Windows Video SDK, refer to the <Link to="/3.x/interactive-live-streaming/introduction/release-notes">Release notes for the Windows video SDK</Link> for audio improvements.
