...
Adds the [`screenAudio`](https://api-ref.agora.io/en/video-sdk/web/3.x/interfaces/agorartc.streamspec.html#screenaudio) property in[`AgoraRTC.createStream`](https://api-ref.agora.io/en/video-sdk/web/3.x/globals.html#createstream).
...
- [`AgoraRTC.getSupportedCodec`](https://api-ref.agora.io/en/video-sdk/web/3.x/globals.html#getsupportedcodec)
...
- [`AgoraRTC.getScreenSources`](https://api-ref.agora.io/en/video-sdk/web/3.x/globals.html#getscreensources)
