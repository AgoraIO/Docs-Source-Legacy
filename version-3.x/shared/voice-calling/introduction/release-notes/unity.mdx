...
- Reporting streaming states, errors, and events:
  ...
  - Renaming `RTMP_STREAM_PUBLISH_ERROR` to `RTMP_STREAM_PUBLISH_ERROR_TYPE` and adding the following to the `RTMP_STREAM_PUBLISH_ERROR_TYPE` error code:
    ...
    - `RTMP_STREAM_PUBLISH_ERROR_INVALID_APPID(15)`: Your App ID does not have permission to use the CDN live streaming function. Refer to <Link to="/3.x/interactive-live-streaming/advanced-features/media-push#prerequisites">Prerequisites</Link> to enable the CDN live streaming permission.
...
- `RTMP_STREAM_UNPUBLISH_ERROR_OK (100)` in [`RTMP_STREAM_PUBLISH_ERROR`](https://api-ref.agora.io/en/voice-sdk/unity/3.x/namespaceagora__gaming__rtc.html#adf0b94807c88344092613487b0dfa0c9)
- `RTMP_STREAMING_EVENT_URL_ALREADY_IN_USE (2)` in [`RTMP_STREAMING_EVENT`](https://api-ref.agora.io/en/voice-sdk/unity/3.x/namespaceagora__gaming__rtc.html#a1161b5f270933ebd660b9c29848161aa) 
...
- [`MuteLocalAudioStream`](https://api-ref.agora.io/en/voice-sdk/unity/3.x/classagora__gaming__rtc_1_1_i_rtc_engine.html#a6260eac33b6624824872a7140a229ef3) in `IRtcEngine` 
- [`publishLocalAudio`](https://api-ref.agora.io/en/voice-sdk/unity/3.x/structagora__gaming__rtc_1_1_channel_media_options.html#ae7cf13e792f38e45ed5a1a35f8c948c7) in [`ChannelMediaOptions`](https://api-ref.agora.io/en/voice-sdk/unity/3.x/structagora__gaming__rtc_1_1_channel_media_options.html)


**Modified**

[`MEDIA_DEVICE_STATE_TYPE`](https://api-ref.agora.io/en/voice-sdk/unity/3.x/namespaceagora__gaming__rtc.html#ad862a26da27e398f045eb4a95bcfa530)
...
- [Start a Voice Call](../quickstart-guide/get-started-sdk) or <Link to="/3.x/interactive-live-streaming/quickstart-guide/start-audio-streaming">Start Live Interactive Audio Streaming</Link>
