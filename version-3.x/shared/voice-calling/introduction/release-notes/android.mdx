...
This release adds [`startEchoTest`](./API%20Reference/java/v3.5.2/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#ae4b2638c90a721749abdd9513260e51c) [3/3].
...
As of this release, Agora publishes the SDK package to mavenCentral. To integrate the SDK with mavenCentral, see [Integrate the SDK](https://docs.agora.io/en/Voice/start_call_audio_android?platform=Android#integrate-the-sdk).
...
- [`muteLocalAudioStream`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_channel.html#ae756f3e94c56acc0873799c63a97a22d) in `RtcChannel`
- [`publishLocalAudio`](./API%20Reference/java/classio_1_1agora_1_1rtc_1_1models_1_1_channel_media_options.html#a647b5b6056e0b364c4df6a72ec1f9420) in `ChannelMediaOptions`
...
Because JCenter is about to retire, as of this release, Agora publishes the SDK package to JitPack instead of JCenter. To integrate the SDK with JitPack, see [Integrate the SDK](./start_call_audio_android?platform=Android#a-nameintegrate_sdkaintegrate-the-sdk).
