...
This release adapts to the Agora Voice SDK v3.5.1 for Android and iOS. For the compatibility changes, new features, improvements, and fixed issues from v3.2.0 to v3.5.1, see [Release Notes (Android)](https://docs.agora.io/en/Voice/release_android_audio?platform=Android) and [Release Notes (iOS)](https://docs.agora.io/en/Voice/release_ios_audio?platform=iOS).
